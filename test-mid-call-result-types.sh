...
for source in tests/run/mid_call_result_aggregate_context.pw tests/run/mid_call_result_return_context.pw tests/run/primitive_extension.pw tests/part/importalias/Main.pw; do
