...
言語・コアライブラリが提供する主要トレイトの一覧です。演算子・変換まわりの詳細な意味論は [型変換と演算子](08-operators.md) を参照。
