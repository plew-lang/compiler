...
for name in match_move_discard_payload match_move_unique_payload match_move_wildcard_payload unique_enum_arc mid_enum_destructure_runtime mid_enum_destructure_verify mid_unique_match_temporary mid_unique_match_owned_result; do
