#!/bin/sh
# tests/harness/test-deps.sh — end-to-end test of package dependency resolution (spec/17).
...
# @Cache/@Fetch and the resolver, which the main tests/harness/test.sh (single-file programs)
