...
long long placeIsMutable_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m488 = e;
    if (_m488.tag == 1) {
        uint64_t start = _m488.data.Ident.start;
        (void)start;
        uint64_t len = _m488.data.Ident.len;
        (void)len;
    { long long __ret489 = localIsMutable_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret489; }
    }
    else if (_m488.tag == 5) {
        uint64_t base = _m488.data.Field.base;
        (void)base;
        uint64_t nameStart = _m488.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m488.data.Field.nameLen;
        (void)nameLen;
    ...
    { long long __ret490 = placeIsMutable_c_Comp_id_U64(&((*c)), base);
    return __ret490; }
    }
    ...
    return __ret492; }
        ...
        uint64_t base = _m488.data.Index.base;
        (void)base;
        uint64_t index = _m488.data.Index.index;
        (void)index;
    { long long __ret493 = placeIsMutable_c_Comp_id_U64(&((*c)), base);
    return __ret493; }
    }
    else if (_m488.tag == 16) {
        uint64_t base = _m488.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m488.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m488.data.Arrow.nameLen;
        (void)nameLen;
    { long long __ret494 = 1;
    return __ret494; }
    }
    else {
    { long long __ret495 = 1;
    return __ret495; }
    }
    }
}
TypeInfo exprType_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m496 = e;
    if (_m496.tag == 0) {
        long long isBool = _m496.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m496.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m496.data.Int.tyLen;
        (void)tyLen;
    if (isBool) {
    Bind b = kwSpan_c_Comp_kw_String_kwLen_U64(&((*c)), (PlewString){"Bool", 4}, 4);
    if (b.nameLen != 0) {
    { TypeInfo __ret497 = (TypeInfo){.kind = 0, .nameStart = b.nameStart, .nameLen = b.nameLen, .ref = 0};
    return __ret497; }
    }
    }
    if (tyLen != 0) {
    { TypeInfo __ret498 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret498; }
    }
    ...
    return __ret499; }
        ...
        uint64_t start = _m496.data.Str.start;
        (void)start;
        uint64_t len = _m496.data.Str.len;
        (void)len;
    ...
    { TypeInfo __ret501 = (TypeInfo){.kind = 3, .nameStart = en.nameStart, .nameLen = en.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    return __ret501; }
    }
    }
    { TypeInfo __ret502 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    return __ret502; }
    TypeRef_release(rt);
    }
    { TypeInfo __ret503 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), (*c).curRecvStart, (*c).curRecvLen, 0);
    return __ret503; }
    }
    if ((*c).curInClosure) {
    uint64_t ci = 0;
    ...
    { TypeInfo __ret504 = (TypeInfo){.kind = 2, .nameStart = rt2.nameStart, .nameLen = rt2.nameLen, .ref = ce.ty};
    TypeRef_release(rt2);
    return __ret504; }
    TypeRef_release(rt2);
    }
    { TypeInfo __ret505 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), ce.tyStart, ce.tyLen, ce.isArray);
    return __ret505; }
    }
    }
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), lo.nameStart, lo.nameLen, start, len)) {
    if (lo.isArray) {
    { TypeInfo __ret506 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, 1);
    return __ret506; }
    }
    if (isGenericInst_c_Comp_ref_U64(&((*c)), lo.ty)) {
    TypeRef lt = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(lo.ty)));
    { TypeInfo __ret507 = (TypeInfo){.kind = 2, .nameStart = lt.nameStart, .nameLen = lt.nameLen, .ref = lo.ty};
    TypeRef_release(lt);
    return __ret507; }
    TypeRef_release(lt);
    }
    ...
    { TypeInfo __ret508 = (TypeInfo){.kind = 2, .nameStart = lt2.nameStart, .nameLen = lt2.nameLen, .ref = lo.ty};
    TypeRef_release(lt2);
    return __ret508; }
    TypeRef_release(lt2);
    }
    ...
    { TypeInfo __ret509 = (TypeInfo){.kind = 2, .nameStart = lt3.nameStart, .nameLen = lt3.nameLen, .ref = lo.ty};
    TypeRef_release(lt3);
    return __ret509; }
    TypeRef_release(lt3);
    }
    ...
    { TypeInfo __ret510 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get((*c).curTypeArgs, (long long)(k)));
    return __ret510; }
    }
    k = ({ uint64_t __ov; if (__builtin_add_overflow((k), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    }
    { TypeInfo __ret511 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, lo.isArray);
    return __ret511; }
    }
    }
    ...
    return __ret512; }
        ...
        int64_t op = _m496.data.Unary.op;
        (void)op;
        uint64_t operand = _m496.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ...
    return __ret515; }
        ...
        int64_t op = _m496.data.Binary.op;
        (void)op;
        uint64_t lhs = _m496.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m496.data.Binary.rhs;
        (void)rhs;
    if (op >= 56) {
    if (op <= 60) {
    ...
    if (op >= 74) {
    if (op <= 78) {
    { TypeInfo __ret517 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret517; }
    }
    }
    ...
    return __ret518; }
        ...
        uint64_t nameStart = _m496.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m496.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m496.data.Call.args;
        (void)args;
    ...
    { TypeInfo __ret519 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(rb.args, (long long)(0)));
    TypeRef_release(rb);
    return __ret519; }
    }
    TypeRef_release(rb);
    ...
    if (bl.nameLen != 0) {
    { TypeInfo __ret522 = (TypeInfo){.kind = 0, .nameStart = bl.nameStart, .nameLen = bl.nameLen, .ref = 0};
    return __ret522; }
    }
    }
    ...
    { TypeInfo __ret524 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), at.nameStart, at.nameLen, 0);
    return __ret524; }
    }
    ...
    { TypeInfo __ret527 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(inferred, (long long)(k)));
    ...
    { TypeInfo __ret528 = (TypeInfo){.kind = 2, .nameStart = rtr.nameStart, .nameLen = rtr.nameLen, .ref = f.retTy};
    TypeRef_release(rtr);
    Func_release(f);
    return __ret528; }
    TypeRef_release(rtr);
    ...
    { TypeInfo __ret529 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.retStart, f.retLen, f.retIsArray);
    Func_release(f);
    return __ret529; }
    }
    ...
    { TypeInfo __ret531 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(ftr.args, (long long)(0)));
    TypeRef_release(ftr);
    return __ret531; }
    }
    TypeRef_release(ftr);
    ...
    if (u8.nameLen != 0) {
    { TypeInfo __ret533 = (TypeInfo){.kind = 3, .nameStart = u8.nameStart, .nameLen = u8.nameLen, .ref = 0};
    return __ret533; }
    }
    }
    }
    ...
    { TypeInfo __ret535 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.ref, nameStart, nameLen);
    return __ret535; }
    }
    if (bt.kind == 2) {
    { TypeInfo __ret536 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.nameStart, bt.nameLen, nameStart, nameLen);
    return __ret536; }
    }
    ...
    return __ret537; }
        ...
        uint64_t typeStart = _m496.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m496.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m496.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m496.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m496.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m496.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m496.data.Make.fields;
        (void)fields;
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ty)) {
    { TypeInfo __ret538 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = ty};
    return __ret538; }
    }
    { TypeInfo __ret539 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = 0};
    return __ret539; }
    }
    else if (_m496.tag == 8) {
        Array_U64 elems = _m496.data.Array.elems;
        (void)elems;
    ...
    { TypeInfo __ret541 = (TypeInfo){.kind = 3, .nameStart = xn.nameStart, .nameLen = xn.nameLen, .ref = 0};
    TypeRef_release(rt);
    return __ret541; }
    }
    }
    if (isCompoundType_c_Comp_ref_U64(&((*c)), rr)) {
    { TypeInfo __ret542 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = rr};
    TypeRef_release(rt);
    return __ret542; }
    }
    TypeRef_release(rt);
    ...
    { TypeInfo __ret543 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), bt.nameStart, bt.nameLen, 0);
    return __ret543; }
    }
    { TypeInfo __ret544 = scalarInfo();
    return __ret544; }
    }
    else if (_m496.tag == 10) {
        uint64_t recv = _m496.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m496.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m496.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m496.data.Method.args;
        (void)args;
    ...
    if (af.hasRet) {
    { TypeInfo __ret546 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), af.retStart, af.retLen, af.retIsArray);
    Func_release(af);
    return __ret546; }
    }
    ...
    { TypeInfo __ret549 = substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(&((*c)), rt.ref, Array_Bind_share(Array_StructDef_get((*c).structs, (long long)(gsi)).typeParams), mf.retTy);
    TypeRef_release(gt);
    Func_release(mf);
    return __ret549; }
    }
    ...
    { TypeInfo __ret550 = substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(&((*c)), rt.ref, Array_Bind_share(Array_EnumDef_get((*c).enums, (long long)(gei)).typeParams), mf.retTy);
    TypeRef_release(gt);
    Func_release(mf);
    return __ret550; }
    }
    ...
    { TypeInfo __ret551 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), mf.retStart, mf.retLen, mf.retIsArray);
    Func_release(mf);
    return __ret551; }
    }
    ...
    { TypeInfo __ret554 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), rt.nameStart, rt.nameLen, 0);
    TypeRef_release(rtt);
    Func_release(mf);
    return __ret554; }
    }
    ...
    else if (_m496.tag == 11) {
        uint64_t operand = _m496.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m496.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m496.data.Cast.tyLen;
        (void)tyLen;
    { TypeInfo __ret558 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret558; }
    }
    else if (_m496.tag == 12) {
        uint64_t scrut = _m496.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m496.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).count) > 0) {
    { TypeInfo __ret559 = exprType_c_Comp_id_U64(&((*c)), Array_MatchArm_get(arms, (long long)(0)).body);
    return __ret559; }
    }
    { TypeInfo __ret560 = scalarInfo();
    return __ret560; }
    }
    else if (_m496.tag == 13) {
        uint64_t cond = _m496.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m496.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m496.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (g < (long long)(((*c).exprs).count)) {
    { TypeInfo __ret561 = exprType_c_Comp_id_U64(&((*c)), g);
    return __ret561; }
    }
    { TypeInfo __ret562 = scalarInfo();
    return __ret562; }
    }
    else if (_m496.tag == 14) {
        uint64_t opt = _m496.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m496.data.Coalesce.deflt;
        (void)deflt;
    { TypeInfo __ret563 = exprType_c_Comp_id_U64(&((*c)), deflt);
    return __ret563; }
    }
    else if (_m496.tag == 15) {
        uint64_t expr = _m496.data.Try.expr;
        (void)expr;
    ...
    { TypeInfo __ret564 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(inst.args, (long long)(0)));
    ...
    if (pt.kind == 2) {
    { TypeInfo __ret566 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), pt.nameStart, pt.nameLen, nameStart, nameLen);
    TypeRef_release(inst);
    return __ret566; }
    }
    TypeRef_release(inst);
    ...
    else if (_m496.tag == 17) {
        Array_Param params = _m496.data.Closure.params;
        (void)params;
        long long hasRet = _m496.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m496.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m496.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m496.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m496.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m496.data.Closure.body;
        (void)body;
    { TypeInfo __ret568 = scalarInfo();
    return __ret568; }
    }
    else if (_m496.tag == 18) {
        uint64_t operand = _m496.data.Move.operand;
        (void)operand;
        long long isBorrow = _m496.data.Move.isBorrow;
        (void)isBorrow;
    { TypeInfo __ret569 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret569; }
    }
    else if (_m496.tag == 19) {
        uint64_t operand = _m496.data.Await.operand;
        (void)operand;
    ...
    { TypeInfo __ret570 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(tr.args, (long long)(0)));
    TypeRef_release(tr);
    return __ret570; }
    }
    TypeRef_release(tr);
...
uint64_t blockGiveExpr_c_Comp_blkId_U64(Comp* c, uint64_t blkId) {
    ...
    Stmt _m573 = s;
    if (_m573.tag == 9) {
        uint64_t value = _m573.data.Give.value;
        (void)value;
    found = value;
    }
    else {
...
PlewString unaryOpStr_op_I64(int64_t op) {
    ...
    { PlewString __ret596 = (PlewString){"!", 1};
    return __ret596; }
}
int64_t strDecodedLen_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    int64_t n = 0;
...
PlewString overflowBuiltin_op_I64(int64_t op) {
    if (op == 56) {
    { PlewString __ret606 = (PlewString){"__builtin_add_overflow", 22};
    return __ret606; }
    }
    if (op == 57) {
    { PlewString __ret607 = (PlewString){"__builtin_sub_overflow", 22};
    return __ret607; }
    }
    { PlewString __ret608 = (PlewString){"__builtin_mul_overflow", 22};
    return __ret608; }
}
TypeInfo arithIntType_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
    ...
    { TypeInfo __ret610 = rt;
    return __ret610; }
    }
    }
    { TypeInfo __ret611 = scalarInfo();
    return __ret611; }
}
void genCheckedArith_c_Comp_op_I64_lhs_U64_rhs_U64_tyStart_U64_tyLen_U64(Comp* c, int64_t op, uint64_t lhs, uint64_t rhs, uint64_t tyStart, uint64_t tyLen) {
...
PlewString intMinMacro_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I8", 2})) {
    { PlewString __ret612 = (PlewString){"INT8_MIN", 8};
    return __ret612; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I16", 3})) {
    { PlewString __ret613 = (PlewString){"INT16_MIN", 9};
    return __ret613; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I32", 3})) {
    { PlewString __ret614 = (PlewString){"INT32_MIN", 9};
    return __ret614; }
    }
    { PlewString __ret615 = (PlewString){"INT64_MIN", 9};
    return __ret615; }
}
void genCheckedNeg_c_Comp_operand_U64_tyStart_U64_tyLen_U64(Comp* c, uint64_t operand, uint64_t tyStart, uint64_t tyLen) {
    plew_write((PlewString){"({ ", 3});
...
PlewString assignOpStr_op_I64(int64_t op) {
    ...
    { PlewString __ret626 = (PlewString){" >>= ", 5};
    return __ret626; }
}
long long isCompoundDiv_op_I64(int64_t op) {
    if (op == 70) {
...
PlewString compoundDivFn_op_I64(int64_t op) {
    if (op == 70) {
    { PlewString __ret630 = (PlewString){"plew_div(", 9};
    return __ret630; }
    }
    if (op == 71) {
    { PlewString __ret631 = (PlewString){"plew_mod(", 9};
    return __ret631; }
    }
    { PlewString __ret632 = (PlewString){"", 0};
    return __ret632; }
}
PlewString assignToBinStr_op_I64(int64_t op) {
    if (op == 67) {
    ...
    { PlewString __ret642 = (PlewString){" >> ", 4};
    return __ret642; }
}
ConstInt notConst(void) {
    { ConstInt __ret643 = (ConstInt){.isConst = 0, .neg = 0, .value = 0};
    return __ret643; }
}
ConstInt mkConst_neg_Bool_mag_U64(long long neg, uint64_t mag) {
    if (mag == 0) {
    { ConstInt __ret644 = (ConstInt){.isConst = 1, .neg = 0, .value = 0};
    return __ret644; }
    }
    { ConstInt __ret645 = (ConstInt){.isConst = 1, .neg = neg, .value = mag};
    return __ret645; }
}
ConstInt addConst_na_Bool_a_U64_nb_Bool_b_U64(long long na, uint64_t a, long long nb, uint64_t b) {
    if (na == nb) {
    ...
    { ConstInt __ret647 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_add_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret647; }
    }
    if (a >= b) {
    { ConstInt __ret648 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_sub_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret648; }
    }
    { ConstInt __ret649 = mkConst_neg_Bool_mag_U64(nb, ({ uint64_t __ov; if (__builtin_sub_overflow((b), (a), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret649; }
}
ConstInt foldConst_c_Comp_id_U64(Comp* c, uint64_t id) {
    Expr e = Array_Expr_get((*c).exprs, (long long)(id));
    ...
    Expr _m650 = e;
    if (_m650.tag == 0) {
        uint64_t value = _m650.data.Int.value;
        (void)value;
        long long isBool = _m650.data.Int.isBool;
        (void)isBool;
    if (isBool) {
    ...
    { ConstInt __ret653 = (ConstInt){.isConst = 1, .neg = 0, .value = value};
    return __ret653; }
    }
    else if (_m650.tag == 2) {
        int64_t op = _m650.data.Unary.op;
        (void)op;
        uint64_t operand = _m650.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ConstInt o = foldConst_c_Comp_id_U64(&((*c)), operand);
    if (o.isConst) {
    { ConstInt __ret654 = mkConst_neg_Bool_mag_U64(!(o.neg), o.value);
    return __ret654; }
    }
    }
    ...
    return __ret655; }
        ...
        int64_t op = _m650.data.Binary.op;
        (void)op;
        uint64_t lhs = _m650.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m650.data.Binary.rhs;
        (void)rhs;
    ...
    if (op == 57) {
    { ConstInt __ret657 = addConst_na_Bool_a_U64_nb_Bool_b_U64(a.neg, a.value, !(b.neg), b.value);
    return __ret657; }
    }
    if (op == 58) {
    if (a.value == 0) {
    { ConstInt __ret658 = mkConst_neg_Bool_mag_U64(0, 0);
    return __ret658; }
    }
    ...
    { ConstInt __ret660 = mkConst_neg_Bool_mag_U64((a.neg != b.neg), ({ uint64_t __ov; if (__builtin_mul_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret660; }
    }
    }
    }
...
long long tiIsInt_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    if (ti.kind == 0) {
    if (ti.nameLen != 0) {
    { long long __ret663 = isIntType_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret663; }
    }
    }
...
void checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(Comp* c, uint64_t id, uint64_t eKind, uint64_t eBits, long long eSgn) {
    ...
    checkLitLeaf_c_Comp_value_U64_neg_Bool_offset_U64_isBool_Bool_tyStart_U64_tyLen_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), value, 0, offset, isBool, tyStart, tyLen, eKind, eBits, eSgn);
        ...
        int64_t op = _m665.data.Unary.op;
        (void)op;
        uint64_t operand = _m665.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ...
    Expr _m666 = oe;
    if (_m666.tag == 0) {
        uint64_t value = _m666.data.Int.value;
        (void)value;
        uint64_t offset = _m666.data.Int.offset;
        (void)offset;
        long long isBool = _m666.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m666.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m666.data.Int.tyLen;
        (void)tyLen;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, eKind, eBits, eSgn);
        ...
        int64_t op = _m665.data.Binary.op;
        (void)op;
        uint64_t lhs = _m665.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m665.data.Binary.rhs;
        (void)rhs;
    long long isArith = 0;
    if (op >= 56) {
    if (op <= 60) {
    ...
    checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(&((*c)), lhs, rhs);
        ...
        uint64_t nameStart = _m665.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m665.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m665.data.Call.args;
        (void)args;
    checkCallArgs_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, Array_Arg_share(args));
    }
    else if (_m665.tag == 10) {
        uint64_t recv = _m665.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m665.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m665.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m665.data.Method.args;
        (void)args;
    checkMethodArgs_c_Comp_recv_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recv, nameStart, nameLen, Array_Arg_share(args));
    }
    else if (_m665.tag == 11) {
        uint64_t operand = _m665.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m665.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m665.data.Cast.tyLen;
        (void)tyLen;
    Expr oe = Array_Expr_get((*c).exprs, (long long)(operand));
    {
    Expr _m667 = oe;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, 0, 0, 0);
        ...
        uint64_t base = _m665.data.Field.base;
        (void)base;
        uint64_t nameStart = _m665.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m665.data.Field.nameLen;
        (void)nameLen;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    }
    else if (_m665.tag == 9) {
        uint64_t base = _m665.data.Index.base;
        (void)base;
        uint64_t index = _m665.data.Index.index;
        (void)index;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), index, 1, 64, 0);
    }
    else if (_m665.tag == 6) {
        uint64_t typeStart = _m665.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m665.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m665.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m665.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m665.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m665.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m665.data.Make.fields;
        (void)fields;
    checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(&((*c)), typeStart, typeLen, variantStart, variantLen, isEnum, ty, Array_MakeField_share(fields));
        ...
        Array_U64 elems = _m665.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    ...
    else if (_m665.tag == 12) {
        uint64_t scrut = _m665.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m665.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m665.tag == 14) {
        uint64_t opt = _m665.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m665.data.Coalesce.deflt;
        (void)deflt;
    ...
    else if (_m665.tag == 15) {
        uint64_t expr = _m665.data.Try.expr;
        (void)expr;
...
IntTy exprIntTy_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { IntTy __ret668 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen)};
    return __ret668; }
    }
    Expr e = Array_Expr_get((*c).exprs, (long long)(id));
    {
    ...
    { IntTy __ret670 = (IntTy){.known = 1, .bits = 64, .sgn = 1};
    return __ret670; }
    }
    }
    else if (_m669.tag == 5) {
    ...
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { IntTy __ret671 = (IntTy){.known = 1, .bits = 64, .sgn = 0};
    return __ret671; }
    }
    }
    }
    ...
    { IntTy __ret672 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)};
    return __ret672; }
    }
    }
    }
    ...
    { IntTy __ret673 = (IntTy){.known = 0, .bits = 0, .sgn = 0};
    return __ret673; }
}
void checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
void checkLitArray_c_Comp_id_U64_elemStart_U64_elemLen_U64(Comp* c, uint64_t id, uint64_t elemStart, uint64_t elemLen) {
    ...
    Expr _m674 = e;
    if (_m674.tag == 8) {
        Array_U64 elems = _m674.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).count)) {
...
TypeInfo makeFieldType_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret679 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), fd.tyStart, fd.tyLen, fd.tyIsArray);
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
    EnumDef_release(en);
    ...
    { TypeInfo __ret680 = scalarInfo();
    return __ret680; }
    }
    { TypeInfo __ret681 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), typeStart, typeLen, fieldStart, fieldLen);
    return __ret681; }
}
void checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t ty, Array_MakeField fields) {
    uint64_t i = 0;
...
void instantiateProvidedMethods_c_Comp(Comp* c) {
    ...
    Array_Func_append_value_T(&((*c).funcs), (Func){.nameStart = f.nameStart, .nameLen = f.nameLen, .typeParams = Array_Bind_share(f.typeParams), .params = Array_Param_share(f.params), .hasRet = f.hasRet, .retStart = f.retStart, .retLen = f.retLen, .retIsArray = f.retIsArray, .retTy = f.retTy, .body = f.body, .hasRecv = 1, .recvStart = cf.typeStart, .recvLen = cf.typeLen, .selfInout = f.selfInout, .selfMove = f.selfMove, .isAssoc = f.isAssoc, .isAsync = f.isAsync, .isExtern = f.isExtern, .isPub = 0});
    }
    }
    }
    }
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret787 = (long long)(((*c).structs).count);
    return __ret787; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m805 = Array_Expr_get((*c).exprs, (long long)(id));
    if (_m805.tag == 17) {
        Array_Param params = _m805.data.Closure.params;
        (void)params;
        long long hasRet = _m805.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m805.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m805.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m805.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m805.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m805.data.Closure.body;
        (void)body;
    if (hasRet) {
    (*c).curRetVoid = 0;
...
void collectFnThunks_c_Comp(Comp* c) {
    ...
    while (i < (long long)(((*c).exprs).count)) {
    {
    Expr _m806 = Array_Expr_get((*c).exprs, (long long)(i));
    if (_m806.tag == 1) {
        uint64_t start = _m806.data.Ident.start;
        (void)start;
        uint64_t len = _m806.data.Ident.len;
        (void)len;
    uint64_t fvi = firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(&((*c)), start, len);
    if (fvi < (long long)(((*c).funcs).count)) {
...
void emitClosureEnvs_c_Comp(Comp* c) {
    ...
    while (i < (long long)(((*c).exprs).count)) {
    {
    Expr _m815 = Array_Expr_get((*c).exprs, (long long)(i));
    if (_m815.tag == 17) {
        Array_Param params = _m815.data.Closure.params;
        (void)params;
        long long hasRet = _m815.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m815.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m815.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m815.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m815.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m815.data.Closure.body;
        (void)body;
...
void emitClosures_c_Comp_proto_Bool(Comp* c, long long proto) {
    ...
    while (i < (long long)(((*c).exprs).count)) {
    {
    Expr _m816 = Array_Expr_get((*c).exprs, (long long)(i));
    if (_m816.tag == 17) {
        Array_Param params = _m816.data.Closure.params;
        (void)params;
        long long hasRet = _m816.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m816.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m816.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m816.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m816.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m816.data.Closure.body;
        (void)body;
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret818 = (long long)(((*c).structs).count);
    return __ret818; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret820 = (long long)(((*c).enums).count);
    return __ret820; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret825 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).count));
    TypeRef_release(t);
    return __ret825; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret827 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret827; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret830 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret830; }
    TypeRef_release(t);
}
long long isRawBufInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret833 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"RawBuffer", 9});
    TypeRef_release(t);
    return __ret833; }
    TypeRef_release(t);
}
long long isPromiseInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret835 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Promise", 7});
    TypeRef_release(t);
    return __ret835; }
    TypeRef_release(t);
}
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret838 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).count));
    TypeRef_release(t);
    return __ret838; }
    TypeRef_release(t);
}
...
Bind appendMangleSpan_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    uint64_t n = (long long)(((*c).bytes).count);
    { Bind __ret844 = (Bind){.nameStart = start, .nameLen = ({ uint64_t __ov; if (__builtin_sub_overflow((n), (start), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }), .fieldStart = ref, .fieldLen = 0};
    return __ret844; }
}
long long sameMangle_c_Comp_refA_U64_refB_U64(Comp* c, uint64_t refA, uint64_t refB) {
...
long long isCompoundType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret852 = ((long long)((Array_TypeRef_get((*c).types, (long long)(r)).args).count) > 0);
    return __ret852; }
}
void emitConcreteCType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    uint64_t r = resolveTy_c_Comp_tyRef_U64(&((*c)), ref);
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret854 = Array_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret854; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m864 = Array_Stmt_get((*c).stmts, (long long)(sti));
    if (_m864.tag == 0) {
    ...
    {
    Expr _m865 = Array_Expr_get((*c).exprs, (long long)(xi));
    if (_m865.tag == 11) {
    ...
    scanType_c_Comp_ref_U64(&((*c)), ty);
        ...
        (void)ty;
        Array_MakeField fields = _m865.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).count) == 0) {
    { TypeInfo __ret866 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret866; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Array", 5})) {
    TypeRef el = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(Array_U64_get(t.args, (long long)(0)))));
    { TypeInfo __ret867 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret867; }
    TypeRef_release(el);
    }
    { TypeInfo __ret868 = (TypeInfo){.kind = 2, .nameStart = t.nameStart, .nameLen = t.nameLen, .ref = ref};
    TypeRef_release(t);
    return __ret868; }
    TypeRef_release(t);
}
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, Array_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret869 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret869; }
    }
    ...
    { TypeInfo __ret870 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret870; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret873 = (TypeInfo){.kind = 3, .nameStart = mn.nameStart, .nameLen = mn.nameLen, .ref = 0};
    TypeRef_release(elr);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    StructDef_release(s);
    ...
    { TypeInfo __ret874 = (TypeInfo){.kind = 3, .nameStart = at.nameStart, .nameLen = at.nameLen, .ref = 0};
    TypeRef_release(at);
    TypeRef_release(elr);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    ...
    { TypeInfo __ret875 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret878 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
    ...
    { TypeInfo __ret879 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret884 = ((long long)((f.typeParams).count) == (long long)((inst.args).count));
    TypeRef_release(inst);
    return __ret884; }
    TypeRef_release(inst);
}
...
uint64_t arrayInstRef_c_Comp_ae_Bind(Comp* c, Bind ae) {
    ...
    { uint64_t __ret885 = (long long)(((*c).types).count);
    return __ret885; }
    }
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret889 = ((long long)((f.typeParams).count) > 0);
    Func_release(f);
    return __ret889; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    Array_U64 noArgs = Array_U64_new();
    { uint64_t __ret891 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = Array_U64_share(noArgs)});
    Array_U64_release(noArgs);
    return __ret891; }
    Array_U64_release(noArgs);
}
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret895 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret895; }
}
uint64_t argArrayElemRef_c_Comp_argExpr_U64(Comp* c, uint64_t argExpr) {
    {
    Expr _m896 = Array_Expr_get((*c).exprs, (long long)(argExpr));
    if (_m896.tag == 1) {
    ...
    { uint64_t __ret897 = Array_U64_get(lt.args, (long long)(0));
    TypeRef_release(lt);
    return __ret897; }
    }
    }
...
Array_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, Array_Arg args) {
    ...
    { Array_U64 __ret899 = Array_U64_share(out);
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m914 = Array_Expr_get((*c).exprs, (long long)(exprId));
    if (_m914.tag == 1) {
        uint64_t start = _m914.data.Ident.start;
        (void)start;
        uint64_t len = _m914.data.Ident.len;
        (void)len;
    if ((*c).curInClosure) {
    uint64_t li = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
    ...
    (*c).curCaptureMark = savedMark;
        ...
        int64_t op = _m914.data.Unary.op;
        (void)op;
        uint64_t operand = _m914.data.Unary.operand;
        (void)operand;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m914.tag == 3) {
        int64_t op = _m914.data.Binary.op;
        (void)op;
        uint64_t lhs = _m914.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m914.data.Binary.rhs;
        (void)rhs;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), lhs);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
    }
    else if (_m914.tag == 4) {
        uint64_t nameStart = _m914.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m914.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m914.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).count)) {
    ...
    else if (_m914.tag == 10) {
        uint64_t recv = _m914.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m914.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m914.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m914.data.Method.args;
        (void)args;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t base = _m914.data.Field.base;
        (void)base;
        uint64_t nameStart = _m914.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m914.data.Field.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m914.tag == 9) {
        uint64_t base = _m914.data.Index.base;
        (void)base;
        uint64_t index = _m914.data.Index.index;
        (void)index;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), index);
    }
    else if (_m914.tag == 6) {
        uint64_t typeStart = _m914.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m914.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m914.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m914.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m914.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m914.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m914.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).count)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        Array_U64 elems = _m914.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).count)) {
    ...
    else if (_m914.tag == 11) {
        uint64_t operand = _m914.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m914.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m914.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m914.data.Cast.ty;
        (void)ty;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m914.tag == 14) {
        uint64_t opt = _m914.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m914.data.Coalesce.deflt;
        (void)deflt;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), opt);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m914.tag == 15) {
        uint64_t expr = _m914.data.Try.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m914.tag == 16) {
        uint64_t base = _m914.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m914.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m914.data.Arrow.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m914.tag == 13) {
        uint64_t cond = _m914.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m914.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m914.data.IfExpr.elseBlk;
        (void)elseBlk;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
    }
    else if (_m914.tag == 12) {
        uint64_t scrut = _m914.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m914.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m914.tag == 18) {
        uint64_t operand = _m914.data.Move.operand;
        (void)operand;
        long long isBorrow = _m914.data.Move.isBorrow;
        (void)isBorrow;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m915 = Array_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m915.tag == 0) {
        long long mutable = _m915.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m915.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m915.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m915.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m915.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m915.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m915.data.Let.ty;
        (void)ty;
        uint64_t init = _m915.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, le.start, le.len, le.arr, le.ty, 0, mutable, 1);
        ...
        int64_t op = _m915.data.Assign.op;
        (void)op;
        uint64_t target = _m915.data.Assign.target;
        (void)target;
        uint64_t value = _m915.data.Assign.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), target);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m915.tag == 2) {
        uint64_t expr = _m915.data.ExprStmt.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m915.tag == 3) {
        uint64_t value = _m915.data.Return.value;
        (void)value;
        long long hasValue = _m915.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m915.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m915.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m915.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m915.data.If.hasElse;
        (void)hasElse;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m915.data.While.cond;
        (void)cond;
        uint64_t body = _m915.data.While.body;
        (void)body;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m915.tag == 6) {
        uint64_t varStart = _m915.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m915.data.For.varLen;
        (void)varLen;
        long long isRange = _m915.data.For.isRange;
        (void)isRange;
        long long inclusive = _m915.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m915.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m915.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m915.data.For.body;
        (void)body;
        long long isStruct = _m915.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m915.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m915.data.For.patLen;
        (void)patLen;
        Array_Bind binds = _m915.data.For.binds;
        (void)binds;
    uint64_t forMark = scopeMark_c_Comp(&((*c)));
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m915.data.Match.scrut;
        (void)scrut;
        Array_MatchArm arms = _m915.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).count)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m915.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m915.data.Panic.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m915.tag == 9) {
        uint64_t value = _m915.data.Give.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m915.tag == 10) {
    }
    else if (_m915.tag == 11) {
    }
    else { __builtin_unreachable(); }
    }
}
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret938 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), elemStart, elemLen, (PlewString){"U8", 2});
    return __ret938; }
}
long long elemIsRef_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    ...
    { long long __ret940 = isRefInst_c_Comp_ref_U64(&((*c)), er);
    return __ret940; }
}
long long skipArrayElem_c_Comp_ae_Bind(Comp* c, Bind ae) {
...
void rejectAsyncUnsupported_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    while (i < (long long)((stmts).count)) {
    {
    Stmt _m946 = Array_Stmt_get((*c).stmts, (long long)(Array_U64_get(stmts, (long long)(i))));
    if (_m946.tag == 0) {
    }
    else if (_m946.tag == 1) {
    }
    ...
    else if (_m946.tag == 10) {
    }
    else if (_m946.tag == 11) {
    }
    else if (_m946.tag == 8) {
    }
    else if (_m946.tag == 4) {
        uint64_t thenBlk = _m946.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m946.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m946.data.If.hasElse;
        (void)hasElse;
    ...
    rejectAsyncUnsupported_c_Comp_blockId_U64(&((*c)), elseBlk);
        ...
        uint64_t body = _m946.data.While.body;
        (void)body;
    rejectAsyncUnsupported_c_Comp_blockId_U64(&((*c)), body);
    }
    else if (_m946.tag == 7) {
        Array_MatchArm arms = _m946.data.Match.arms;
        (void)arms;
    if ((long long)((arms).count) > 0) {
    if (Array_MatchArm_get(arms, (long long)(0)).isStruct) {
...
void collectAsyncFields_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    while (i < (long long)((stmts).count)) {
    {
    Stmt _m947 = Array_Stmt_get((*c).stmts, (long long)(Array_U64_get(stmts, (long long)(i))));
    if (_m947.tag == 0) {
        long long mutable = _m947.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m947.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m947.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m947.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m947.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m947.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m947.data.Let.ty;
        (void)ty;
        uint64_t init = _m947.data.Let.init;
        (void)init;
    ...
    addLocalCn_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool_cnum_U64(&((*c)), nameStart, nameLen, le.start, le.len, le.arr, le.ty, 0, mutable, 0, cnum);
        ...
        uint64_t thenBlk = _m947.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m947.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m947.data.If.hasElse;
        (void)hasElse;
    ...
    collectAsyncFields_c_Comp_blockId_U64(&((*c)), elseBlk);
        ...
        uint64_t body = _m947.data.While.body;
        (void)body;
    collectAsyncFields_c_Comp_blockId_U64(&((*c)), body);
    }
    else if (_m947.tag == 7) {
        uint64_t scrut = _m947.data.Match.scrut;
        (void)scrut;
        Array_MatchArm arms = _m947.data.Match.arms;
        (void)arms;
    uint64_t scrutRef = exprType_c_Comp_id_U64(&((*c)), scrut).ref;
    long long genericMatch = isGenericEnumInst_c_Comp_ref_U64(&((*c)), scrutRef);
    uint64_t ai = 0;
...
uint64_t nextAsyncVar_c_Comp(Comp* c) {
    ...
    { uint64_t __ret948 = (*c).asyncVarSeq;
    return __ret948; }
}
void genAsyncLet_c_Comp_nameStart_U64_nameLen_U64_effStart_U64_effLen_U64_effArr_Bool_effTy_U64_init_U64_mutable_Bool(Comp* c, uint64_t nameStart, uint64_t nameLen, uint64_t effStart, uint64_t effLen, long long effArr, uint64_t effTy, uint64_t init, long long mutable) {
    uint64_t cnum = nextAsyncVar_c_Comp(&((*c)));
    {
    Expr _m949 = Array_Expr_get((*c).exprs, (long long)(init));
    if (_m949.tag == 19) {
        uint64_t operand = _m949.data.Await.operand;
        (void)operand;
    emitAsyncSuspend_c_Comp_operandId_U64(&((*c)), operand);
...
void genAsyncReturn_c_Comp_value_U64_hasValue_Bool(Comp* c, uint64_t value, long long hasValue) {
    if (hasValue) {
    {
    Expr _m950 = Array_Expr_get((*c).exprs, (long long)(value));
    if (_m950.tag == 19) {
        uint64_t operand = _m950.data.Await.operand;
        (void)operand;
    emitAsyncSuspend_c_Comp_operandId_U64(&((*c)), operand);
...
uint64_t countAsyncAwaits_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    if (_m951.tag == 0) {
        uint64_t init = _m951.data.Let.init;
        (void)init;
    ...
    n = ({ uint64_t __ov; if (__builtin_add_overflow((n), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t value = _m951.data.Return.value;
        (void)value;
        long long hasValue = _m951.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    ...
    n = ({ uint64_t __ov; if (__builtin_add_overflow((n), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t expr = _m951.data.ExprStmt.expr;
        (void)expr;
...
long long exprIsAwait_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m953 = Array_Expr_get((*c).exprs, (long long)(id));
    if (_m953.tag == 19) {
...
Array_Bind collectParts_rootBytes_AU8_toks_ATok(Array_U8 rootBytes, Array_Tok toks) {
    ...
    long long starts = 0;
    {
    Kind _m962 = first.kind;
    if (_m962.tag == 40) {
    starts = 1;
    }
    else if (_m962.tag == 51) {
    starts = 1;
    }
    else {
    ...
    { Array_Bind __ret963 = Array_Bind_share(parts);
...
Array_U8 resolveImport_src_AU8_pStart_U64_pLen_U64_importer_AU8_baseLen_U64_srcRoot_AU8_srcRootLen_U64_stdRoot_AU8_stdRootLen_U64(Array_U8 src, uint64_t pStart, uint64_t pLen, Array_U8 importer, uint64_t baseLen, Array_U8 srcRoot, uint64_t srcRootLen, Array_U8 stdRoot, uint64_t stdRootLen) {
    ...
    { Array_U8 __ret967 = Array_U8_share(out);
    Array_U8_release(out);
    return __ret967; }
    }
    }
    ...
    if (b0 == 47) {
    if (srcRootLen == 0) {
    { Array_U8 __ret969 = Array_U8_share(out);
    Array_U8_release(out);
    return __ret969; }
    }
    uint64_t i = 0;
...
Array_U8 findSrcRoot_entry_AU8(Array_U8 entry) {
    ...
    { Array_U8 __ret975 = Array_U8_share(sr);
    Array_U8_release(sx);
    Array_U8_release(sr);
    Array_U8_release(mn);
    ...
    { Array_U8 __ret976 = Array_U8_share(empty);
...
long long String_isEmpty(PlewString self) {
    { long long __ret979 = ((long long)((({ PlewString __s = self; Array_U8 __b; __b.data = (unsigned char*)plew_rawbuf_alloc(sizeof(unsigned char), __s.len); for (long long __i = 0; __i < __s.len; __i++) __b.data[__i] = (unsigned char)__s.data[__i]; __b.count = __s.len; __b; })).count) == 0);
    return __ret979; }
}
unsigned char digitByteI_d_I64(int64_t d) {
    if (d == 0) {
    { unsigned char __ret980 = 48;
    return __ret980; }
    }
    if (d == 1) {
    { unsigned char __ret981 = 49;
    return __ret981; }
    }
    if (d == 2) {
    { unsigned char __ret982 = 50;
    return __ret982; }
    }
    if (d == 3) {
    { unsigned char __ret983 = 51;
    return __ret983; }
    }
    if (d == 4) {
    { unsigned char __ret984 = 52;
    return __ret984; }
    }
    if (d == 5) {
    { unsigned char __ret985 = 53;
    return __ret985; }
    }
    if (d == 6) {
    { unsigned char __ret986 = 54;
    return __ret986; }
    }
    if (d == 7) {
    { unsigned char __ret987 = 55;
    return __ret987; }
    }
    if (d == 8) {
    { unsigned char __ret988 = 56;
    return __ret988; }
    }
    { unsigned char __ret989 = 57;
    return __ret989; }
}
unsigned char digitByteU_d_U64(uint64_t d) {
    if (d == 0) {
    { unsigned char __ret990 = 48;
    return __ret990; }
    }
    if (d == 1) {
    { unsigned char __ret991 = 49;
    return __ret991; }
    }
    if (d == 2) {
    { unsigned char __ret992 = 50;
    return __ret992; }
    }
    if (d == 3) {
    { unsigned char __ret993 = 51;
    return __ret993; }
    }
    if (d == 4) {
    { unsigned char __ret994 = 52;
    return __ret994; }
    }
    if (d == 5) {
    { unsigned char __ret995 = 53;
    return __ret995; }
    }
    if (d == 6) {
    { unsigned char __ret996 = 54;
    return __ret996; }
    }
    if (d == 7) {
    { unsigned char __ret997 = 55;
    return __ret997; }
    }
    if (d == 8) {
    { unsigned char __ret998 = 56;
    return __ret998; }
    }
    { unsigned char __ret999 = 57;
    return __ret999; }
}
PlewString I64_format_format_String(int64_t self, PlewString format) {
    int64_t n = self;
    ...
    { PlewString __ret1000 = plew_stringFromBytes(Array_U8_share(out));
    Array_U8_release(out);
...
PlewString U64_format_format_String(uint64_t self, PlewString format) {
    ...
    { PlewString __ret1001 = plew_stringFromBytes(Array_U8_share(out));
    Array_U8_release(out);
    Array_U8_release(digits);
    return __ret1001; }
    Array_U8_release(out);
...
PlewString I8_format_format_String(int8_t self, PlewString format) {
    { PlewString __ret1002 = I64_format_format_String(((int64_t)(self)), format);
    return __ret1002; }
}
PlewString I16_format_format_String(int16_t self, PlewString format) {
    { PlewString __ret1003 = I64_format_format_String(((int64_t)(self)), format);
    return __ret1003; }
}
PlewString I32_format_format_String(int32_t self, PlewString format) {
    { PlewString __ret1004 = I64_format_format_String(((int64_t)(self)), format);
    return __ret1004; }
}
PlewString U8_format_format_String(unsigned char self, PlewString format) {
    { PlewString __ret1005 = U64_format_format_String(((uint64_t)(self)), format);
    return __ret1005; }
}
PlewString U16_format_format_String(uint16_t self, PlewString format) {
    { PlewString __ret1006 = U64_format_format_String(((uint64_t)(self)), format);
    return __ret1006; }
}
PlewString U32_format_format_String(uint32_t self, PlewString format) {
    { PlewString __ret1007 = U64_format_format_String(((uint64_t)(self)), format);
    return __ret1007; }
}
PlewString Bool_format_format_String(long long self, PlewString format) {
    if (self) {
    { PlewString __ret1008 = (PlewString){"1", 1};
    return __ret1008; }
    }
    else {
    { PlewString __ret1009 = (PlewString){"0", 1};
    return __ret1009; }
    }
}
void Array_U8_append_value_T(Array_U8* self, unsigned char value) {
...
unsigned char Array_U8_get_i_U64(Array_U8 self, uint64_t i) {
    { unsigned char __ret1010 = Array_U8_get((self), (long long)(i));
    return __ret1010; }
}
void Array_U8_set_i_U64_value_T(Array_U8* self, uint64_t i, unsigned char value) {
...
Bind Array_Bind_get_i_U64(Array_Bind self, uint64_t i) {
    { Bind __ret1011 = Array_Bind_get((self), (long long)(i));
    return __ret1011; }
}
void Array_Bind_set_i_U64_value_T(Array_Bind* self, uint64_t i, Bind value) {
...
Tok Array_Tok_get_i_U64(Array_Tok self, uint64_t i) {
    { Tok __ret1012 = Array_Tok_get((self), (long long)(i));
    return __ret1012; }
}
void Array_Tok_set_i_U64_value_T(Array_Tok* self, uint64_t i, Tok value) {
...
uint64_t Array_U64_get_i_U64(Array_U64 self, uint64_t i) {
    { uint64_t __ret1013 = Array_U64_get((self), (long long)(i));
    return __ret1013; }
}
void Array_U64_set_i_U64_value_T(Array_U64* self, uint64_t i, uint64_t value) {
...
Arg Array_Arg_get_i_U64(Array_Arg self, uint64_t i) {
    { Arg __ret1014 = Array_Arg_get((self), (long long)(i));
    return __ret1014; }
}
void Array_Arg_set_i_U64_value_T(Array_Arg* self, uint64_t i, Arg value) {
...
MakeField Array_MakeField_get_i_U64(Array_MakeField self, uint64_t i) {
    { MakeField __ret1015 = Array_MakeField_get((self), (long long)(i));
    return __ret1015; }
}
void Array_MakeField_set_i_U64_value_T(Array_MakeField* self, uint64_t i, MakeField value) {
...
MatchArm Array_MatchArm_get_i_U64(Array_MatchArm self, uint64_t i) {
    { MatchArm __ret1016 = Array_MatchArm_get((self), (long long)(i));
    return __ret1016; }
}
void Array_MatchArm_set_i_U64_value_T(Array_MatchArm* self, uint64_t i, MatchArm value) {
...
Param Array_Param_get_i_U64(Array_Param self, uint64_t i) {
    { Param __ret1017 = Array_Param_get((self), (long long)(i));
    return __ret1017; }
}
void Array_Param_set_i_U64_value_T(Array_Param* self, uint64_t i, Param value) {
...
FieldDef Array_FieldDef_get_i_U64(Array_FieldDef self, uint64_t i) {
    { FieldDef __ret1018 = Array_FieldDef_get((self), (long long)(i));
    return __ret1018; }
}
void Array_FieldDef_set_i_U64_value_T(Array_FieldDef* self, uint64_t i, FieldDef value) {
...
Func Array_Func_get_i_U64(Array_Func self, uint64_t i) {
    { Func __ret1019 = Array_Func_get((self), (long long)(i));
    return __ret1019; }
}
void Array_Func_set_i_U64_value_T(Array_Func* self, uint64_t i, Func value) {
...
Variant Array_Variant_get_i_U64(Array_Variant self, uint64_t i) {
    { Variant __ret1020 = Array_Variant_get((self), (long long)(i));
    return __ret1020; }
}
void Array_Variant_set_i_U64_value_T(Array_Variant* self, uint64_t i, Variant value) {
...
Expr Array_Expr_get_i_U64(Array_Expr self, uint64_t i) {
    { Expr __ret1021 = Array_Expr_get((self), (long long)(i));
    return __ret1021; }
}
void Array_Expr_set_i_U64_value_T(Array_Expr* self, uint64_t i, Expr value) {
...
Stmt Array_Stmt_get_i_U64(Array_Stmt self, uint64_t i) {
    { Stmt __ret1022 = Array_Stmt_get((self), (long long)(i));
    return __ret1022; }
}
void Array_Stmt_set_i_U64_value_T(Array_Stmt* self, uint64_t i, Stmt value) {
...
Block Array_Block_get_i_U64(Array_Block self, uint64_t i) {
    { Block __ret1023 = Array_Block_get((self), (long long)(i));
    return __ret1023; }
}
void Array_Block_set_i_U64_value_T(Array_Block* self, uint64_t i, Block value) {
...
StructDef Array_StructDef_get_i_U64(Array_StructDef self, uint64_t i) {
    { StructDef __ret1024 = Array_StructDef_get((self), (long long)(i));
    return __ret1024; }
}
void Array_StructDef_set_i_U64_value_T(Array_StructDef* self, uint64_t i, StructDef value) {
...
EnumDef Array_EnumDef_get_i_U64(Array_EnumDef self, uint64_t i) {
    { EnumDef __ret1025 = Array_EnumDef_get((self), (long long)(i));
    return __ret1025; }
}
void Array_EnumDef_set_i_U64_value_T(Array_EnumDef* self, uint64_t i, EnumDef value) {
...
TraitDef Array_TraitDef_get_i_U64(Array_TraitDef self, uint64_t i) {
    { TraitDef __ret1026 = Array_TraitDef_get((self), (long long)(i));
    return __ret1026; }
}
void Array_TraitDef_set_i_U64_value_T(Array_TraitDef* self, uint64_t i, TraitDef value) {
...
Conform Array_Conform_get_i_U64(Array_Conform self, uint64_t i) {
    { Conform __ret1027 = Array_Conform_get((self), (long long)(i));
    return __ret1027; }
}
void Array_Conform_set_i_U64_value_T(Array_Conform* self, uint64_t i, Conform value) {
...
MethodAlias Array_MethodAlias_get_i_U64(Array_MethodAlias self, uint64_t i) {
    { MethodAlias __ret1028 = Array_MethodAlias_get((self), (long long)(i));
    return __ret1028; }
}
void Array_MethodAlias_set_i_U64_value_T(Array_MethodAlias* self, uint64_t i, MethodAlias value) {
...
DeriveReq Array_DeriveReq_get_i_U64(Array_DeriveReq self, uint64_t i) {
    { DeriveReq __ret1029 = Array_DeriveReq_get((self), (long long)(i));
    return __ret1029; }
}
void Array_DeriveReq_set_i_U64_value_T(Array_DeriveReq* self, uint64_t i, DeriveReq value) {
...
FuncBound Array_FuncBound_get_i_U64(Array_FuncBound self, uint64_t i) {
    { FuncBound __ret1030 = Array_FuncBound_get((self), (long long)(i));
    return __ret1030; }
}
void Array_FuncBound_set_i_U64_value_T(Array_FuncBound* self, uint64_t i, FuncBound value) {
...
TypeRef Array_TypeRef_get_i_U64(Array_TypeRef self, uint64_t i) {
    { TypeRef __ret1031 = Array_TypeRef_get((self), (long long)(i));
    return __ret1031; }
}
void Array_TypeRef_set_i_U64_value_T(Array_TypeRef* self, uint64_t i, TypeRef value) {
...
FnInst Array_FnInst_get_i_U64(Array_FnInst self, uint64_t i) {
    { FnInst __ret1032 = Array_FnInst_get((self), (long long)(i));
    return __ret1032; }
}
void Array_FnInst_set_i_U64_value_T(Array_FnInst* self, uint64_t i, FnInst value) {
...
CaptureEntry Array_CaptureEntry_get_i_U64(Array_CaptureEntry self, uint64_t i) {
    { CaptureEntry __ret1033 = Array_CaptureEntry_get((self), (long long)(i));
    return __ret1033; }
}
void Array_CaptureEntry_set_i_U64_value_T(Array_CaptureEntry* self, uint64_t i, CaptureEntry value) {
...
Local Array_Local_get_i_U64(Array_Local self, uint64_t i) {
    { Local __ret1034 = Array_Local_get((self), (long long)(i));
    return __ret1034; }
}
void Array_Local_set_i_U64_value_T(Array_Local* self, uint64_t i, Local value) {
...
PatInfo Array_PatInfo_get_i_U64(Array_PatInfo self, uint64_t i) {
    { PatInfo __ret1035 = Array_PatInfo_get((self), (long long)(i));
    return __ret1035; }
}
void Array_PatInfo_set_i_U64_value_T(Array_PatInfo* self, uint64_t i, PatInfo value) {
