...
long long litFitsType_c_Comp_value_U64_neg_Bool_dstStart_U64_dstLen_U64(Comp* c, uint64_t value, long long neg, uint64_t dstStart, uint64_t dstLen) {
    ...
    { long long __ret337 = litFitsBits_value_U64_neg_Bool_bits_U64_sgn_Bool(value, neg, bits, sgn);
    return __ret337; }
}
long long litFitsBits_value_U64_neg_Bool_bits_U64_sgn_Bool(uint64_t value, long long neg, uint64_t bits, long long sgn) {
    if (neg) {
    ...
    if (bits == 8) {
    { long long __ret339 = (value <= 128);
    return __ret339; }
    }
    if (bits == 16) {
    { long long __ret340 = (value <= 32768);
    return __ret340; }
    }
    if (bits == 32) {
    { long long __ret341 = (value <= 2147483648);
    return __ret341; }
    }
    if (value == 0) {
    ...
    { long long __ret343 = (({ uint64_t __ov; if (__builtin_sub_overflow((value), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }) <= 9223372036854775807);
    return __ret343; }
    }
    if (sgn) {
    if (bits == 8) {
    { long long __ret344 = (value <= 127);
    return __ret344; }
    }
    if (bits == 16) {
    { long long __ret345 = (value <= 32767);
    return __ret345; }
    }
    if (bits == 32) {
    { long long __ret346 = (value <= 2147483647);
    return __ret346; }
    }
    { long long __ret347 = (value <= 9223372036854775807);
    return __ret347; }
    }
    if (bits == 8) {
    { long long __ret348 = (value <= 255);
    return __ret348; }
    }
    if (bits == 16) {
    { long long __ret349 = (value <= 65535);
    return __ret349; }
    }
    if (bits == 32) {
    { long long __ret350 = (value <= 4294967295);
    return __ret350; }
    }
...
uint64_t arrayElemRef_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret352 = ae.fieldStart;
    return __ret352; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
...
Bind arrayElemNameForRef_c_Comp_elemRef_U64(Comp* c, uint64_t elemRef) {
    ...
    { Bind __ret354 = (Bind){.nameStart = ae.nameStart, .nameLen = ae.nameLen, .fieldStart = elemRef, .fieldLen = 0};
    return __ret354; }
    }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    { Bind __ret355 = (Bind){.nameStart = t.nameStart, .nameLen = t.nameLen, .fieldStart = elemRef, .fieldLen = 0};
    TypeRef_release(t);
    return __ret355; }
    TypeRef_release(t);
    }
    { Bind __ret356 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret356; }
}
void genCElem_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (len == 0) {
...
uint64_t exprOffset_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m361 = e;
    if (_m361.tag == 0) {
        uint64_t offset = _m361.data.Int.offset;
        (void)offset;
    { uint64_t __ret362 = offset;
    return __ret362; }
    }
    else if (_m361.tag == 1) {
        uint64_t start = _m361.data.Ident.start;
        (void)start;
        uint64_t len = _m361.data.Ident.len;
        (void)len;
    { uint64_t __ret363 = start;
    return __ret363; }
    }
    else if (_m361.tag == 7) {
        uint64_t start = _m361.data.Str.start;
        (void)start;
        uint64_t len = _m361.data.Str.len;
        (void)len;
    { uint64_t __ret364 = start;
    return __ret364; }
    }
    else if (_m361.tag == 4) {
        uint64_t nameStart = _m361.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m361.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m361.data.Call.args;
        (void)args;
    { uint64_t __ret365 = nameStart;
    return __ret365; }
    }
    else if (_m361.tag == 10) {
        uint64_t recv = _m361.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m361.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m361.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m361.data.Method.args;
        (void)args;
    { uint64_t __ret366 = nameStart;
    return __ret366; }
    }
    else if (_m361.tag == 5) {
        uint64_t base = _m361.data.Field.base;
        (void)base;
        uint64_t nameStart = _m361.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m361.data.Field.nameLen;
        (void)nameLen;
    { uint64_t __ret367 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret367; }
    }
    else if (_m361.tag == 9) {
        uint64_t base = _m361.data.Index.base;
        (void)base;
        uint64_t index = _m361.data.Index.index;
        (void)index;
    { uint64_t __ret368 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret368; }
    }
    else if (_m361.tag == 3) {
        int64_t op = _m361.data.Binary.op;
        (void)op;
        uint64_t lhs = _m361.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m361.data.Binary.rhs;
        (void)rhs;
    { uint64_t __ret369 = exprOffset_c_Comp_id_U64(&((*c)), lhs);
    return __ret369; }
    }
    else if (_m361.tag == 2) {
        int64_t op = _m361.data.Unary.op;
        (void)op;
        uint64_t operand = _m361.data.Unary.operand;
        (void)operand;
    { uint64_t __ret370 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret370; }
    }
    else if (_m361.tag == 11) {
        uint64_t operand = _m361.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m361.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m361.data.Cast.tyLen;
        (void)tyLen;
    { uint64_t __ret371 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret371; }
    }
    else if (_m361.tag == 6) {
        uint64_t typeStart = _m361.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m361.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m361.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m361.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m361.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m361.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m361.data.Make.fields;
        (void)fields;
    { uint64_t __ret372 = typeStart;
    return __ret372; }
    }
    else if (_m361.tag == 12) {
        uint64_t scrut = _m361.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m361.data.MatchExpr.arms;
        (void)arms;
    { uint64_t __ret373 = exprOffset_c_Comp_id_U64(&((*c)), scrut);
    return __ret373; }
    }
    else if (_m361.tag == 13) {
        uint64_t cond = _m361.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m361.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m361.data.IfExpr.elseBlk;
        (void)elseBlk;
    { uint64_t __ret374 = exprOffset_c_Comp_id_U64(&((*c)), cond);
    return __ret374; }
    }
    else if (_m361.tag == 14) {
        uint64_t opt = _m361.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m361.data.Coalesce.deflt;
        (void)deflt;
    { uint64_t __ret375 = exprOffset_c_Comp_id_U64(&((*c)), opt);
    return __ret375; }
    }
    else if (_m361.tag == 15) {
        uint64_t expr = _m361.data.Try.expr;
        (void)expr;
    { uint64_t __ret376 = exprOffset_c_Comp_id_U64(&((*c)), expr);
    return __ret376; }
    }
    else if (_m361.tag == 16) {
        uint64_t base = _m361.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m361.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m361.data.Arrow.nameLen;
        (void)nameLen;
    { uint64_t __ret377 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret377; }
    }
    else if (_m361.tag == 17) {
        PlewArray_Param params = _m361.data.Closure.params;
        (void)params;
        long long hasRet = _m361.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m361.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m361.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m361.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m361.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m361.data.Closure.body;
        (void)body;
    { uint64_t __ret378 = retStart;
    return __ret378; }
    }
    else {
    { uint64_t __ret379 = 0;
...
uint64_t findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret380 = typeMatch;
    return __ret380; }
    }
    { uint64_t __ret381 = firstLabel;
    return __ret381; }
}
uint64_t firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret383 = (long long)(((*c).funcs).len);
    return __ret383; }
}
long long funcNameExists_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    { long long __ret384 = (firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(&((*c)), nameStart, nameLen) != (long long)(((*c).funcs).len));
    return __ret384; }
}
uint64_t findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret385 = typeMatch;
    return __ret385; }
    }
    if (firstLabel != (long long)(((*c).funcs).len)) {
    { uint64_t __ret386 = firstLabel;
    return __ret386; }
    }
    uint64_t ai = 0;
    ...
    { uint64_t __ret387 = findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recvStart, recvLen, al.realStart, al.realLen, PlewArray_Arg_share(args));
    return __ret387; }
    }
    }
    ai = ({ uint64_t __ov; if (__builtin_add_overflow((ai), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    { uint64_t __ret388 = (long long)(((*c).funcs).len);
    return __ret388; }
}
uint64_t findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
...
long long isTypeName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret393 = (genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), start, len) < (long long)(((*c).structs).len));
    return __ret393; }
}
Bind assocRecvName_c_Comp_recv_U64(Comp* c, uint64_t recv) {
    {
    Expr _m394 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m394.tag == 1) {
        uint64_t start = _m394.data.Ident.start;
        (void)start;
        uint64_t len = _m394.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { Bind __ret395 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret395; }
    }
    ...
    { Bind __ret397 = (Bind){.nameStart = start, .nameLen = len, .fieldStart = start, .fieldLen = len};
    return __ret397; }
    }
...
long long argMatchesParam_c_Comp_argExpr_U64_p_Param(Comp* c, uint64_t argExpr, Param p) {
    ...
    if (p.tyIsArray) {
    if (ti.kind == 3) {
    { long long __ret406 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret406; }
    }
    ...
    if (ti.kind == 1) {
    { long long __ret408 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), p.tyStart, p.tyLen, (PlewString){"String", 6});
    return __ret408; }
    }
    if (ti.kind == 2) {
    { long long __ret409 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret409; }
    }
    if (ti.nameLen != 0) {
    ...
    { long long __ret411 = isIntType_c_Comp_start_U64_len_U64(&((*c)), p.tyStart, p.tyLen);
    return __ret411; }
}
long long paramsTypesMatch_c_Comp_params_AParam_args_AArg(Comp* c, PlewArray_Param params, PlewArray_Arg args) {
    uint64_t i = 0;
...
long long callLabelsOk_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    { long long __ret414 = (findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, PlewArray_Arg_share(args)) != (long long)(((*c).funcs).len));
    return __ret414; }
    }
...
TypeInfo scalarInfo(void) {
    { TypeInfo __ret426 = (TypeInfo){.kind = 0, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret426; }
}
Bind kwSpan_c_Comp_kw_String_kwLen_U64(Comp* c, PlewString kw, uint64_t kwLen) {
    ...
    { Bind __ret428 = (Bind){.nameStart = i, .nameLen = kwLen, .fieldStart = i, .fieldLen = kwLen};
    return __ret428; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
...
Bind stringTypeSpan_c_Comp(Comp* c) {
    { Bind __ret430 = kwSpan_c_Comp_kw_String_kwLen_U64(&((*c)), (PlewString){"String", 6}, 6);
    return __ret430; }
}
TypeInfo typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(Comp* c, uint64_t start, uint64_t len, long long isArray) {
    if (isArray) {
    { TypeInfo __ret431 = (TypeInfo){.kind = 3, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret431; }
    }
    if (len == 0) {
    ...
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"String", 6})) {
    { TypeInfo __ret433 = (TypeInfo){.kind = 1, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret433; }
    }
    if (isPrimType_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { TypeInfo __ret434 = (TypeInfo){.kind = 0, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret434; }
    }
    { TypeInfo __ret435 = (TypeInfo){.kind = 2, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret435; }
}
void addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(Comp* c, uint64_t nameStart, uint64_t nameLen, uint64_t tyStart, uint64_t tyLen, long long isArray, uint64_t ty, long long isInout, long long isMut, long long owned) {
...
uint64_t scopeMark_c_Comp(Comp* c) {
    { uint64_t __ret437 = (long long)(((*c).locals).len);
    return __ret437; }
}
void emitScopeDrops_c_Comp_mark_U64_exclIdx_U64(Comp* c, uint64_t mark, uint64_t exclIdx) {
...
long long structLocalReleasable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret442 = structNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret442; }
}
void popLocals_c_Comp_mark_U64(Comp* c, uint64_t mark) {
...
long long localIsMutable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { long long __ret443 = (*c).curSelfInout;
    return __ret443; }
    }
    if ((*c).curInClosure) {
    if (isCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len)) {
    { long long __ret444 = isBoxedCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len);
    return __ret444; }
    }
    }
    uint64_t i = (long long)(((*c).locals).len);
...
long long isSelfRef_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if ((*c).curHasRecv) {
    { long long __ret448 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"self", 4});
    return __ret448; }
    }
...
long long isInoutLocal_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { long long __ret450 = (*c).curSelfInout;
    return __ret450; }
    }
    uint64_t i = (long long)(((*c).locals).len);
    while (i > 0) {
...
long long typeIsUnique_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret454 = PlewArray_StructDef_get((*c).structs, (long long)(si)).isUnique;
    return __ret454; }
}
uint64_t localIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = (long long)(((*c).locals).len);
    ...
    { uint64_t __ret456 = (long long)(((*c).locals).len);
    return __ret456; }
}
long long localMoved_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = (long long)(((*c).locals).len);
...
void markMovedExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m459 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m459.tag == 1) {
        uint64_t start = _m459.data.Ident.start;
        (void)start;
        uint64_t len = _m459.data.Ident.len;
        (void)len;
...
TypeInfo fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t structStart, uint64_t structLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret460 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.tyStart, f.tyLen, f.tyIsArray);
...
long long placeIsMutable_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m464 = e;
    if (_m464.tag == 1) {
        uint64_t start = _m464.data.Ident.start;
        (void)start;
        uint64_t len = _m464.data.Ident.len;
        (void)len;
    { long long __ret465 = localIsMutable_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret465; }
    }
    else if (_m464.tag == 5) {
        uint64_t base = _m464.data.Field.base;
        (void)base;
        uint64_t nameStart = _m464.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m464.data.Field.nameLen;
        (void)nameLen;
    ...
    return __ret468; }
        ...
        uint64_t base = _m464.data.Index.base;
        (void)base;
        uint64_t index = _m464.data.Index.index;
        (void)index;
    { long long __ret469 = placeIsMutable_c_Comp_id_U64(&((*c)), base);
    return __ret469; }
    }
    else if (_m464.tag == 16) {
        uint64_t base = _m464.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m464.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m464.data.Arrow.nameLen;
        (void)nameLen;
...
TypeInfo exprType_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m472 = e;
    if (_m472.tag == 0) {
        uint64_t tyStart = _m472.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m472.data.Int.tyLen;
        (void)tyLen;
    if (tyLen != 0) {
    { TypeInfo __ret473 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret473; }
    }
    ...
    return __ret474; }
        ...
        uint64_t start = _m472.data.Str.start;
        (void)start;
        uint64_t len = _m472.data.Str.len;
        (void)len;
    { TypeInfo __ret475 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret475; }
    }
    else if (_m472.tag == 1) {
    ...
    { TypeInfo __ret476 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    return __ret476; }
    TypeRef_release(rt);
    }
    { TypeInfo __ret477 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), (*c).curRecvStart, (*c).curRecvLen, 0);
    return __ret477; }
    }
    if ((*c).curInClosure) {
    uint64_t ci = 0;
    ...
    { TypeInfo __ret478 = (TypeInfo){.kind = 2, .nameStart = rt2.nameStart, .nameLen = rt2.nameLen, .ref = ce.ty};
    TypeRef_release(rt2);
    return __ret478; }
    TypeRef_release(rt2);
    }
    { TypeInfo __ret479 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), ce.tyStart, ce.tyLen, ce.isArray);
    return __ret479; }
    }
    }
    ...
    { TypeInfo __ret480 = (TypeInfo){.kind = 2, .nameStart = lt.nameStart, .nameLen = lt.nameLen, .ref = lo.ty};
    TypeRef_release(lt);
    return __ret480; }
    TypeRef_release(lt);
    }
    ...
    { TypeInfo __ret481 = (TypeInfo){.kind = 2, .nameStart = lt2.nameStart, .nameLen = lt2.nameLen, .ref = lo.ty};
    TypeRef_release(lt2);
    return __ret481; }
    TypeRef_release(lt2);
    }
    ...
    { TypeInfo __ret482 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get((*c).curTypeArgs, (long long)(k)));
    return __ret482; }
    }
    k = ({ uint64_t __ov; if (__builtin_add_overflow((k), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    }
    { TypeInfo __ret483 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, lo.isArray);
    return __ret483; }
    }
    }
    ...
    return __ret484; }
        ...
        int64_t op = _m472.data.Unary.op;
        (void)op;
        uint64_t operand = _m472.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    { TypeInfo __ret485 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret485; }
    }
    if (op == 79) {
    { TypeInfo __ret486 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret486; }
    }
    ...
    return __ret487; }
        ...
        int64_t op = _m472.data.Binary.op;
        (void)op;
        uint64_t lhs = _m472.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m472.data.Binary.rhs;
        (void)rhs;
    if (op >= 56) {
    if (op <= 60) {
    { TypeInfo __ret488 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret488; }
    }
    }
    if (op >= 74) {
    if (op <= 78) {
    { TypeInfo __ret489 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret489; }
    }
    }
    ...
    return __ret490; }
        ...
        uint64_t nameStart = _m472.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m472.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m472.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"readStdin", 9})) {
    ...
    { TypeInfo __ret495 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inferred, (long long)(k)));
    ...
    { TypeInfo __ret496 = (TypeInfo){.kind = 2, .nameStart = rtr.nameStart, .nameLen = rtr.nameLen, .ref = f.retTy};
    TypeRef_release(rtr);
    Func_release(f);
    return __ret496; }
    TypeRef_release(rtr);
    }
    { TypeInfo __ret497 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.retStart, f.retLen, f.retIsArray);
    Func_release(f);
    return __ret497; }
    }
    ...
    if (u8.nameLen != 0) {
    { TypeInfo __ret500 = (TypeInfo){.kind = 3, .nameStart = u8.nameStart, .nameLen = u8.nameLen, .ref = 0};
    return __ret500; }
    }
    }
    }
    if (isGenericInst_c_Comp_ref_U64(&((*c)), bt.ref)) {
    { TypeInfo __ret501 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.ref, nameStart, nameLen);
    return __ret501; }
    }
    if (bt.kind == 2) {
    { TypeInfo __ret502 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.nameStart, bt.nameLen, nameStart, nameLen);
    return __ret502; }
    }
    ...
    return __ret503; }
        ...
        uint64_t typeStart = _m472.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m472.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m472.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m472.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m472.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m472.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m472.data.Make.fields;
        (void)fields;
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ty)) {
    { TypeInfo __ret504 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = ty};
    return __ret504; }
    }
    { TypeInfo __ret505 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = 0};
    return __ret505; }
    }
    else if (_m472.tag == 8) {
        PlewArray_U64 elems = _m472.data.Array.elems;
        (void)elems;
    ...
    { TypeInfo __ret507 = (TypeInfo){.kind = 3, .nameStart = xn.nameStart, .nameLen = xn.nameLen, .ref = 0};
    TypeRef_release(rt);
    return __ret507; }
    }
    }
    ...
    else if (_m472.tag == 10) {
        uint64_t recv = _m472.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m472.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m472.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m472.data.Method.args;
        (void)args;
    ...
    if (mf.hasRet) {
    { TypeInfo __ret514 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), mf.retStart, mf.retLen, mf.retIsArray);
    Func_release(mf);
    return __ret514; }
    }
    ...
    else if (_m472.tag == 11) {
        uint64_t operand = _m472.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m472.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m472.data.Cast.tyLen;
        (void)tyLen;
    { TypeInfo __ret517 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret517; }
    }
    else if (_m472.tag == 12) {
        uint64_t scrut = _m472.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m472.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    { TypeInfo __ret518 = exprType_c_Comp_id_U64(&((*c)), PlewArray_MatchArm_get(arms, (long long)(0)).body);
    return __ret518; }
    }
    { TypeInfo __ret519 = scalarInfo();
    return __ret519; }
    }
    else if (_m472.tag == 13) {
        uint64_t cond = _m472.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m472.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m472.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (g < (long long)(((*c).exprs).len)) {
    { TypeInfo __ret520 = exprType_c_Comp_id_U64(&((*c)), g);
    return __ret520; }
    }
    { TypeInfo __ret521 = scalarInfo();
    return __ret521; }
    }
    else if (_m472.tag == 14) {
        uint64_t opt = _m472.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m472.data.Coalesce.deflt;
        (void)deflt;
    { TypeInfo __ret522 = exprType_c_Comp_id_U64(&((*c)), deflt);
    return __ret522; }
    }
    else if (_m472.tag == 15) {
        uint64_t expr = _m472.data.Try.expr;
        (void)expr;
    ...
    { TypeInfo __ret523 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(0)));
    ...
    if (pt.kind == 2) {
    { TypeInfo __ret525 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), pt.nameStart, pt.nameLen, nameStart, nameLen);
    TypeRef_release(inst);
    return __ret525; }
    }
    TypeRef_release(inst);
    ...
    else if (_m472.tag == 17) {
        PlewArray_Param params = _m472.data.Closure.params;
        (void)params;
        long long hasRet = _m472.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m472.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m472.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m472.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m472.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m472.data.Closure.body;
        (void)body;
    { TypeInfo __ret527 = scalarInfo();
    return __ret527; }
    }
    else if (_m472.tag == 18) {
        uint64_t operand = _m472.data.Move.operand;
        (void)operand;
        long long isBorrow = _m472.data.Move.isBorrow;
        (void)isBorrow;
    { TypeInfo __ret528 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret528; }
    }
...
uint64_t blockGiveExpr_c_Comp_blkId_U64(Comp* c, uint64_t blkId) {
    ...
    Stmt _m530 = s;
    if (_m530.tag == 10) {
        uint64_t value = _m530.data.Give.value;
        (void)value;
    found = value;
    }
    else {
...
PlewString unaryOpStr_op_I64(int64_t op) {
    if (op == 57) {
    { PlewString __ret551 = (PlewString){"-", 1};
    return __ret551; }
    }
    if (op == 79) {
    { PlewString __ret552 = (PlewString){"~", 1};
    return __ret552; }
    }
...
PlewString overflowBuiltin_op_I64(int64_t op) {
    if (op == 56) {
    { PlewString __ret563 = (PlewString){"__builtin_add_overflow", 22};
    return __ret563; }
    }
    if (op == 57) {
    { PlewString __ret564 = (PlewString){"__builtin_sub_overflow", 22};
    return __ret564; }
    }
    { PlewString __ret565 = (PlewString){"__builtin_mul_overflow", 22};
    return __ret565; }
}
TypeInfo arithIntType_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
PlewString intMinMacro_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I8", 2})) {
    { PlewString __ret569 = (PlewString){"INT8_MIN", 8};
    return __ret569; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I16", 3})) {
    { PlewString __ret570 = (PlewString){"INT16_MIN", 9};
    return __ret570; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I32", 3})) {
    { PlewString __ret571 = (PlewString){"INT32_MIN", 9};
    return __ret571; }
    }
    { PlewString __ret572 = (PlewString){"INT64_MIN", 9};
    return __ret572; }
}
void genCheckedNeg_c_Comp_operand_U64_tyStart_U64_tyLen_U64(Comp* c, uint64_t operand, uint64_t tyStart, uint64_t tyLen) {
    plew_write((PlewString){"({ ", 3});
...
PlewString assignOpStr_op_I64(int64_t op) {
    ...
    if (op == 83) {
    { PlewString __ret582 = (PlewString){" <<= ", 5};
    return __ret582; }
    }
    { PlewString __ret583 = (PlewString){" >>= ", 5};
    return __ret583; }
}
long long isCompoundDiv_op_I64(int64_t op) {
    if (op == 70) {
    ...
    { long long __ret586 = 0;
    return __ret586; }
}
PlewString compoundDivFn_op_I64(int64_t op) {
    if (op == 70) {
    { PlewString __ret587 = (PlewString){"plew_div(", 9};
    return __ret587; }
    }
    if (op == 71) {
    { PlewString __ret588 = (PlewString){"plew_mod(", 9};
    return __ret588; }
    }
    { PlewString __ret589 = (PlewString){"", 0};
    return __ret589; }
}
PlewString assignToBinStr_op_I64(int64_t op) {
    if (op == 67) {
...
ConstInt notConst(void) {
    { ConstInt __ret600 = (ConstInt){.isConst = 0, .neg = 0, .value = 0};
    return __ret600; }
}
ConstInt mkConst_neg_Bool_mag_U64(long long neg, uint64_t mag) {
    if (mag == 0) {
    { ConstInt __ret601 = (ConstInt){.isConst = 1, .neg = 0, .value = 0};
    return __ret601; }
    }
    { ConstInt __ret602 = (ConstInt){.isConst = 1, .neg = neg, .value = mag};
    return __ret602; }
}
ConstInt addConst_na_Bool_a_U64_nb_Bool_b_U64(long long na, uint64_t a, long long nb, uint64_t b) {
    if (na == nb) {
    if (a > ({ uint64_t __ov; if (__builtin_sub_overflow((9223372036854775807), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })) {
    { ConstInt __ret603 = notConst();
    return __ret603; }
    }
    { ConstInt __ret604 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_add_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret604; }
    }
    if (a >= b) {
    { ConstInt __ret605 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_sub_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret605; }
    }
    { ConstInt __ret606 = mkConst_neg_Bool_mag_U64(nb, ({ uint64_t __ov; if (__builtin_sub_overflow((b), (a), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret606; }
}
ConstInt foldConst_c_Comp_id_U64(Comp* c, uint64_t id) {
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    ...
    Expr _m607 = e;
    if (_m607.tag == 0) {
        uint64_t value = _m607.data.Int.value;
        (void)value;
        long long isBool = _m607.data.Int.isBool;
        (void)isBool;
    if (isBool) {
    { ConstInt __ret608 = notConst();
    return __ret608; }
    }
    ...
    { ConstInt __ret610 = (ConstInt){.isConst = 1, .neg = 0, .value = value};
    return __ret610; }
    }
    else if (_m607.tag == 2) {
        int64_t op = _m607.data.Unary.op;
        (void)op;
        uint64_t operand = _m607.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ConstInt o = foldConst_c_Comp_id_U64(&((*c)), operand);
    if (o.isConst) {
    { ConstInt __ret611 = mkConst_neg_Bool_mag_U64(!(o.neg), o.value);
    return __ret611; }
    }
    }
    { ConstInt __ret612 = notConst();
    return __ret612; }
    }
    else if (_m607.tag == 3) {
        int64_t op = _m607.data.Binary.op;
        (void)op;
        uint64_t lhs = _m607.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m607.data.Binary.rhs;
        (void)rhs;
    ...
    if (b.isConst) {
    if (op == 56) {
    { ConstInt __ret613 = addConst_na_Bool_a_U64_nb_Bool_b_U64(a.neg, a.value, b.neg, b.value);
    return __ret613; }
    }
    if (op == 57) {
    { ConstInt __ret614 = addConst_na_Bool_a_U64_nb_Bool_b_U64(a.neg, a.value, !(b.neg), b.value);
    return __ret614; }
    }
    if (op == 58) {
    if (a.value == 0) {
    { ConstInt __ret615 = mkConst_neg_Bool_mag_U64(0, 0);
    return __ret615; }
    }
    ...
    { ConstInt __ret617 = mkConst_neg_Bool_mag_U64((a.neg != b.neg), ({ uint64_t __ov; if (__builtin_mul_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret617; }
    }
    }
    }
...
long long tiIsInt_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    if (ti.kind == 0) {
    if (ti.nameLen != 0) {
    { long long __ret620 = isIntType_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret620; }
    }
    }
...
void checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(Comp* c, uint64_t id, uint64_t eKind, uint64_t eBits, long long eSgn) {
    ...
    if (_m622.tag == 0) {
        ...
        (void)value;
        uint64_t offset = _m622.data.Int.offset;
        (void)offset;
        long long isBool = _m622.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m622.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m622.data.Int.tyLen;
        (void)tyLen;
    ...
    Expr _m623 = oe;
    if (_m623.tag == 0) {
        uint64_t value = _m623.data.Int.value;
        (void)value;
        uint64_t offset = _m623.data.Int.offset;
        (void)offset;
        long long isBool = _m623.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m623.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m623.data.Int.tyLen;
        (void)tyLen;
    ...
    checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(&((*c)), lhs, rhs);
        ...
        uint64_t nameStart = _m622.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m622.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m622.data.Call.args;
        (void)args;
    checkCallArgs_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, PlewArray_Arg_share(args));
    }
    else if (_m622.tag == 10) {
        uint64_t recv = _m622.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m622.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m622.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m622.data.Method.args;
        (void)args;
    checkMethodArgs_c_Comp_recv_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recv, nameStart, nameLen, PlewArray_Arg_share(args));
    }
    else if (_m622.tag == 11) {
        uint64_t operand = _m622.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m622.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m622.data.Cast.tyLen;
        (void)tyLen;
    Expr oe = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    {
    Expr _m624 = oe;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, 0, 0, 0);
        ...
        uint64_t base = _m622.data.Field.base;
        (void)base;
        uint64_t nameStart = _m622.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m622.data.Field.nameLen;
        (void)nameLen;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    }
    else if (_m622.tag == 9) {
        uint64_t base = _m622.data.Index.base;
        (void)base;
        uint64_t index = _m622.data.Index.index;
        (void)index;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), index, 1, 64, 0);
    }
    else if (_m622.tag == 6) {
        uint64_t typeStart = _m622.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m622.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m622.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m622.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m622.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m622.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m622.data.Make.fields;
        (void)fields;
    checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(&((*c)), typeStart, typeLen, variantStart, variantLen, isEnum, ty, PlewArray_MakeField_share(fields));
        ...
        PlewArray_U64 elems = _m622.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    ...
    else if (_m622.tag == 12) {
        uint64_t scrut = _m622.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m622.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m622.tag == 14) {
        uint64_t opt = _m622.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m622.data.Coalesce.deflt;
        (void)deflt;
    ...
    else if (_m622.tag == 15) {
        uint64_t expr = _m622.data.Try.expr;
        (void)expr;
...
IntTy exprIntTy_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { IntTy __ret625 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen)};
    return __ret625; }
    }
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    {
    Expr _m626 = e;
    if (_m626.tag == 4) {
        uint64_t nameStart = _m626.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m626.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m626.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"argCount", 8})) {
    { IntTy __ret627 = (IntTy){.known = 1, .bits = 64, .sgn = 1};
    return __ret627; }
    }
    }
    else if (_m626.tag == 5) {
        uint64_t base = _m626.data.Field.base;
        (void)base;
        uint64_t nameStart = _m626.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m626.data.Field.nameLen;
        (void)nameLen;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"count", 5})) {
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { IntTy __ret628 = (IntTy){.known = 1, .bits = 64, .sgn = 0};
    return __ret628; }
    }
    }
    }
    else if (_m626.tag == 9) {
        uint64_t base = _m626.data.Index.base;
        (void)base;
        uint64_t index = _m626.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    if (isIntType_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)) {
    { IntTy __ret629 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)};
    return __ret629; }
    }
    }
    }
    ...
    { IntTy __ret630 = (IntTy){.known = 0, .bits = 0, .sgn = 0};
    return __ret630; }
}
void checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
void checkLitArray_c_Comp_id_U64_elemStart_U64_elemLen_U64(Comp* c, uint64_t id, uint64_t elemStart, uint64_t elemLen) {
    ...
    Expr _m631 = e;
    if (_m631.tag == 8) {
        PlewArray_U64 elems = _m631.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
...
TypeInfo makeFieldType_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret636 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), fd.tyStart, fd.tyLen, fd.tyIsArray);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    EnumDef_release(en);
    ...
    { TypeInfo __ret638 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), typeStart, typeLen, fieldStart, fieldLen);
    return __ret638; }
}
void checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t ty, PlewArray_MakeField fields) {
    uint64_t i = 0;
...
long long builtinEqOrd_c_Comp_typeStart_U64_typeLen_U64_traitStart_U64_traitLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t traitStart, uint64_t traitLen) {
    ...
    { long long __ret649 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), typeStart, typeLen, (PlewString){"String", 6});
    return __ret649; }
    }
...
void checkBoundsExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m664 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m664.tag == 2) {
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), lhs)), (PlewString){"comparison on a type parameter needs an Eq/Ord bound (add `where T: Eq` / `: Ord`)", 82});
        ...
        (void)nameLen;
        PlewArray_Arg args = _m664.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        (void)nameLen;
        PlewArray_Arg args = _m664.data.Method.args;
        (void)args;
    ...
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), index);
        ...
        (void)ty;
        PlewArray_MakeField fields = _m664.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m664.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        (void)tyLen;
        uint64_t ty = _m664.data.Cast.ty;
        (void)ty;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    ...
    else if (_m664.tag == 16) {
        uint64_t base = _m664.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m664.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m664.data.Arrow.nameLen;
        (void)nameLen;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m664.tag == 13) {
        uint64_t cond = _m664.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m664.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m664.data.IfExpr.elseBlk;
        (void)elseBlk;
    ...
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m664.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m664.tag == 18) {
        uint64_t operand = _m664.data.Move.operand;
        (void)operand;
        long long isBorrow = _m664.data.Move.isBorrow;
        (void)isBorrow;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void checkBoundsStmt_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m665 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m665.tag == 0) {
        long long mutable = _m665.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m665.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m665.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m665.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m665.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m665.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m665.data.Let.ty;
        (void)ty;
        uint64_t init = _m665.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m665.data.Assign.op;
        (void)op;
        uint64_t target = _m665.data.Assign.target;
        (void)target;
        uint64_t value = _m665.data.Assign.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), target);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m665.tag == 2) {
        uint64_t expr = _m665.data.Print.expr;
        (void)expr;
        uint64_t offset = _m665.data.Print.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m665.tag == 3) {
        uint64_t expr = _m665.data.ExprStmt.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m665.tag == 4) {
        uint64_t value = _m665.data.Return.value;
        (void)value;
        long long hasValue = _m665.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m665.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m665.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m665.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m665.data.If.hasElse;
        (void)hasElse;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m665.data.While.cond;
        (void)cond;
        uint64_t body = _m665.data.While.body;
        (void)body;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m665.tag == 7) {
        uint64_t varStart = _m665.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m665.data.For.varLen;
        (void)varLen;
        long long isRange = _m665.data.For.isRange;
        (void)isRange;
        long long inclusive = _m665.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m665.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m665.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m665.data.For.body;
        (void)body;
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m665.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m665.data.Match.arms;
        (void)arms;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m665.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m665.data.Panic.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m665.tag == 10) {
        uint64_t value = _m665.data.Give.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
...
void genExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m671 = e;
    if (_m671.tag == 0) {
        uint64_t value = _m671.data.Int.value;
        (void)value;
    writeIntLit_n_U64(value);
    }
    else if (_m671.tag == 1) {
        uint64_t start = _m671.data.Ident.start;
        (void)start;
        uint64_t len = _m671.data.Ident.len;
        (void)len;
    if ((*c).curInClosure) {
    if (isCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len)) {
    ...
    else if (_m671.tag == 18) {
        uint64_t operand = _m671.data.Move.operand;
        (void)operand;
        long long isBorrow = _m671.data.Move.isBorrow;
        (void)isBorrow;
    if (isBorrow) {
    genExpr_c_Comp_id_U64(&((*c)), operand);
    }
    ...
    {
    Expr _m672 = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    if (_m672.tag == 1) {
    ...
    markMovedExpr_c_Comp_exprId_U64(&((*c)), operand);
        ...
        int64_t op = _m671.data.Unary.op;
        (void)op;
        uint64_t operand = _m671.data.Unary.operand;
        (void)operand;
    ...
    plew_write((PlewString){")", 1});
        ...
        int64_t op = _m671.data.Binary.op;
        (void)op;
        uint64_t lhs = _m671.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m671.data.Binary.rhs;
        (void)rhs;
    ...
    plew_write((PlewString){")", 1});
        ...
        uint64_t nameStart = _m671.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m671.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m671.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"write", 5})) {
    if ((*c).impWrite) {
    ...
    plew_write((PlewString){")", 1});
        ...
        uint64_t base = _m671.data.Field.base;
        (void)base;
        uint64_t nameStart = _m671.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m671.data.Field.nameLen;
        (void)nameLen;
    {
    Expr _m673 = PlewArray_Expr_get((*c).exprs, (long long)(base));
    if (_m673.tag == 1) {
        uint64_t bs = _m673.data.Ident.start;
        (void)bs;
        uint64_t bl = _m673.data.Ident.len;
        (void)bl;
    ...
    writeSpan_c_Comp_start_U64_len_U64(&((*c)), nameStart, nameLen);
        ...
        uint64_t start = _m671.data.Str.start;
        (void)start;
        uint64_t len = _m671.data.Str.len;
        (void)len;
    ...
    plew_write((PlewString){"}", 1});
        ...
        uint64_t base = _m671.data.Index.base;
        (void)base;
        uint64_t index = _m671.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    ...
    else if (_m671.tag == 16) {
        uint64_t base = _m671.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m671.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m671.data.Arrow.nameLen;
        (void)nameLen;
    plew_write((PlewString){"(", 1});
    genExpr_c_Comp_id_U64(&((*c)), base);
    plew_write((PlewString){")->", 3});
    ...
    else if (_m671.tag == 17) {
        PlewArray_Param params = _m671.data.Closure.params;
        (void)params;
        long long hasRet = _m671.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m671.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m671.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m671.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m671.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m671.data.Closure.body;
        (void)body;
    ...
    else if (_m671.tag == 10) {
        uint64_t recv = _m671.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m671.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m671.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m671.data.Method.args;
        (void)args;
    Bind arn = assocRecvName_c_Comp_recv_U64(&((*c)), recv);
    if (arn.nameLen != 0) {
    uint64_t afi = findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), arn.nameStart, arn.nameLen, nameStart, nameLen, PlewArray_Arg_share(args));
    ...
    {
    Expr _m674 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m674.tag == 9) {
        uint64_t abase = _m674.data.Index.base;
        (void)abase;
        uint64_t aidx = _m674.data.Index.index;
        (void)aidx;
    ...
    if (mf.selfMove) {
    {
    Expr _m675 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m675.tag == 1) {
        uint64_t start = _m675.data.Ident.start;
        (void)start;
        uint64_t len = _m675.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    Func_release(mf);
        ...
        PlewArray_U64 elems = _m671.data.Array.elems;
        (void)elems;
    plew_write((PlewString){"0", 1});
    }
    else if (_m671.tag == 11) {
        uint64_t operand = _m671.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m671.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m671.data.Cast.tyLen;
        (void)tyLen;
    ...
    plew_write((PlewString){"))", 2});
        ...
        uint64_t typeStart = _m671.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m671.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m671.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m671.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m671.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m671.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m671.data.Make.fields;
        (void)fields;
    if (isRefInst_c_Comp_ref_U64(&((*c)), ty)) {
    TypeRef rt = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ty)));
    uint64_t t2 = (*c).tmp;
    ...
    else if (_m671.tag == 12) {
        uint64_t scrut = _m671.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m671.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    ...
    else if (_m671.tag == 13) {
        uint64_t cond = _m671.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m671.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m671.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
    ...
    else if (_m671.tag == 14) {
        uint64_t opt = _m671.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m671.data.Coalesce.deflt;
        (void)deflt;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    else if (_m671.tag == 15) {
        uint64_t expr = _m671.data.Try.expr;
        (void)expr;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
long long isPlaceExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m677 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m677.tag == 1) {
...
long long isEnumEq_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    TypeInfo lt = exprType_c_Comp_id_U64(&((*c)), lhs);
    if (lt.kind == 2) {
    { long long __ret691 = isEnumName_c_Comp_start_U64_len_U64(&((*c)), lt.nameStart, lt.nameLen);
    return __ret691; }
    }
...
uint64_t findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(Comp* c, uint64_t typeStart, uint64_t typeLen, PlewString name) {
    ...
    { uint64_t __ret701 = (long long)(((*c).funcs).len);
    return __ret701; }
}
uint64_t orderingVariantIndex_c_Comp_name_String(Comp* c, PlewString name) {
    uint64_t ei = 0;
...
long long hasCompareWitness_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    if (lt.kind == 2) {
    if (op == 50) {
    { long long __ret704 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret704; }
    }
    if (op == 51) {
    { long long __ret705 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret705; }
    }
    if (op >= 52) {
    if (op <= 55) {
    if (typeConformsToName_c_Comp_typeStart_U64_typeLen_U64_traitName_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"Ord", 3})) {
    { long long __ret706 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"compare", 7}) < (long long)(((*c).funcs).len));
    return __ret706; }
    }
    }
    }
...
long long eqWitnessReady_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret708 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), ti.nameStart, ti.nameLen, (PlewString){"eq", 2}) < (long long)(((*c).funcs).len));
    return __ret708; }
    }
...
long long tryArrayElemFieldAssign_c_Comp_op_I64_target_U64_value_U64(Comp* c, int64_t op, uint64_t target, uint64_t value) {
    ...
    Expr _m712 = be;
    if (_m712.tag == 9) {
        uint64_t abase = _m712.data.Index.base;
        (void)abase;
...
void genStmt_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Stmt _m718 = s;
    if (_m718.tag == 0) {
        long long mutable = _m718.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m718.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m718.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m718.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m718.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m718.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m718.data.Let.ty;
        (void)ty;
        uint64_t init = _m718.data.Let.init;
        (void)init;
    ...
    addLocalCn_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool_cnum_U64(&((*c)), nameStart, nameLen, effStart, effLen, effArr, effTy, 0, mutable, 1, cnum);
        ...
        int64_t op = _m718.data.Assign.op;
        (void)op;
        uint64_t target = _m718.data.Assign.target;
        (void)target;
        uint64_t value = _m718.data.Assign.value;
        (void)value;
    ...
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t expr = _m718.data.Print.expr;
        (void)expr;
        uint64_t offset = _m718.data.Print.offset;
        (void)offset;
    if ((*c).impPrint) {
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), offset), (PlewString){"print is not ambient; import it from @Std/Io", 44});
        ...
        uint64_t expr = _m718.data.ExprStmt.expr;
        (void)expr;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), expr, 0, 0, 0);
    plew_write((PlewString){"    ", 4});
    genExpr_c_Comp_id_U64(&((*c)), expr);
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t value = _m718.data.Return.value;
        (void)value;
        long long hasValue = _m718.data.Return.hasValue;
        (void)hasValue;
    if ((*c).curIsMain) {
    ...
    {
    Expr _m720 = PlewArray_Expr_get((*c).exprs, (long long)(value));
    if (_m720.tag == 1) {
    ...
    plew_write((PlewString){"; }\n", 4});
        ...
        uint64_t cond = _m718.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m718.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m718.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m718.data.If.hasElse;
        (void)hasElse;
    ...
    (*c).curBranchBase = savedBB;
        ...
        uint64_t cond = _m718.data.While.cond;
        (void)cond;
        uint64_t body = _m718.data.While.body;
        (void)body;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), cond, 0, 0, 0);
    ...
    plew_write((PlewString){"    }\n", 6});
        ...
        uint64_t varStart = _m718.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m718.data.For.varLen;
        (void)varLen;
        long long isRange = _m718.data.For.isRange;
        (void)isRange;
        long long inclusive = _m718.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m718.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m718.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m718.data.For.body;
        (void)body;
    if (isRange) {
    ...
    scopeExit_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t msg = _m718.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m718.data.Panic.offset;
        (void)offset;
    plew_write((PlewString){"    plew_panic(", 15});
    genExpr_c_Comp_id_U64(&((*c)), msg);
    plew_write((PlewString){");\n", 3});
    }
    else if (_m718.tag == 10) {
        uint64_t value = _m718.data.Give.value;
        (void)value;
...
long long nameIsMain_c_Comp_f_Func(Comp* c, Func f) {
    ...
    { long long __ret722 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), f.nameStart, f.nameLen, (PlewString){"main", 4});
    return __ret722; }
}
long long isTraitName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
...
long long methodRecvIsTrait_c_Comp_f_Func(Comp* c, Func f) {
    if (f.hasRecv) {
    { long long __ret725 = isTraitName_c_Comp_start_U64_len_U64(&((*c)), f.recvStart, f.recvLen);
    return __ret725; }
    }
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret730 = (long long)(((*c).structs).len);
    return __ret730; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m746 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m746.tag == 17) {
...
void collectFnThunks_c_Comp(Comp* c) {
    ...
    {
    Expr _m747 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m747.tag == 1) {
...
void emitClosureEnvs_c_Comp(Comp* c) {
    ...
    while (i < (long long)(((*c).exprs).len)) {
    {
    Expr _m756 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m756.tag == 17) {
        PlewArray_Param params = _m756.data.Closure.params;
        (void)params;
        long long hasRet = _m756.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m756.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m756.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m756.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m756.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m756.data.Closure.body;
        (void)body;
...
void emitClosures_c_Comp_proto_Bool(Comp* c, long long proto) {
    ...
    while (i < (long long)(((*c).exprs).len)) {
    {
    Expr _m757 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m757.tag == 17) {
        PlewArray_Param params = _m757.data.Closure.params;
        (void)params;
        long long hasRet = _m757.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m757.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m757.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m757.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m757.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m757.data.Closure.body;
        (void)body;
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret759 = (long long)(((*c).structs).len);
    return __ret759; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret761 = (long long)(((*c).enums).len);
    return __ret761; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret765 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret765; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret767 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret767; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret770 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret770; }
    TypeRef_release(t);
}
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret773 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret773; }
    TypeRef_release(t);
}
...
Bind appendMangleSpan_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    uint64_t n = (long long)(((*c).bytes).len);
    { Bind __ret779 = (Bind){.nameStart = start, .nameLen = ({ uint64_t __ov; if (__builtin_sub_overflow((n), (start), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }), .fieldStart = ref, .fieldLen = 0};
    return __ret779; }
}
long long sameMangle_c_Comp_refA_U64_refB_U64(Comp* c, uint64_t refA, uint64_t refB) {
...
long long isCompoundType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret787 = ((long long)((PlewArray_TypeRef_get((*c).types, (long long)(r)).args).len) > 0);
    return __ret787; }
}
void emitConcreteCType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    uint64_t r = resolveTy_c_Comp_tyRef_U64(&((*c)), ref);
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret789 = PlewArray_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret789; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m799 = PlewArray_Stmt_get((*c).stmts, (long long)(sti));
    if (_m799.tag == 0) {
        uint64_t ty = _m799.data.Let.ty;
        (void)ty;
    ...
    {
    Expr _m800 = PlewArray_Expr_get((*c).exprs, (long long)(xi));
    if (_m800.tag == 11) {
        uint64_t operand = _m800.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m800.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m800.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m800.data.Cast.ty;
        (void)ty;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else if (_m800.tag == 6) {
        ...
        (void)ty;
        PlewArray_MakeField fields = _m800.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).len) == 0) {
    { TypeInfo __ret801 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret801; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Array", 5})) {
    TypeRef el = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(PlewArray_U64_get(t.args, (long long)(0)))));
    { TypeInfo __ret802 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret802; }
    TypeRef_release(el);
    }
    { TypeInfo __ret803 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret803; }
    TypeRef_release(t);
}
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, PlewArray_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret804 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret804; }
    }
    ...
    { TypeInfo __ret805 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret805; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret807 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
    ...
    { TypeInfo __ret808 = (TypeInfo){.kind = 3, .nameStart = mn.nameStart, .nameLen = mn.nameLen, .ref = 0};
    TypeRef_release(elr);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    ...
    { TypeInfo __ret809 = (TypeInfo){.kind = 3, .nameStart = at.nameStart, .nameLen = at.nameLen, .ref = 0};
    TypeRef_release(at);
    TypeRef_release(elr);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    ...
    { TypeInfo __ret810 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret813 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret819 = ((long long)((f.typeParams).len) == (long long)((inst.args).len));
    TypeRef_release(inst);
    return __ret819; }
    TypeRef_release(inst);
}
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret822 = ((long long)((f.typeParams).len) > 0);
    Func_release(f);
    return __ret822; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    PlewArray_U64 noArgs = PlewArray_U64_new();
    { uint64_t __ret824 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = PlewArray_U64_share(noArgs)});
    PlewArray_U64_release(noArgs);
    return __ret824; }
    PlewArray_U64_release(noArgs);
}
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret828 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret828; }
}
uint64_t argArrayElemRef_c_Comp_argExpr_U64(Comp* c, uint64_t argExpr) {
    {
    Expr _m829 = PlewArray_Expr_get((*c).exprs, (long long)(argExpr));
    if (_m829.tag == 1) {
        uint64_t start = _m829.data.Ident.start;
        (void)start;
        uint64_t len = _m829.data.Ident.len;
        (void)len;
    uint64_t li = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
    if (li < (long long)(((*c).locals).len)) {
    ...
    { uint64_t __ret830 = PlewArray_U64_get(lt.args, (long long)(0));
    TypeRef_release(lt);
    return __ret830; }
    }
    }
...
PlewArray_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, PlewArray_Arg args) {
    ...
    { PlewArray_U64 __ret832 = PlewArray_U64_share(out);
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m847 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m847.tag == 1) {
    ...
    else if (_m847.tag == 17) {
        PlewArray_Param params = _m847.data.Closure.params;
        (void)params;
    ...
    (*c).curCaptureMark = savedMark;
        ...
        int64_t op = _m847.data.Unary.op;
        (void)op;
        uint64_t operand = _m847.data.Unary.operand;
        (void)operand;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m847.tag == 3) {
        int64_t op = _m847.data.Binary.op;
        (void)op;
        uint64_t lhs = _m847.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m847.data.Binary.rhs;
        (void)rhs;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), lhs);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
    }
    else if (_m847.tag == 4) {
        uint64_t nameStart = _m847.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m847.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m847.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    else if (_m847.tag == 10) {
        uint64_t recv = _m847.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m847.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m847.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m847.data.Method.args;
        (void)args;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t base = _m847.data.Field.base;
        (void)base;
        uint64_t nameStart = _m847.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m847.data.Field.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m847.tag == 9) {
        uint64_t base = _m847.data.Index.base;
        (void)base;
        uint64_t index = _m847.data.Index.index;
        (void)index;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m847.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    else if (_m847.tag == 14) {
        uint64_t opt = _m847.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m847.data.Coalesce.deflt;
        (void)deflt;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), opt);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m847.tag == 15) {
        uint64_t expr = _m847.data.Try.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m847.tag == 16) {
        uint64_t base = _m847.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m847.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m847.data.Arrow.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m847.tag == 13) {
        uint64_t cond = _m847.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m847.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m847.data.IfExpr.elseBlk;
        (void)elseBlk;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
    }
    else if (_m847.tag == 12) {
        uint64_t scrut = _m847.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m847.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m847.tag == 18) {
        uint64_t operand = _m847.data.Move.operand;
        (void)operand;
        long long isBorrow = _m847.data.Move.isBorrow;
        (void)isBorrow;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m848 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m848.tag == 0) {
        long long mutable = _m848.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m848.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m848.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m848.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m848.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m848.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m848.data.Let.ty;
        (void)ty;
        uint64_t init = _m848.data.Let.init;
        (void)init;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), init);
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
    }
    else if (_m848.tag == 1) {
        int64_t op = _m848.data.Assign.op;
        (void)op;
        uint64_t target = _m848.data.Assign.target;
        (void)target;
        uint64_t value = _m848.data.Assign.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), target);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m848.tag == 2) {
        uint64_t expr = _m848.data.Print.expr;
        (void)expr;
        uint64_t offset = _m848.data.Print.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m848.tag == 3) {
        uint64_t expr = _m848.data.ExprStmt.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m848.tag == 4) {
        uint64_t value = _m848.data.Return.value;
        (void)value;
        long long hasValue = _m848.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m848.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m848.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m848.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m848.data.If.hasElse;
        (void)hasElse;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m848.data.While.cond;
        (void)cond;
        uint64_t body = _m848.data.While.body;
        (void)body;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m848.tag == 7) {
        uint64_t varStart = _m848.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m848.data.For.varLen;
        (void)varLen;
        long long isRange = _m848.data.For.isRange;
        (void)isRange;
        long long inclusive = _m848.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m848.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m848.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m848.data.For.body;
        (void)body;
    uint64_t forMark = scopeMark_c_Comp(&((*c)));
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m848.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m848.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m848.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m848.data.Panic.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m848.tag == 10) {
        uint64_t value = _m848.data.Give.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m848.tag == 11) {
    }
    else if (_m848.tag == 12) {
    }
    else { __builtin_unreachable(); }
    }
}
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret849 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), elemStart, elemLen, (PlewString){"U8", 2});
    return __ret849; }
}
long long elemIsRef_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    ...
    { long long __ret851 = isRefInst_c_Comp_ref_U64(&((*c)), er);
    return __ret851; }
}
long long skipArrayElem_c_Comp_ae_Bind(Comp* c, Bind ae) {
...
PlewArray_Bind collectParts_rootBytes_AU8_toks_ATok(PlewArray_U8 rootBytes, PlewArray_Tok toks) {
    ...
    long long starts = 0;
    {
    Kind _m861 = first.kind;
    if (_m861.tag == 37) {
    starts = 1;
    }
    else if (_m861.tag == 48) {
    starts = 1;
    }
    else {
    ...
    { PlewArray_Bind __ret862 = PlewArray_Bind_share(parts);
...
PlewArray_U8 resolveImport_src_AU8_pStart_U64_pLen_U64_importer_AU8_baseLen_U64_srcRoot_AU8_srcRootLen_U64_stdRoot_AU8_stdRootLen_U64(PlewArray_U8 src, uint64_t pStart, uint64_t pLen, PlewArray_U8 importer, uint64_t baseLen, PlewArray_U8 srcRoot, uint64_t srcRootLen, PlewArray_U8 stdRoot, uint64_t stdRootLen) {
    ...
    { PlewArray_U8 __ret867 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret867; }
    }
    if (b0 == 47) {
...
PlewArray_U8 findSrcRoot_entry_AU8(PlewArray_U8 entry) {
    ...
    { PlewArray_U8 __ret874 = PlewArray_U8_share(sr);
    ...
    { PlewArray_U8 __ret875 = PlewArray_U8_share(empty);
