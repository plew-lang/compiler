...
uint64_t parseFor_c_Comp(Comp* c) {
    ...
    if (_m167.tag == 5) {
    {
    Kind _m168 = Comp_peekKind_off_U64(&((*c)), 1);
    if (_m168.tag == 33) {
    isPattern = 1;
    }
    else {
    ...
    Comp_skipNewlines(&((*c)));
    uint64_t body = parseBlock_c_Comp(&((*c)));
    { uint64_t __ret172 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 7, .data.For = {.varStart = nameStart, .varLen = nameLen, .isRange = isRange, .inclusive = inclusive, .iter = lo, .rangeHi = hi, .body = body, .isStruct = isStruct, .patStart = patStart, .patLen = patLen, .binds = PlewArray_Bind_share(binds)}});
...
uint64_t parseExprOrAssign_c_Comp(Comp* c) {
    ...
    { uint64_t __ret173 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 1, .data.Assign = {.op = op, .target = lhs, .value = rhs}});
    return __ret173; }
    }
    { uint64_t __ret174 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 3, .data.ExprStmt = {.expr = lhs}});
    return __ret174; }
}
PatInfo parsePattern_c_Comp(Comp* c) {
    ...
    { PatInfo __ret182 = (PatInfo){.isWildcard = isWildcard, .enumStart = enumStart, .enumLen = enumLen, .variantStart = variantStart, .variantLen = variantLen, .binds = PlewArray_Bind_share(binds), .isStruct = isStruct};
    PlewArray_Bind_release(binds);
    return __ret182; }
    PlewArray_Bind_release(binds);
}
...
PlewArray_PatInfo parseArmPatterns_c_Comp(Comp* c) {
    ...
    { PlewArray_PatInfo __ret188 = PlewArray_PatInfo_share(pats);
...
uint64_t parseArmBody_c_Comp(Comp* c) {
    ...
    if (_m189.tag == 33) {
    { uint64_t __ret190 = parseBlock_c_Comp(&((*c)));
    return __ret190; }
    }
    else {
...
uint64_t parseMatch_c_Comp(Comp* c) {
    ...
    {
    PlewArray_PatInfo __fa194 = pats;
    for (long long __fi194 = 0; __fi194 < __fa194.len; __fi194++) {
        PatInfo pi = PlewArray_PatInfo_get(__fa194, __fi194);
    ...
    { uint64_t __ret195 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 8, .data.Match = {.scrut = scrut, .arms = PlewArray_MatchArm_share(arms)}});
...
uint64_t parseMatchExpr_c_Comp(Comp* c) {
    ...
    { uint64_t __ret200 = Comp_pushExpr_e_Expr(&((*c)), (Expr){.tag = 12, .data.MatchExpr = {.scrut = scrut, .arms = PlewArray_MatchArm_share(arms)}});
    PlewArray_MatchArm_release(arms);
    return __ret200; }
    PlewArray_MatchArm_release(arms);
}
uint64_t parseStmt_c_Comp(Comp* c) {
    ...
    Kind _m201 = k;
    if (_m201.tag == 18) {
    { uint64_t __ret202 = parseLet_c_Comp_mutable_Bool(&((*c)), 0);
    return __ret202; }
    }
    else if (_m201.tag == 19) {
    Comp_advance(&((*c)));
    { uint64_t __ret203 = parseLet_c_Comp_mutable_Bool(&((*c)), 1);
    return __ret203; }
    }
    else if (_m201.tag == 10) {
    { uint64_t __ret204 = parseIf_c_Comp(&((*c)));
    return __ret204; }
    }
    else if (_m201.tag == 12) {
    { uint64_t __ret205 = parseWhile_c_Comp(&((*c)));
    return __ret205; }
    }
    else if (_m201.tag == 13) {
    { uint64_t __ret206 = parseFor_c_Comp(&((*c)));
    return __ret206; }
    }
    else if (_m201.tag == 9) {
    { uint64_t __ret207 = parseMatch_c_Comp(&((*c)));
    return __ret207; }
    }
    else if (_m201.tag == 14) {
    Comp_advance(&((*c)));
    { uint64_t __ret208 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 11});
    return __ret208; }
    }
    else if (_m201.tag == 15) {
    Comp_advance(&((*c)));
    { uint64_t __ret209 = Comp_pushStmt_s_Stmt(&((*c)), (Stmt){.tag = 12});
    return __ret209; }
    }
    else if (_m201.tag == 16) {
    { uint64_t __ret210 = parseReturn_c_Comp(&((*c)));
    return __ret210; }
    }
    else if (_m201.tag == 5) {
    if (Comp_identIs_kw_String(&((*c)), (PlewString){"print", 5})) {
    {
    Kind _m211 = Comp_peekKind_off_U64(&((*c)), 1);
    if (_m211.tag == 29) {
    { uint64_t __ret212 = parsePrint_c_Comp(&((*c)));
    return __ret212; }
    }
    else {
    ...
    { uint64_t __ret214 = parsePanic_c_Comp(&((*c)));
    return __ret214; }
    }
    { uint64_t __ret215 = parseExprOrAssign_c_Comp(&((*c)));
    return __ret215; }
    }
    else if (_m201.tag == 17) {
    { uint64_t __ret216 = parseGive_c_Comp(&((*c)));
    return __ret216; }
    }
    else {
...
PlewArray_Param parseParamList_c_Comp(Comp* c) {
    ...
    { PlewArray_Param __ret228 = PlewArray_Param_share(params);
    PlewArray_Param_release(params);
    return __ret228; }
    PlewArray_Param_release(params);
}
...
PlewArray_Bind parseWhereClause_c_Comp(Comp* c) {
    ...
    { PlewArray_Bind __ret235 = PlewArray_Bind_share(boundParams);
    PlewArray_Bind_release(boundTraits);
    PlewArray_Bind_release(boundParams);
    return __ret235; }
    PlewArray_Bind_release(boundTraits);
...
Bind internBytes_c_Comp_s_String(Comp* c, PlewString s) {
    ...
    { Bind __ret265 = (Bind){.nameStart = start, .nameLen = (long long)((sb).len), .fieldStart = start, .fieldLen = (long long)((sb).len)};
    PlewArray_U8_release(sb);
    return __ret265; }
    PlewArray_U8_release(sb);
}
...
unsigned char digitByte_d_U64(uint64_t d) {
    if (d == 0) {
    { unsigned char __ret267 = 48;
    return __ret267; }
    }
    if (d == 1) {
    { unsigned char __ret268 = 49;
    return __ret268; }
    }
    if (d == 2) {
    { unsigned char __ret269 = 50;
    return __ret269; }
    }
    if (d == 3) {
    { unsigned char __ret270 = 51;
    return __ret270; }
    }
    if (d == 4) {
    { unsigned char __ret271 = 52;
    return __ret271; }
    }
    if (d == 5) {
    { unsigned char __ret272 = 53;
    return __ret272; }
    }
    if (d == 6) {
    { unsigned char __ret273 = 54;
    return __ret273; }
    }
    if (d == 7) {
    { unsigned char __ret274 = 55;
    return __ret274; }
    }
    if (d == 8) {
    { unsigned char __ret275 = 56;
    return __ret275; }
    }
    { unsigned char __ret276 = 57;
    return __ret276; }
}
void appendU64Digits_c_Comp_n_U64(Comp* c, uint64_t n) {
    if (n >= 10) {
...
Bind internName_c_Comp_prefix_U8_n_U64(Comp* c, unsigned char prefix, uint64_t n) {
    ...
    { Bind __ret277 = (Bind){.nameStart = start, .nameLen = len, .fieldStart = start, .fieldLen = len};
    return __ret277; }
}
uint64_t enumIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
    ...
    { uint64_t __ret279 = (long long)(((*c).enums).len);
    return __ret279; }
}
uint64_t synthBool_c_Comp_v_I64(Comp* c, int64_t v) {
    { uint64_t __ret280 = Comp_pushExpr_e_Expr(&((*c)), (Expr){.tag = 0, .data.Int = {.value = v, .offset = 0, .isBool = 1, .tyStart = 0, .tyLen = 0}});
    return __ret280; }
}
void synthEnumEq_c_Comp_d_DeriveReq_eqN_Bind_lhsN_Bind_rhsN_Bind_boolN_Bind_eqTrait_Bind(Comp* c, DeriveReq d, Bind eqN, Bind lhsN, Bind rhsN, Bind boolN, Bind eqTrait) {
...
uint64_t synthOrdering_c_Comp_ordN_Bind_variantN_Bind(Comp* c, Bind ordN, Bind variantN) {
    ...
    { uint64_t __ret281 = Comp_pushExpr_e_Expr(&((*c)), (Expr){.tag = 6, .data.Make = {.typeStart = ordN.nameStart, .typeLen = ordN.nameLen, .variantStart = variantN.nameStart, .variantLen = variantN.nameLen, .isEnum = 1, .ty = 0, .fields = PlewArray_MakeField_share(noFields)}});
...
void parseProgram_c_Comp(Comp* c) {
    ...
    else if (_m286.tag == 23) {
    Comp_advance(&((*c)));
    {
    Kind _m287 = Comp_curKind(&((*c)));
    if (_m287.tag == 7) {
...
PlewString digitStr_d_I64(int64_t d) {
    if (d == 0) {
    { PlewString __ret288 = (PlewString){"0", 1};
    return __ret288; }
    }
    if (d == 1) {
    { PlewString __ret289 = (PlewString){"1", 1};
    return __ret289; }
    }
    if (d == 2) {
    { PlewString __ret290 = (PlewString){"2", 1};
    return __ret290; }
    }
    if (d == 3) {
    { PlewString __ret291 = (PlewString){"3", 1};
    return __ret291; }
    }
    if (d == 4) {
    { PlewString __ret292 = (PlewString){"4", 1};
    return __ret292; }
    }
    if (d == 5) {
    { PlewString __ret293 = (PlewString){"5", 1};
    return __ret293; }
    }
    if (d == 6) {
    { PlewString __ret294 = (PlewString){"6", 1};
    return __ret294; }
    }
    if (d == 7) {
    { PlewString __ret295 = (PlewString){"7", 1};
    return __ret295; }
    }
    if (d == 8) {
    { PlewString __ret296 = (PlewString){"8", 1};
    return __ret296; }
    }
    { PlewString __ret297 = (PlewString){"9", 1};
    return __ret297; }
}
void writeInt_n_I64(int64_t n) {
    if (n < 0) {
...
uint64_t intBits_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I16", 3})) {
    { uint64_t __ret329 = 16;
    return __ret329; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"U16", 3})) {
    { uint64_t __ret330 = 16;
    return __ret330; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I32", 3})) {
    { uint64_t __ret331 = 32;
    return __ret331; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"U32", 3})) {
    { uint64_t __ret332 = 32;
    return __ret332; }
    }
    { uint64_t __ret333 = 64;
    return __ret333; }
}
long long intSigned_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    { long long __ret334 = (PlewArray_U8_get((*c).bytes, (long long)(start)) == 73);
    return __ret334; }
}
long long losslessInt_c_Comp_srcStart_U64_srcLen_U64_dstStart_U64_dstLen_U64(Comp* c, uint64_t srcStart, uint64_t srcLen, uint64_t dstStart, uint64_t dstLen) {
    ...
    if (dSigned) {
    { long long __ret337 = (dBits > sBits);
    return __ret337; }
    }
    { long long __ret338 = (dBits >= sBits);
    return __ret338; }
}
long long litFitsType_c_Comp_value_U64_neg_Bool_dstStart_U64_dstLen_U64(Comp* c, uint64_t value, long long neg, uint64_t dstStart, uint64_t dstLen) {
    ...
    { long long __ret339 = litFitsBits_value_U64_neg_Bool_bits_U64_sgn_Bool(value, neg, bits, sgn);
    return __ret339; }
}
long long litFitsBits_value_U64_neg_Bool_bits_U64_sgn_Bool(uint64_t value, long long neg, uint64_t bits, long long sgn) {
    if (neg) {
    ...
    if (bits == 8) {
    { long long __ret341 = (value <= 128);
    return __ret341; }
    }
    if (bits == 16) {
    { long long __ret342 = (value <= 32768);
    return __ret342; }
    }
    if (bits == 32) {
    { long long __ret343 = (value <= 2147483648);
    return __ret343; }
    }
    if (value == 0) {
    ...
    { long long __ret345 = (({ uint64_t __ov; if (__builtin_sub_overflow((value), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }) <= 9223372036854775807);
    return __ret345; }
    }
    if (sgn) {
    if (bits == 8) {
    { long long __ret346 = (value <= 127);
    return __ret346; }
    }
    if (bits == 16) {
    { long long __ret347 = (value <= 32767);
    return __ret347; }
    }
    if (bits == 32) {
    { long long __ret348 = (value <= 2147483647);
    return __ret348; }
    }
    { long long __ret349 = (value <= 9223372036854775807);
    return __ret349; }
    }
    if (bits == 8) {
    { long long __ret350 = (value <= 255);
    return __ret350; }
    }
    if (bits == 16) {
    { long long __ret351 = (value <= 65535);
    return __ret351; }
    }
    if (bits == 32) {
    { long long __ret352 = (value <= 4294967295);
    return __ret352; }
    }
...
uint64_t arrayElemRef_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret354 = ae.fieldStart;
    return __ret354; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
...
Bind arrayElemNameForRef_c_Comp_elemRef_U64(Comp* c, uint64_t elemRef) {
    ...
    { Bind __ret356 = (Bind){.nameStart = ae.nameStart, .nameLen = ae.nameLen, .fieldStart = elemRef, .fieldLen = 0};
    return __ret356; }
    }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    { Bind __ret357 = (Bind){.nameStart = t.nameStart, .nameLen = t.nameLen, .fieldStart = elemRef, .fieldLen = 0};
    TypeRef_release(t);
    return __ret357; }
    TypeRef_release(t);
    }
    { Bind __ret358 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret358; }
}
void genCElem_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (len == 0) {
...
uint64_t exprOffset_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m363 = e;
    if (_m363.tag == 0) {
        uint64_t offset = _m363.data.Int.offset;
        (void)offset;
    { uint64_t __ret364 = offset;
    return __ret364; }
    }
    else if (_m363.tag == 1) {
        uint64_t start = _m363.data.Ident.start;
        (void)start;
        uint64_t len = _m363.data.Ident.len;
        (void)len;
    { uint64_t __ret365 = start;
    return __ret365; }
    }
    else if (_m363.tag == 7) {
        uint64_t start = _m363.data.Str.start;
        (void)start;
        uint64_t len = _m363.data.Str.len;
        (void)len;
    { uint64_t __ret366 = start;
    return __ret366; }
    }
    else if (_m363.tag == 4) {
        uint64_t nameStart = _m363.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m363.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m363.data.Call.args;
        (void)args;
    { uint64_t __ret367 = nameStart;
    return __ret367; }
    }
    else if (_m363.tag == 10) {
        uint64_t recv = _m363.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m363.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m363.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m363.data.Method.args;
        (void)args;
    { uint64_t __ret368 = nameStart;
    return __ret368; }
    }
    else if (_m363.tag == 5) {
        uint64_t base = _m363.data.Field.base;
        (void)base;
        uint64_t nameStart = _m363.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m363.data.Field.nameLen;
        (void)nameLen;
    { uint64_t __ret369 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret369; }
    }
    else if (_m363.tag == 9) {
        uint64_t base = _m363.data.Index.base;
        (void)base;
        uint64_t index = _m363.data.Index.index;
        (void)index;
    { uint64_t __ret370 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret370; }
    }
    else if (_m363.tag == 3) {
        int64_t op = _m363.data.Binary.op;
        (void)op;
        uint64_t lhs = _m363.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m363.data.Binary.rhs;
        (void)rhs;
    { uint64_t __ret371 = exprOffset_c_Comp_id_U64(&((*c)), lhs);
    return __ret371; }
    }
    else if (_m363.tag == 2) {
        int64_t op = _m363.data.Unary.op;
        (void)op;
        uint64_t operand = _m363.data.Unary.operand;
        (void)operand;
    { uint64_t __ret372 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret372; }
    }
    else if (_m363.tag == 11) {
        uint64_t operand = _m363.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m363.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m363.data.Cast.tyLen;
        (void)tyLen;
    { uint64_t __ret373 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret373; }
    }
    else if (_m363.tag == 6) {
        uint64_t typeStart = _m363.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m363.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m363.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m363.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m363.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m363.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m363.data.Make.fields;
        (void)fields;
    { uint64_t __ret374 = typeStart;
    return __ret374; }
    }
    else if (_m363.tag == 12) {
        uint64_t scrut = _m363.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m363.data.MatchExpr.arms;
        (void)arms;
    { uint64_t __ret375 = exprOffset_c_Comp_id_U64(&((*c)), scrut);
    return __ret375; }
    }
    else if (_m363.tag == 13) {
        uint64_t cond = _m363.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m363.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m363.data.IfExpr.elseBlk;
        (void)elseBlk;
    { uint64_t __ret376 = exprOffset_c_Comp_id_U64(&((*c)), cond);
    return __ret376; }
    }
    else if (_m363.tag == 14) {
        uint64_t opt = _m363.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m363.data.Coalesce.deflt;
        (void)deflt;
    { uint64_t __ret377 = exprOffset_c_Comp_id_U64(&((*c)), opt);
    return __ret377; }
    }
    else if (_m363.tag == 15) {
        uint64_t expr = _m363.data.Try.expr;
        (void)expr;
    { uint64_t __ret378 = exprOffset_c_Comp_id_U64(&((*c)), expr);
    return __ret378; }
    }
    else if (_m363.tag == 16) {
        uint64_t base = _m363.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m363.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m363.data.Arrow.nameLen;
        (void)nameLen;
    { uint64_t __ret379 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret379; }
    }
    else if (_m363.tag == 17) {
        PlewArray_Param params = _m363.data.Closure.params;
        (void)params;
        long long hasRet = _m363.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m363.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m363.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m363.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m363.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m363.data.Closure.body;
        (void)body;
    { uint64_t __ret380 = retStart;
    return __ret380; }
    }
    else {
    { uint64_t __ret381 = 0;
...
uint64_t findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret382 = typeMatch;
    return __ret382; }
    }
    { uint64_t __ret383 = firstLabel;
    return __ret383; }
}
uint64_t firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret385 = (long long)(((*c).funcs).len);
    return __ret385; }
}
long long funcNameExists_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    { long long __ret386 = (firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(&((*c)), nameStart, nameLen) != (long long)(((*c).funcs).len));
    return __ret386; }
}
uint64_t findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
    ...
    { uint64_t __ret389 = findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recvStart, recvLen, al.realStart, al.realLen, PlewArray_Arg_share(args));
    return __ret389; }
    }
    }
    ai = ({ uint64_t __ov; if (__builtin_add_overflow((ai), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    { uint64_t __ret390 = (long long)(((*c).funcs).len);
    return __ret390; }
}
uint64_t findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret391 = typeMatch;
    return __ret391; }
    }
    { uint64_t __ret392 = firstLabel;
    return __ret392; }
}
long long isTypeName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret395 = (genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), start, len) < (long long)(((*c).structs).len));
    return __ret395; }
}
Bind assocRecvName_c_Comp_recv_U64(Comp* c, uint64_t recv) {
    {
    Expr _m396 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m396.tag == 1) {
        uint64_t start = _m396.data.Ident.start;
        (void)start;
        uint64_t len = _m396.data.Ident.len;
        (void)len;
    ...
    { Bind __ret398 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret398; }
    }
    if (isTypeName_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { Bind __ret399 = (Bind){.nameStart = start, .nameLen = len, .fieldStart = start, .fieldLen = len};
    return __ret399; }
    }
    ...
    { Bind __ret401 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret401; }
    }
    }
}
...
long long argMatchesParam_c_Comp_argExpr_U64_p_Param(Comp* c, uint64_t argExpr, Param p) {
    ...
    if (ti.kind == 1) {
    { long long __ret410 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), p.tyStart, p.tyLen, (PlewString){"String", 6});
    return __ret410; }
    }
    if (ti.kind == 2) {
    { long long __ret411 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret411; }
    }
    if (ti.nameLen != 0) {
    { long long __ret412 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret412; }
    }
    { long long __ret413 = isIntType_c_Comp_start_U64_len_U64(&((*c)), p.tyStart, p.tyLen);
    return __ret413; }
}
long long paramsTypesMatch_c_Comp_params_AParam_args_AArg(Comp* c, PlewArray_Param params, PlewArray_Arg args) {
    uint64_t i = 0;
...
long long callLabelsOk_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    { long long __ret416 = (findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, PlewArray_Arg_share(args)) != (long long)(((*c).funcs).len));
    return __ret416; }
    }
...
TypeInfo scalarInfo(void) {
    { TypeInfo __ret428 = (TypeInfo){.kind = 0, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret428; }
}
Bind kwSpan_c_Comp_kw_String_kwLen_U64(Comp* c, PlewString kw, uint64_t kwLen) {
    uint64_t n = (long long)(((*c).bytes).len);
    if (n < kwLen) {
    { Bind __ret429 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret429; }
    }
    uint64_t i = 0;
    ...
    { Bind __ret430 = (Bind){.nameStart = i, .nameLen = kwLen, .fieldStart = i, .fieldLen = kwLen};
    return __ret430; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
...
Bind stringTypeSpan_c_Comp(Comp* c) {
    { Bind __ret432 = kwSpan_c_Comp_kw_String_kwLen_U64(&((*c)), (PlewString){"String", 6}, 6);
    return __ret432; }
}
TypeInfo typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(Comp* c, uint64_t start, uint64_t len, long long isArray) {
    if (isArray) {
    { TypeInfo __ret433 = (TypeInfo){.kind = 3, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret433; }
    }
    if (len == 0) {
    ...
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"String", 6})) {
    { TypeInfo __ret435 = (TypeInfo){.kind = 1, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret435; }
    }
    if (isPrimType_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { TypeInfo __ret436 = (TypeInfo){.kind = 0, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret436; }
    }
    { TypeInfo __ret437 = (TypeInfo){.kind = 2, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret437; }
}
void addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(Comp* c, uint64_t nameStart, uint64_t nameLen, uint64_t tyStart, uint64_t tyLen, long long isArray, uint64_t ty, long long isInout, long long isMut, long long owned) {
...
uint64_t scopeMark_c_Comp(Comp* c) {
    { uint64_t __ret439 = (long long)(((*c).locals).len);
    return __ret439; }
}
void emitScopeDrops_c_Comp_mark_U64_exclIdx_U64(Comp* c, uint64_t mark, uint64_t exclIdx) {
...
long long structLocalReleasable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret444 = structNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret444; }
}
void popLocals_c_Comp_mark_U64(Comp* c, uint64_t mark) {
...
long long localIsMutable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { long long __ret445 = (*c).curSelfInout;
    return __ret445; }
    }
    if ((*c).curInClosure) {
    if (isCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len)) {
    { long long __ret446 = isBoxedCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len);
    return __ret446; }
    }
    }
    uint64_t i = (long long)(((*c).locals).len);
...
long long isSelfRef_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if ((*c).curHasRecv) {
    { long long __ret450 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"self", 4});
    return __ret450; }
    }
...
long long typeIsUnique_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret456 = PlewArray_StructDef_get((*c).structs, (long long)(si)).isUnique;
    return __ret456; }
}
uint64_t localIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = (long long)(((*c).locals).len);
    ...
    { uint64_t __ret458 = (long long)(((*c).locals).len);
    return __ret458; }
}
long long localMoved_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = (long long)(((*c).locals).len);
...
void markMovedExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m461 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m461.tag == 1) {
...
TypeInfo fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t structStart, uint64_t structLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret462 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.tyStart, f.tyLen, f.tyIsArray);
...
long long placeIsMutable_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    if (_m466.tag == 1) {
        ...
        (void)len;
    { long long __ret467 = localIsMutable_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret467; }
    }
    else if (_m466.tag == 5) {
    ...
    { long long __ret468 = placeIsMutable_c_Comp_id_U64(&((*c)), base);
    return __ret468; }
    }
    ...
    return __ret470; }
        ...
        (void)index;
    { long long __ret471 = placeIsMutable_c_Comp_id_U64(&((*c)), base);
    return __ret471; }
    }
...
TypeInfo exprType_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m474 = e;
    if (_m474.tag == 0) {
        uint64_t tyStart = _m474.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m474.data.Int.tyLen;
        (void)tyLen;
    if (tyLen != 0) {
    { TypeInfo __ret475 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret475; }
    }
    ...
    return __ret476; }
        ...
        uint64_t start = _m474.data.Str.start;
        (void)start;
        uint64_t len = _m474.data.Str.len;
        (void)len;
    { TypeInfo __ret477 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret477; }
    }
    else if (_m474.tag == 1) {
        uint64_t start = _m474.data.Ident.start;
        (void)start;
        uint64_t len = _m474.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    if ((*c).curRecvInstRef != 0) {
    TypeRef rt = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)((*c).curRecvInstRef)));
    { TypeInfo __ret478 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    return __ret478; }
    TypeRef_release(rt);
    }
    { TypeInfo __ret479 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), (*c).curRecvStart, (*c).curRecvLen, 0);
    return __ret479; }
    }
    if ((*c).curInClosure) {
    uint64_t ci = 0;
    ...
    { TypeInfo __ret480 = (TypeInfo){.kind = 2, .nameStart = rt2.nameStart, .nameLen = rt2.nameLen, .ref = ce.ty};
    TypeRef_release(rt2);
    return __ret480; }
    TypeRef_release(rt2);
    }
    { TypeInfo __ret481 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), ce.tyStart, ce.tyLen, ce.isArray);
    return __ret481; }
    }
    }
    ...
    { TypeInfo __ret482 = (TypeInfo){.kind = 2, .nameStart = lt.nameStart, .nameLen = lt.nameLen, .ref = lo.ty};
    TypeRef_release(lt);
    return __ret482; }
    TypeRef_release(lt);
    }
    ...
    { TypeInfo __ret483 = (TypeInfo){.kind = 2, .nameStart = lt2.nameStart, .nameLen = lt2.nameLen, .ref = lo.ty};
    TypeRef_release(lt2);
    return __ret483; }
    TypeRef_release(lt2);
    }
    ...
    { TypeInfo __ret484 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get((*c).curTypeArgs, (long long)(k)));
    return __ret484; }
    }
    k = ({ uint64_t __ov; if (__builtin_add_overflow((k), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    }
    { TypeInfo __ret485 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, lo.isArray);
    return __ret485; }
    }
    }
    ...
    return __ret486; }
        ...
        int64_t op = _m474.data.Unary.op;
        (void)op;
        uint64_t operand = _m474.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    { TypeInfo __ret487 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret487; }
    }
    if (op == 79) {
    { TypeInfo __ret488 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret488; }
    }
    ...
    return __ret489; }
        ...
        int64_t op = _m474.data.Binary.op;
        (void)op;
        uint64_t lhs = _m474.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m474.data.Binary.rhs;
        (void)rhs;
    if (op >= 56) {
    if (op <= 60) {
    { TypeInfo __ret490 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret490; }
    }
    }
    if (op >= 74) {
    if (op <= 78) {
    { TypeInfo __ret491 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret491; }
    }
    }
    ...
    return __ret492; }
        ...
        uint64_t nameStart = _m474.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m474.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m474.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"readStdin", 9})) {
    { TypeInfo __ret493 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret493; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"readFile", 8})) {
    { TypeInfo __ret494 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret494; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"readFileBytes", 13})) {
    ...
    { TypeInfo __ret497 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inferred, (long long)(k)));
    ...
    { TypeInfo __ret498 = (TypeInfo){.kind = 2, .nameStart = rtr.nameStart, .nameLen = rtr.nameLen, .ref = f.retTy};
    TypeRef_release(rtr);
    Func_release(f);
    return __ret498; }
    TypeRef_release(rtr);
    }
    { TypeInfo __ret499 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.retStart, f.retLen, f.retIsArray);
    Func_release(f);
    return __ret499; }
    }
    ...
    return __ret501; }
        ...
        uint64_t base = _m474.data.Field.base;
        (void)base;
        uint64_t nameStart = _m474.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m474.data.Field.nameLen;
        (void)nameLen;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 1) {
    ...
    if (u8.nameLen != 0) {
    { TypeInfo __ret502 = (TypeInfo){.kind = 3, .nameStart = u8.nameStart, .nameLen = u8.nameLen, .ref = 0};
    return __ret502; }
    }
    }
    }
    if (isGenericInst_c_Comp_ref_U64(&((*c)), bt.ref)) {
    { TypeInfo __ret503 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.ref, nameStart, nameLen);
    return __ret503; }
    }
    if (bt.kind == 2) {
    { TypeInfo __ret504 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.nameStart, bt.nameLen, nameStart, nameLen);
    return __ret504; }
    }
    ...
    return __ret505; }
        ...
        uint64_t typeStart = _m474.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m474.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m474.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m474.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m474.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m474.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m474.data.Make.fields;
        (void)fields;
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ty)) {
    { TypeInfo __ret506 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = ty};
    return __ret506; }
    }
    { TypeInfo __ret507 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = 0};
    return __ret507; }
    }
    else if (_m474.tag == 8) {
        PlewArray_U64 elems = _m474.data.Array.elems;
        (void)elems;
    { TypeInfo __ret508 = scalarInfo();
    return __ret508; }
    }
    else if (_m474.tag == 9) {
        uint64_t base = _m474.data.Index.base;
        (void)base;
        uint64_t index = _m474.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    ...
    { TypeInfo __ret509 = (TypeInfo){.kind = 3, .nameStart = xn.nameStart, .nameLen = xn.nameLen, .ref = 0};
    TypeRef_release(rt);
    return __ret509; }
    }
    }
    ...
    { TypeInfo __ret510 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), bt.nameStart, bt.nameLen, 0);
    return __ret510; }
    }
    { TypeInfo __ret511 = scalarInfo();
    return __ret511; }
    }
    else if (_m474.tag == 10) {
        uint64_t recv = _m474.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m474.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m474.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m474.data.Method.args;
        (void)args;
    ...
    if (af.hasRet) {
    { TypeInfo __ret513 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), af.retStart, af.retLen, af.retIsArray);
    Func_release(af);
    return __ret513; }
    }
    ...
    else if (_m474.tag == 11) {
        uint64_t operand = _m474.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m474.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m474.data.Cast.tyLen;
        (void)tyLen;
    { TypeInfo __ret519 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    return __ret519; }
    }
    else if (_m474.tag == 12) {
        uint64_t scrut = _m474.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m474.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    { TypeInfo __ret520 = exprType_c_Comp_id_U64(&((*c)), PlewArray_MatchArm_get(arms, (long long)(0)).body);
    return __ret520; }
    }
    { TypeInfo __ret521 = scalarInfo();
    return __ret521; }
    }
    else if (_m474.tag == 13) {
        uint64_t cond = _m474.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m474.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m474.data.IfExpr.elseBlk;
        (void)elseBlk;
    ...
    else if (_m474.tag == 14) {
        uint64_t opt = _m474.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m474.data.Coalesce.deflt;
        (void)deflt;
    { TypeInfo __ret524 = exprType_c_Comp_id_U64(&((*c)), deflt);
    return __ret524; }
    }
    else if (_m474.tag == 15) {
        uint64_t expr = _m474.data.Try.expr;
        (void)expr;
    ...
    { TypeInfo __ret525 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(0)));
    ...
    else if (_m474.tag == 16) {
        uint64_t base = _m474.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m474.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m474.data.Arrow.nameLen;
        (void)nameLen;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    ...
    else if (_m474.tag == 17) {
        PlewArray_Param params = _m474.data.Closure.params;
        (void)params;
        long long hasRet = _m474.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m474.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m474.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m474.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m474.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m474.data.Closure.body;
        (void)body;
    { TypeInfo __ret529 = scalarInfo();
    return __ret529; }
    }
    else if (_m474.tag == 18) {
        uint64_t operand = _m474.data.Move.operand;
        (void)operand;
        long long isBorrow = _m474.data.Move.isBorrow;
        (void)isBorrow;
...
uint64_t blockGiveExpr_c_Comp_blkId_U64(Comp* c, uint64_t blkId) {
    ...
    Stmt _m532 = s;
    if (_m532.tag == 10) {
        uint64_t value = _m532.data.Give.value;
        (void)value;
    found = value;
    }
    else {
...
PlewString binOpStr_op_I64(int64_t op) {
    ...
    if (op == 57) {
    { PlewString __ret535 = (PlewString){" - ", 3};
    return __ret535; }
    }
    if (op == 58) {
    ...
    if (op == 52) {
    { PlewString __ret541 = (PlewString){" < ", 3};
    return __ret541; }
    }
    if (op == 53) {
    ...
    if (op == 61) {
    { PlewString __ret545 = (PlewString){" && ", 4};
    return __ret545; }
    }
    if (op == 62) {
...
PlewString unaryOpStr_op_I64(int64_t op) {
    if (op == 57) {
    { PlewString __ret553 = (PlewString){"-", 1};
    return __ret553; }
    }
    if (op == 79) {
    { PlewString __ret554 = (PlewString){"~", 1};
    return __ret554; }
    }
...
PlewString overflowBuiltin_op_I64(int64_t op) {
    if (op == 56) {
    { PlewString __ret565 = (PlewString){"__builtin_add_overflow", 22};
    return __ret565; }
    }
    if (op == 57) {
    { PlewString __ret566 = (PlewString){"__builtin_sub_overflow", 22};
    return __ret566; }
    }
    { PlewString __ret567 = (PlewString){"__builtin_mul_overflow", 22};
    return __ret567; }
}
TypeInfo arithIntType_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
PlewString intMinMacro_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I8", 2})) {
    { PlewString __ret571 = (PlewString){"INT8_MIN", 8};
    return __ret571; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I16", 3})) {
    { PlewString __ret572 = (PlewString){"INT16_MIN", 9};
    return __ret572; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), start, len, (PlewString){"I32", 3})) {
    { PlewString __ret573 = (PlewString){"INT32_MIN", 9};
    return __ret573; }
    }
    { PlewString __ret574 = (PlewString){"INT64_MIN", 9};
    return __ret574; }
}
void genCheckedNeg_c_Comp_operand_U64_tyStart_U64_tyLen_U64(Comp* c, uint64_t operand, uint64_t tyStart, uint64_t tyLen) {
    plew_write((PlewString){"({ ", 3});
...
PlewString assignOpStr_op_I64(int64_t op) {
    ...
    if (op == 83) {
    { PlewString __ret584 = (PlewString){" <<= ", 5};
    return __ret584; }
    }
    { PlewString __ret585 = (PlewString){" >>= ", 5};
    return __ret585; }
}
long long isCompoundDiv_op_I64(int64_t op) {
    if (op == 70) {
...
PlewString compoundDivFn_op_I64(int64_t op) {
    if (op == 70) {
    { PlewString __ret589 = (PlewString){"plew_div(", 9};
    return __ret589; }
    }
    if (op == 71) {
    { PlewString __ret590 = (PlewString){"plew_mod(", 9};
    return __ret590; }
    }
    { PlewString __ret591 = (PlewString){"", 0};
    return __ret591; }
}
PlewString assignToBinStr_op_I64(int64_t op) {
    if (op == 67) {
...
ConstInt notConst(void) {
    { ConstInt __ret602 = (ConstInt){.isConst = 0, .neg = 0, .value = 0};
    return __ret602; }
}
ConstInt mkConst_neg_Bool_mag_U64(long long neg, uint64_t mag) {
    if (mag == 0) {
    { ConstInt __ret603 = (ConstInt){.isConst = 1, .neg = 0, .value = 0};
    return __ret603; }
    }
    { ConstInt __ret604 = (ConstInt){.isConst = 1, .neg = neg, .value = mag};
    return __ret604; }
}
ConstInt addConst_na_Bool_a_U64_nb_Bool_b_U64(long long na, uint64_t a, long long nb, uint64_t b) {
    if (na == nb) {
    if (a > ({ uint64_t __ov; if (__builtin_sub_overflow((9223372036854775807), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })) {
    { ConstInt __ret605 = notConst();
    return __ret605; }
    }
    { ConstInt __ret606 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_add_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret606; }
    }
    if (a >= b) {
    { ConstInt __ret607 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_sub_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret607; }
    }
    { ConstInt __ret608 = mkConst_neg_Bool_mag_U64(nb, ({ uint64_t __ov; if (__builtin_sub_overflow((b), (a), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret608; }
}
ConstInt foldConst_c_Comp_id_U64(Comp* c, uint64_t id) {
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    ...
    Expr _m609 = e;
    if (_m609.tag == 0) {
        uint64_t value = _m609.data.Int.value;
        (void)value;
        long long isBool = _m609.data.Int.isBool;
        (void)isBool;
    if (isBool) {
    { ConstInt __ret610 = notConst();
    return __ret610; }
    }
    if (value > 9223372036854775807) {
    { ConstInt __ret611 = notConst();
    return __ret611; }
    }
    { ConstInt __ret612 = (ConstInt){.isConst = 1, .neg = 0, .value = value};
    return __ret612; }
    }
    else if (_m609.tag == 2) {
        int64_t op = _m609.data.Unary.op;
        (void)op;
        uint64_t operand = _m609.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ConstInt o = foldConst_c_Comp_id_U64(&((*c)), operand);
    if (o.isConst) {
    { ConstInt __ret613 = mkConst_neg_Bool_mag_U64(!(o.neg), o.value);
    return __ret613; }
    }
    }
    ...
    return __ret614; }
        ...
        int64_t op = _m609.data.Binary.op;
        (void)op;
        uint64_t lhs = _m609.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m609.data.Binary.rhs;
        (void)rhs;
    ...
    if (b.isConst) {
    if (op == 56) {
    { ConstInt __ret615 = addConst_na_Bool_a_U64_nb_Bool_b_U64(a.neg, a.value, b.neg, b.value);
    return __ret615; }
    }
    if (op == 57) {
    { ConstInt __ret616 = addConst_na_Bool_a_U64_nb_Bool_b_U64(a.neg, a.value, !(b.neg), b.value);
    return __ret616; }
    }
    if (op == 58) {
    if (a.value == 0) {
    { ConstInt __ret617 = mkConst_neg_Bool_mag_U64(0, 0);
    return __ret617; }
    }
    ...
    { ConstInt __ret619 = mkConst_neg_Bool_mag_U64((a.neg != b.neg), ({ uint64_t __ov; if (__builtin_mul_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret619; }
    }
    }
    }
...
long long tiIsInt_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    if (ti.kind == 0) {
    if (ti.nameLen != 0) {
    { long long __ret622 = isIntType_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret622; }
    }
    }
...
void checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(Comp* c, uint64_t id, uint64_t eKind, uint64_t eBits, long long eSgn) {
    ...
    Expr _m624 = e;
    if (_m624.tag == 0) {
        uint64_t value = _m624.data.Int.value;
        (void)value;
        uint64_t offset = _m624.data.Int.offset;
        (void)offset;
        long long isBool = _m624.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m624.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m624.data.Int.tyLen;
        (void)tyLen;
    checkLitLeaf_c_Comp_value_U64_neg_Bool_offset_U64_isBool_Bool_tyStart_U64_tyLen_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), value, 0, offset, isBool, tyStart, tyLen, eKind, eBits, eSgn);
        ...
        int64_t op = _m624.data.Unary.op;
        (void)op;
        uint64_t operand = _m624.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ...
    Expr _m625 = oe;
    if (_m625.tag == 0) {
        uint64_t value = _m625.data.Int.value;
        (void)value;
        uint64_t offset = _m625.data.Int.offset;
        (void)offset;
        long long isBool = _m625.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m625.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m625.data.Int.tyLen;
        (void)tyLen;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, eKind, eBits, eSgn);
        ...
        int64_t op = _m624.data.Binary.op;
        (void)op;
        uint64_t lhs = _m624.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m624.data.Binary.rhs;
        (void)rhs;
    long long isArith = 0;
    if (op >= 56) {
    if (op <= 60) {
    ...
    checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(&((*c)), lhs, rhs);
        ...
        uint64_t nameStart = _m624.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m624.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m624.data.Call.args;
        (void)args;
    checkCallArgs_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, PlewArray_Arg_share(args));
    }
    else if (_m624.tag == 10) {
        uint64_t recv = _m624.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m624.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m624.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m624.data.Method.args;
        (void)args;
    checkMethodArgs_c_Comp_recv_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recv, nameStart, nameLen, PlewArray_Arg_share(args));
    }
    else if (_m624.tag == 11) {
        uint64_t operand = _m624.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m624.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m624.data.Cast.tyLen;
        (void)tyLen;
    Expr oe = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    {
    Expr _m626 = oe;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, 0, 0, 0);
        ...
        uint64_t base = _m624.data.Field.base;
        (void)base;
        uint64_t nameStart = _m624.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m624.data.Field.nameLen;
        (void)nameLen;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    }
    else if (_m624.tag == 9) {
        uint64_t base = _m624.data.Index.base;
        (void)base;
        uint64_t index = _m624.data.Index.index;
        (void)index;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), index, 1, 64, 0);
    }
    else if (_m624.tag == 6) {
        uint64_t typeStart = _m624.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m624.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m624.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m624.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m624.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m624.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m624.data.Make.fields;
        (void)fields;
    checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(&((*c)), typeStart, typeLen, variantStart, variantLen, isEnum, ty, PlewArray_MakeField_share(fields));
        ...
        PlewArray_U64 elems = _m624.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    ...
    else if (_m624.tag == 12) {
        uint64_t scrut = _m624.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m624.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m624.tag == 14) {
        uint64_t opt = _m624.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m624.data.Coalesce.deflt;
        (void)deflt;
    ...
    else if (_m624.tag == 15) {
        uint64_t expr = _m624.data.Try.expr;
        (void)expr;
...
IntTy exprIntTy_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { IntTy __ret627 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen)};
    return __ret627; }
    }
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    {
    Expr _m628 = e;
    if (_m628.tag == 4) {
        uint64_t nameStart = _m628.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m628.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m628.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"argCount", 8})) {
    { IntTy __ret629 = (IntTy){.known = 1, .bits = 64, .sgn = 1};
    return __ret629; }
    }
    }
    else if (_m628.tag == 5) {
        uint64_t base = _m628.data.Field.base;
        (void)base;
        uint64_t nameStart = _m628.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m628.data.Field.nameLen;
        (void)nameLen;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"count", 5})) {
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { IntTy __ret630 = (IntTy){.known = 1, .bits = 64, .sgn = 0};
    return __ret630; }
    }
    }
    }
    else if (_m628.tag == 9) {
        uint64_t base = _m628.data.Index.base;
        (void)base;
        uint64_t index = _m628.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    if (isIntType_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)) {
    { IntTy __ret631 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)};
    return __ret631; }
    }
    }
    }
    ...
    { IntTy __ret632 = (IntTy){.known = 0, .bits = 0, .sgn = 0};
    return __ret632; }
}
void checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
TypeInfo makeFieldType_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret638 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), fd.tyStart, fd.tyLen, fd.tyIsArray);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    EnumDef_release(en);
    ...
    { TypeInfo __ret639 = scalarInfo();
    return __ret639; }
    }
    { TypeInfo __ret640 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), typeStart, typeLen, fieldStart, fieldLen);
    return __ret640; }
}
void checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t ty, PlewArray_MakeField fields) {
    uint64_t i = 0;
...
long long builtinEqOrd_c_Comp_typeStart_U64_typeLen_U64_traitStart_U64_traitLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t traitStart, uint64_t traitLen) {
    ...
    { long long __ret651 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), typeStart, typeLen, (PlewString){"String", 6});
    return __ret651; }
    }
...
void checkBoundsExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m666 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m666.tag == 2) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        (void)tyLen;
        uint64_t ty = _m666.data.Cast.ty;
        (void)ty;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
...
void checkBoundsStmt_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m667 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m667.tag == 0) {
        long long mutable = _m667.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m667.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m667.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m667.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m667.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m667.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m667.data.Let.ty;
        (void)ty;
        uint64_t init = _m667.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m667.data.Assign.op;
        (void)op;
        uint64_t target = _m667.data.Assign.target;
        (void)target;
        uint64_t value = _m667.data.Assign.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), target);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m667.tag == 2) {
        uint64_t expr = _m667.data.Print.expr;
        (void)expr;
        uint64_t offset = _m667.data.Print.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m667.tag == 3) {
        uint64_t expr = _m667.data.ExprStmt.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m667.tag == 4) {
        uint64_t value = _m667.data.Return.value;
        (void)value;
        long long hasValue = _m667.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m667.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m667.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m667.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m667.data.If.hasElse;
        (void)hasElse;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m667.data.While.cond;
        (void)cond;
        uint64_t body = _m667.data.While.body;
        (void)body;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m667.tag == 7) {
        uint64_t varStart = _m667.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m667.data.For.varLen;
        (void)varLen;
        long long isRange = _m667.data.For.isRange;
        (void)isRange;
        long long inclusive = _m667.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m667.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m667.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m667.data.For.body;
        (void)body;
        long long isStruct = _m667.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m667.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m667.data.For.patLen;
        (void)patLen;
        PlewArray_Bind binds = _m667.data.For.binds;
        (void)binds;
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m667.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m667.data.Match.arms;
        (void)arms;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m667.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m667.data.Panic.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m667.tag == 10) {
        uint64_t value = _m667.data.Give.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
...
void genExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    writeIntLit_n_U64(value);
        ...
        uint64_t start = _m673.data.Ident.start;
        (void)start;
        uint64_t len = _m673.data.Ident.len;
        (void)len;
    if ((*c).curInClosure) {
    if (isCaptureOf_c_Comp_closureId_U64_start_U64_len_U64(&((*c)), (*c).curClosureId, start, len)) {
    ...
    else if (_m673.tag == 18) {
        uint64_t operand = _m673.data.Move.operand;
        (void)operand;
        long long isBorrow = _m673.data.Move.isBorrow;
        (void)isBorrow;
    if (isBorrow) {
    genExpr_c_Comp_id_U64(&((*c)), operand);
    }
    ...
    {
    Expr _m674 = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    if (_m674.tag == 1) {
        uint64_t start = _m674.data.Ident.start;
        (void)start;
        uint64_t len = _m674.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    plew_write((PlewString){")", 1});
        ...
        (void)nameLen;
        PlewArray_Arg args = _m673.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), nameStart, nameLen, (PlewString){"write", 5})) {
    if ((*c).impWrite) {
    ...
    plew_write((PlewString){")", 1});
        ...
        (void)nameLen;
    {
    Expr _m675 = PlewArray_Expr_get((*c).exprs, (long long)(base));
    if (_m675.tag == 1) {
        uint64_t bs = _m675.data.Ident.start;
        (void)bs;
        uint64_t bl = _m675.data.Ident.len;
        (void)bl;
    ...
    writeSpan_c_Comp_start_U64_len_U64(&((*c)), nameStart, nameLen);
        ...
        uint64_t start = _m673.data.Str.start;
        (void)start;
        uint64_t len = _m673.data.Str.len;
        (void)len;
    ...
    else if (_m673.tag == 16) {
        uint64_t base = _m673.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m673.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m673.data.Arrow.nameLen;
        (void)nameLen;
    plew_write((PlewString){"(", 1});
    genExpr_c_Comp_id_U64(&((*c)), base);
    plew_write((PlewString){")->", 3});
    ...
    else if (_m673.tag == 17) {
        PlewArray_Param params = _m673.data.Closure.params;
        (void)params;
        long long hasRet = _m673.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m673.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m673.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m673.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m673.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m673.data.Closure.body;
        (void)body;
    ...
    plew_write((PlewString){", 0, 0, 0}", 10});
        ...
        (void)nameLen;
        PlewArray_Arg args = _m673.data.Method.args;
        (void)args;
    Bind arn = assocRecvName_c_Comp_recv_U64(&((*c)), recv);
    if (arn.nameLen != 0) {
    uint64_t afi = findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), arn.nameStart, arn.nameLen, nameStart, nameLen, PlewArray_Arg_share(args));
    ...
    {
    Expr _m676 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m676.tag == 9) {
        uint64_t abase = _m676.data.Index.base;
        (void)abase;
        uint64_t aidx = _m676.data.Index.index;
        (void)aidx;
    ...
    if (mf.selfMove) {
    {
    Expr _m677 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m677.tag == 1) {
        uint64_t start = _m677.data.Ident.start;
        (void)start;
        uint64_t len = _m677.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    Func_release(mf);
        ...
        PlewArray_U64 elems = _m673.data.Array.elems;
        (void)elems;
    ...
    Expr _m678 = opE;
    if (_m678.tag == 0) {
        uint64_t value = _m678.data.Int.value;
        (void)value;
        uint64_t offset = _m678.data.Int.offset;
        (void)offset;
    ...
    plew_write((PlewString){"))", 2});
        ...
        (void)ty;
        PlewArray_MakeField fields = _m673.data.Make.fields;
        (void)fields;
    if (isRefInst_c_Comp_ref_U64(&((*c)), ty)) {
    TypeRef rt = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ty)));
    uint64_t t2 = (*c).tmp;
    ...
    plew_write((PlewString){"}", 1});
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m673.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    ...
    else if (_m673.tag == 13) {
        uint64_t cond = _m673.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m673.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m673.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
...
long long isPlaceExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m679 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m679.tag == 1) {
        uint64_t start = _m679.data.Ident.start;
        (void)start;
        uint64_t len = _m679.data.Ident.len;
        (void)len;
...
long long isEnumEq_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    TypeInfo lt = exprType_c_Comp_id_U64(&((*c)), lhs);
    if (lt.kind == 2) {
    { long long __ret693 = isEnumName_c_Comp_start_U64_len_U64(&((*c)), lt.nameStart, lt.nameLen);
    return __ret693; }
    }
...
void emitEnumOperand_c_Comp_id_U64_enStart_U64_enLen_U64(Comp* c, uint64_t id, uint64_t enStart, uint64_t enLen) {
    ...
    Expr _m701 = e;
    if (_m701.tag == 6) {
        uint64_t typeStart = _m701.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m701.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m701.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m701.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m701.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m701.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m701.data.Make.fields;
        (void)fields;
    if (isEnum) {
...
uint64_t findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(Comp* c, uint64_t typeStart, uint64_t typeLen, PlewString name) {
    ...
    { uint64_t __ret703 = (long long)(((*c).funcs).len);
    return __ret703; }
}
uint64_t orderingVariantIndex_c_Comp_name_String(Comp* c, PlewString name) {
    uint64_t ei = 0;
...
long long hasCompareWitness_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    if (lt.kind == 2) {
    if (op == 50) {
    { long long __ret706 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret706; }
    }
    if (op == 51) {
    { long long __ret707 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret707; }
    }
    if (op >= 52) {
    if (op <= 55) {
    if (typeConformsToName_c_Comp_typeStart_U64_typeLen_U64_traitName_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"Ord", 3})) {
    { long long __ret708 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"compare", 7}) < (long long)(((*c).funcs).len));
    return __ret708; }
    }
    }
    }
...
long long eqWitnessReady_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret710 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), ti.nameStart, ti.nameLen, (PlewString){"eq", 2}) < (long long)(((*c).funcs).len));
    return __ret710; }
    }
...
void genCond_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m712 = e;
    if (_m712.tag == 3) {
        int64_t op = _m712.data.Binary.op;
        (void)op;
        uint64_t lhs = _m712.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m712.data.Binary.rhs;
        (void)rhs;
    if (isStringEq_c_Comp_op_I64_lhs_U64(&((*c)), op, lhs)) {
    genExpr_c_Comp_id_U64(&((*c)), id);
    }
...
long long tryArrayElemFieldAssign_c_Comp_op_I64_target_U64_value_U64(Comp* c, int64_t op, uint64_t target, uint64_t value) {
    ...
    Expr _m714 = be;
    if (_m714.tag == 9) {
        uint64_t abase = _m714.data.Index.base;
        (void)abase;
...
TypeInfo forBindFieldType_c_Comp_et_TypeInfo_bd_Bind(Comp* c, TypeInfo et, Bind bd) {
    if (isGenericInst_c_Comp_ref_U64(&((*c)), et.ref)) {
    { TypeInfo __ret720 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), et.ref, bd.fieldStart, bd.fieldLen);
    return __ret720; }
    }
    { TypeInfo __ret721 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), et.nameStart, et.nameLen, bd.fieldStart, bd.fieldLen);
    return __ret721; }
}
void addForStructBinds_c_Comp_et_TypeInfo_binds_ABind(Comp* c, TypeInfo et, PlewArray_Bind binds) {
    uint64_t bi = 0;
...
void genStmt_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t expr = _m722.data.Print.expr;
        (void)expr;
        uint64_t offset = _m722.data.Print.offset;
        (void)offset;
    if ((*c).impPrint) {
    ...
    {
    Expr _m724 = PlewArray_Expr_get((*c).exprs, (long long)(value));
    if (_m724.tag == 1) {
    ...
    plew_write((PlewString){"    }\n", 6});
        ...
        (void)patLen;
        PlewArray_Bind binds = _m722.data.For.binds;
        (void)binds;
    if (isRange) {
    ...
    plew_write((PlewString){"    continue;\n", 14});
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m722.data.Match.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    if (PlewArray_MatchArm_get(arms, (long long)(0)).isStruct) {
...
long long nameIsMain_c_Comp_f_Func(Comp* c, Func f) {
    ...
    { long long __ret726 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), f.nameStart, f.nameLen, (PlewString){"main", 4});
    return __ret726; }
}
long long isTraitName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
...
long long methodRecvIsTrait_c_Comp_f_Func(Comp* c, Func f) {
    if (f.hasRecv) {
    { long long __ret729 = isTraitName_c_Comp_start_U64_len_U64(&((*c)), f.recvStart, f.recvLen);
    return __ret729; }
    }
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret734 = (long long)(((*c).structs).len);
    return __ret734; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m750 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m750.tag == 17) {
        PlewArray_Param params = _m750.data.Closure.params;
        (void)params;
        long long hasRet = _m750.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m750.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m750.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m750.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m750.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m750.data.Closure.body;
        (void)body;
    if (hasRet) {
    (*c).curRetVoid = 0;
...
void collectFnThunks_c_Comp(Comp* c) {
    ...
    if (_m751.tag == 1) {
        uint64_t start = _m751.data.Ident.start;
        (void)start;
        uint64_t len = _m751.data.Ident.len;
        (void)len;
    uint64_t fvi = firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(&((*c)), start, len);
    if (fvi < (long long)(((*c).funcs).len)) {
...
void emitClosureEnvs_c_Comp(Comp* c) {
    ...
    while (i < (long long)(((*c).exprs).len)) {
    {
    Expr _m760 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m760.tag == 17) {
...
void emitClosures_c_Comp_proto_Bool(Comp* c, long long proto) {
    ...
    if (_m761.tag == 17) {
        PlewArray_Param params = _m761.data.Closure.params;
        (void)params;
        long long hasRet = _m761.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m761.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m761.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m761.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m761.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m761.data.Closure.body;
        (void)body;
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret763 = (long long)(((*c).structs).len);
    return __ret763; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret765 = (long long)(((*c).enums).len);
    return __ret765; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret769 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret769; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret771 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret771; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret774 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret774; }
    TypeRef_release(t);
}
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret777 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret777; }
    TypeRef_release(t);
}
...
Bind appendMangleSpan_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    uint64_t n = (long long)(((*c).bytes).len);
    { Bind __ret783 = (Bind){.nameStart = start, .nameLen = ({ uint64_t __ov; if (__builtin_sub_overflow((n), (start), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }), .fieldStart = ref, .fieldLen = 0};
    return __ret783; }
}
long long sameMangle_c_Comp_refA_U64_refB_U64(Comp* c, uint64_t refA, uint64_t refB) {
...
long long isCompoundType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret791 = ((long long)((PlewArray_TypeRef_get((*c).types, (long long)(r)).args).len) > 0);
    return __ret791; }
}
void emitConcreteCType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    uint64_t r = resolveTy_c_Comp_tyRef_U64(&((*c)), ref);
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret793 = PlewArray_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret793; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m803 = PlewArray_Stmt_get((*c).stmts, (long long)(sti));
    if (_m803.tag == 0) {
        uint64_t ty = _m803.data.Let.ty;
        (void)ty;
    ...
    {
    Expr _m804 = PlewArray_Expr_get((*c).exprs, (long long)(xi));
    if (_m804.tag == 11) {
        uint64_t operand = _m804.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m804.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m804.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m804.data.Cast.ty;
        (void)ty;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else if (_m804.tag == 6) {
        uint64_t typeStart = _m804.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m804.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m804.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m804.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m804.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m804.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m804.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).len) == 0) {
    { TypeInfo __ret805 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret805; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Array", 5})) {
    TypeRef el = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(PlewArray_U64_get(t.args, (long long)(0)))));
    { TypeInfo __ret806 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret806; }
    TypeRef_release(el);
    }
    { TypeInfo __ret807 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret807; }
    TypeRef_release(t);
}
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, PlewArray_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret808 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret808; }
    }
    ...
    { TypeInfo __ret809 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret809; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret811 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
    ...
    { TypeInfo __ret812 = (TypeInfo){.kind = 3, .nameStart = mn.nameStart, .nameLen = mn.nameLen, .ref = 0};
    TypeRef_release(elr);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    ...
    { TypeInfo __ret813 = (TypeInfo){.kind = 3, .nameStart = at.nameStart, .nameLen = at.nameLen, .ref = 0};
    TypeRef_release(at);
    TypeRef_release(elr);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    ...
    { TypeInfo __ret814 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret817 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    ...
    { TypeInfo __ret818 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret823 = ((long long)((f.typeParams).len) == (long long)((inst.args).len));
    TypeRef_release(inst);
    return __ret823; }
    TypeRef_release(inst);
}
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret826 = ((long long)((f.typeParams).len) > 0);
    Func_release(f);
    return __ret826; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    PlewArray_U64 noArgs = PlewArray_U64_new();
    { uint64_t __ret828 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = PlewArray_U64_share(noArgs)});
    PlewArray_U64_release(noArgs);
    return __ret828; }
    PlewArray_U64_release(noArgs);
}
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret832 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret832; }
}
uint64_t argArrayElemRef_c_Comp_argExpr_U64(Comp* c, uint64_t argExpr) {
    {
    Expr _m833 = PlewArray_Expr_get((*c).exprs, (long long)(argExpr));
    if (_m833.tag == 1) {
    ...
    { uint64_t __ret834 = PlewArray_U64_get(lt.args, (long long)(0));
    TypeRef_release(lt);
    return __ret834; }
    }
    }
...
PlewArray_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, PlewArray_Arg args) {
    ...
    { PlewArray_U64 __ret836 = PlewArray_U64_share(out);
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m851 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m851.tag == 1) {
        uint64_t start = _m851.data.Ident.start;
        (void)start;
        uint64_t len = _m851.data.Ident.len;
        (void)len;
    if ((*c).curInClosure) {
    uint64_t li = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
    ...
    else if (_m851.tag == 17) {
        PlewArray_Param params = _m851.data.Closure.params;
        (void)params;
        long long hasRet = _m851.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m851.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m851.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m851.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m851.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m851.data.Closure.body;
        (void)body;
    if ((*c).curInClosure) {
    ...
    (*c).curCaptureMark = savedMark;
        ...
        int64_t op = _m851.data.Unary.op;
        (void)op;
        uint64_t operand = _m851.data.Unary.operand;
        (void)operand;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m851.tag == 3) {
        int64_t op = _m851.data.Binary.op;
        (void)op;
        uint64_t lhs = _m851.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m851.data.Binary.rhs;
        (void)rhs;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), lhs);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
    }
    else if (_m851.tag == 4) {
        uint64_t nameStart = _m851.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m851.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m851.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    else if (_m851.tag == 10) {
        uint64_t recv = _m851.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m851.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m851.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m851.data.Method.args;
        (void)args;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t base = _m851.data.Field.base;
        (void)base;
        uint64_t nameStart = _m851.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m851.data.Field.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m851.tag == 9) {
        uint64_t base = _m851.data.Index.base;
        (void)base;
        uint64_t index = _m851.data.Index.index;
        (void)index;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), index);
    }
    else if (_m851.tag == 6) {
        uint64_t typeStart = _m851.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m851.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m851.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m851.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m851.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m851.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m851.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m851.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    else if (_m851.tag == 11) {
        uint64_t operand = _m851.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m851.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m851.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m851.data.Cast.ty;
        (void)ty;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m851.tag == 14) {
        uint64_t opt = _m851.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m851.data.Coalesce.deflt;
        (void)deflt;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), opt);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m851.tag == 15) {
        uint64_t expr = _m851.data.Try.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m851.tag == 16) {
        uint64_t base = _m851.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m851.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m851.data.Arrow.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m851.tag == 13) {
        uint64_t cond = _m851.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m851.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m851.data.IfExpr.elseBlk;
        (void)elseBlk;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
    }
    else if (_m851.tag == 12) {
        uint64_t scrut = _m851.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m851.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m851.tag == 18) {
        uint64_t operand = _m851.data.Move.operand;
        (void)operand;
        long long isBorrow = _m851.data.Move.isBorrow;
        (void)isBorrow;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m852 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m852.tag == 0) {
        long long mutable = _m852.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m852.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m852.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m852.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m852.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m852.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m852.data.Let.ty;
        (void)ty;
        uint64_t init = _m852.data.Let.init;
        (void)init;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), init);
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
    }
    else if (_m852.tag == 1) {
        int64_t op = _m852.data.Assign.op;
        (void)op;
        uint64_t target = _m852.data.Assign.target;
        (void)target;
        uint64_t value = _m852.data.Assign.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), target);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m852.tag == 2) {
        uint64_t expr = _m852.data.Print.expr;
        (void)expr;
        uint64_t offset = _m852.data.Print.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m852.tag == 3) {
        uint64_t expr = _m852.data.ExprStmt.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m852.tag == 4) {
        uint64_t value = _m852.data.Return.value;
        (void)value;
        long long hasValue = _m852.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m852.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m852.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m852.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m852.data.If.hasElse;
        (void)hasElse;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m852.data.While.cond;
        (void)cond;
        uint64_t body = _m852.data.While.body;
        (void)body;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m852.tag == 7) {
        uint64_t varStart = _m852.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m852.data.For.varLen;
        (void)varLen;
        long long isRange = _m852.data.For.isRange;
        (void)isRange;
        long long inclusive = _m852.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m852.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m852.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m852.data.For.body;
        (void)body;
        long long isStruct = _m852.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m852.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m852.data.For.patLen;
        (void)patLen;
        PlewArray_Bind binds = _m852.data.For.binds;
        (void)binds;
    uint64_t forMark = scopeMark_c_Comp(&((*c)));
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m852.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m852.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m852.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m852.data.Panic.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m852.tag == 10) {
        uint64_t value = _m852.data.Give.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m852.tag == 11) {
    }
    else if (_m852.tag == 12) {
    }
    else { __builtin_unreachable(); }
    }
}
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret853 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(PlewArray_U8_share((*c).bytes), elemStart, elemLen, (PlewString){"U8", 2});
    return __ret853; }
}
long long elemIsRef_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    ...
    { long long __ret855 = isRefInst_c_Comp_ref_U64(&((*c)), er);
    return __ret855; }
}
long long skipArrayElem_c_Comp_ae_Bind(Comp* c, Bind ae) {
...
PlewArray_Bind collectParts_rootBytes_AU8_toks_ATok(PlewArray_U8 rootBytes, PlewArray_Tok toks) {
    ...
    long long starts = 0;
    {
    Kind _m865 = first.kind;
    if (_m865.tag == 37) {
    starts = 1;
    }
    else if (_m865.tag == 48) {
    starts = 1;
    }
    else {
    ...
    { PlewArray_Bind __ret866 = PlewArray_Bind_share(parts);
...
PlewArray_U8 resolveImport_src_AU8_pStart_U64_pLen_U64_importer_AU8_baseLen_U64_srcRoot_AU8_srcRootLen_U64_stdRoot_AU8_stdRootLen_U64(PlewArray_U8 src, uint64_t pStart, uint64_t pLen, PlewArray_U8 importer, uint64_t baseLen, PlewArray_U8 srcRoot, uint64_t srcRootLen, PlewArray_U8 stdRoot, uint64_t stdRootLen) {
    ...
    if (stdRootLen == 0) {
    { PlewArray_U8 __ret869 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret869; }
    }
    uint64_t si = 0;
    ...
    { PlewArray_U8 __ret870 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret870; }
    }
    }
    ...
    { PlewArray_U8 __ret871 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret871; }
    }
    if (b0 == 47) {
    if (srcRootLen == 0) {
    { PlewArray_U8 __ret872 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret872; }
    }
    uint64_t i = 0;
    ...
    PlewArray_U8_push(&(out), 112);
    PlewArray_U8_push(&(out), 119);
    { PlewArray_U8 __ret873 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret873; }
    }
    ...
    PlewArray_U8_push(&(out), 112);
    PlewArray_U8_push(&(out), 119);
    { PlewArray_U8 __ret874 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret874; }
    PlewArray_U8_release(out);
}
...
PlewArray_U8 extractSpan_buf_AU8_start_U64_len_U64(PlewArray_U8 buf, uint64_t start, uint64_t len) {
    ...
    { PlewArray_U8 __ret875 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret875; }
    PlewArray_U8_release(out);
}
...
PlewArray_U8 computeStdRoot_arg0_AU8(PlewArray_U8 arg0) {
    ...
    { PlewArray_U8 __ret877 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret877; }
    PlewArray_U8_release(out);
}
PlewArray_U8 findSrcRoot_entry_AU8(PlewArray_U8 entry) {
    ...
    { PlewArray_U8 __ret878 = PlewArray_U8_share(sr);
    ...
    { PlewArray_U8 __ret879 = PlewArray_U8_share(empty);
