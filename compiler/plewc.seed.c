...
TypeInfo exprType_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m503 = e;
    if (_m503.tag == 0) {
        long long isBool = _m503.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m503.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m503.data.Int.tyLen;
        (void)tyLen;
    if (isBool) {
    Bind b = kwSpan_c_Comp_kw_String_kwLen_U64(&((*c)), (PlewString){"Bool", 4}, 4);
    if (b.nameLen != 0) {
    { TypeInfo __ret504 = (TypeInfo){.kind = 0, .nameStart = b.nameStart, .nameLen = b.nameLen, .ref = 0};
    Expr_release(e);
    return __ret504; }
    }
    }
    if (tyLen != 0) {
    { TypeInfo __ret505 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), tyStart, tyLen, 0);
    Expr_release(e);
    return __ret505; }
    }
    ...
    return __ret506; }
        ...
        uint64_t start = _m503.data.Str.start;
        (void)start;
        uint64_t len = _m503.data.Str.len;
        (void)len;
    ...
    return __ret507; }
        ...
        uint64_t start = _m503.data.Ident.start;
        (void)start;
        uint64_t len = _m503.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    { TypeInfo __ret508 = (TypeInfo){.kind = 3, .nameStart = en.nameStart, .nameLen = en.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    Expr_release(e);
    return __ret508; }
    }
    }
    { TypeInfo __ret509 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    Expr_release(e);
    return __ret509; }
    TypeRef_release(rt);
    }
    { TypeInfo __ret510 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), (*c).curRecvStart, (*c).curRecvLen, 0);
    Expr_release(e);
    return __ret510; }
    }
    if ((*c).curInClosure) {
    ...
    { TypeInfo __ret511 = (TypeInfo){.kind = 2, .nameStart = rt2.nameStart, .nameLen = rt2.nameLen, .ref = ce.ty};
    TypeRef_release(rt2);
    Expr_release(e);
    return __ret511; }
    TypeRef_release(rt2);
    }
    { TypeInfo __ret512 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), ce.tyStart, ce.tyLen, ce.isArray);
    Expr_release(e);
    return __ret512; }
    }
    }
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), lo.nameStart, lo.nameLen, start, len)) {
    if (lo.isArray) {
    { TypeInfo __ret513 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, 1);
    Expr_release(e);
    return __ret513; }
    }
    if (isGenericInst_c_Comp_ref_U64(&((*c)), lo.ty)) {
    TypeRef lt = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(lo.ty)));
    { TypeInfo __ret514 = (TypeInfo){.kind = 2, .nameStart = lt.nameStart, .nameLen = lt.nameLen, .ref = lo.ty};
    TypeRef_release(lt);
    Expr_release(e);
    return __ret514; }
    TypeRef_release(lt);
    ...
    { TypeInfo __ret515 = (TypeInfo){.kind = 2, .nameStart = lt2.nameStart, .nameLen = lt2.nameLen, .ref = lo.ty};
    TypeRef_release(lt2);
    Expr_release(e);
    return __ret515; }
    TypeRef_release(lt2);
    ...
    { TypeInfo __ret516 = (TypeInfo){.kind = 2, .nameStart = lt3.nameStart, .nameLen = lt3.nameLen, .ref = lo.ty};
    TypeRef_release(lt3);
    Expr_release(e);
    return __ret516; }
    TypeRef_release(lt3);
    ...
    { TypeInfo __ret517 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get((*c).curTypeArgs, (long long)(k)));
    Expr_release(e);
    return __ret517; }
    }
    k = ({ uint64_t __ov; if (__builtin_add_overflow((k), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    { TypeInfo __ret518 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, lo.isArray);
    Expr_release(e);
    return __ret518; }
    }
    }
    ...
    return __ret519; }
        ...
        int64_t op = _m503.data.Unary.op;
        (void)op;
        uint64_t operand = _m503.data.Unary.operand;
        (void)operand;
    if (op == opSub()) {
    ...
    return __ret522; }
        ...
        int64_t op = _m503.data.Binary.op;
        (void)op;
        uint64_t lhs = _m503.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m503.data.Binary.rhs;
        (void)rhs;
    if (op >= 56) {
    if (op <= 60) {
    ...
    return __ret525; }
        ...
        uint64_t nameStart = _m503.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m503.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m503.data.Call.args;
        (void)args;
    ...
    { TypeInfo __ret526 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(rb.args, (long long)(0)));
    TypeRef_release(rb);
    Expr_release(e);
    return __ret526; }
    }
    ...
    if (u64.nameLen != 0) {
    { TypeInfo __ret528 = (TypeInfo){.kind = 0, .nameStart = u64.nameStart, .nameLen = u64.nameLen, .ref = 0};
    Expr_release(e);
    return __ret528; }
    }
    }
    ...
    if (bl.nameLen != 0) {
    { TypeInfo __ret529 = (TypeInfo){.kind = 0, .nameStart = bl.nameStart, .nameLen = bl.nameLen, .ref = 0};
    Expr_release(e);
    return __ret529; }
    }
    }
    ...
    { TypeInfo __ret531 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), at.nameStart, at.nameLen, 0);
    Expr_release(e);
    return __ret531; }
    }
    ...
    { TypeInfo __ret534 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(inferred, (long long)(k)));
    ...
    { TypeInfo __ret535 = (TypeInfo){.kind = 2, .nameStart = rtr.nameStart, .nameLen = rtr.nameLen, .ref = f.retTy};
    TypeRef_release(rtr);
    Func_release(f);
    Expr_release(e);
    return __ret535; }
    ...
    { TypeInfo __ret536 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.retStart, f.retLen, f.retIsArray);
    Func_release(f);
    Expr_release(e);
    return __ret536; }
    }
    ...
    { TypeInfo __ret538 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(ftr.args, (long long)(0)));
    TypeRef_release(ftr);
    Expr_release(e);
    return __ret538; }
    }
    ...
    return __ret539; }
        ...
        uint64_t base = _m503.data.Field.base;
        (void)base;
        uint64_t nameStart = _m503.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m503.data.Field.nameLen;
        (void)nameLen;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 1) {
    ...
    if (u8.nameLen != 0) {
    { TypeInfo __ret540 = (TypeInfo){.kind = 3, .nameStart = u8.nameStart, .nameLen = u8.nameLen, .ref = 0};
    Expr_release(e);
    return __ret540; }
    }
    }
    ...
    { TypeInfo __ret542 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.ref, nameStart, nameLen);
    Expr_release(e);
    return __ret542; }
    }
    if (bt.kind == 2) {
    { TypeInfo __ret543 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.nameStart, bt.nameLen, nameStart, nameLen);
    Expr_release(e);
    return __ret543; }
    }
    ...
    return __ret544; }
        ...
        uint64_t typeStart = _m503.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m503.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m503.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m503.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m503.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m503.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m503.data.Make.fields;
        (void)fields;
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ty)) {
    { TypeInfo __ret545 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = ty};
    Expr_release(e);
    return __ret545; }
    }
    { TypeInfo __ret546 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = 0};
    Expr_release(e);
    return __ret546; }
    }
    else if (_m503.tag == 8) {
        Array_U64 elems = _m503.data.Array.elems;
        (void)elems;
    ...
    return __ret547; }
        ...
        uint64_t base = _m503.data.Index.base;
        (void)base;
        uint64_t index = _m503.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    ...
    { TypeInfo __ret548 = (TypeInfo){.kind = 3, .nameStart = xn.nameStart, .nameLen = xn.nameLen, .ref = 0};
    TypeRef_release(rt);
    Expr_release(e);
    return __ret548; }
    }
    ...
    { TypeInfo __ret549 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = rr};
    TypeRef_release(rt);
    Expr_release(e);
    return __ret549; }
    }
    ...
    { TypeInfo __ret550 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), bt.nameStart, bt.nameLen, 0);
    Expr_release(e);
    return __ret550; }
    }
    ...
    return __ret551; }
        ...
        uint64_t recv = _m503.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m503.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m503.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m503.data.Method.args;
        (void)args;
    ...
    if (af.hasRet) {
    { TypeInfo __ret553 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), af.retStart, af.retLen, af.retIsArray);
    Func_release(af);
    Expr_release(e);
    return __ret553; }
    }
    ...
    clearSelfItemEnv_c_Comp(&((*c)));
    { TypeInfo __ret556 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), gr);
    ...
    { TypeInfo __ret557 = substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(&((*c)), rt.ref, Array_Bind_share(Array_EnumDef_get((*c).enums, (long long)(gei)).typeParams), mf.retTy);
    TypeRef_release(gt);
    Func_release(mf);
    Expr_release(e);
    return __ret557; }
    ...
    clearSelfItemEnv_c_Comp(&((*c)));
    { TypeInfo __ret558 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), gr2);
    ...
    return __ret565; }
        ...
        uint64_t operand = _m503.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m503.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m503.data.Cast.tyLen;
        (void)tyLen;
    ...
    return __ret566; }
        ...
        uint64_t scrut = _m503.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m503.data.MatchExpr.arms;
        (void)arms;
    ...
    return __ret568; }
        ...
        uint64_t cond = _m503.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m503.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m503.data.IfExpr.elseBlk;
        (void)elseBlk;
    ...
    return __ret570; }
        ...
        uint64_t opt = _m503.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m503.data.Coalesce.deflt;
        (void)deflt;
    ...
    return __ret571; }
        ...
        uint64_t expr = _m503.data.Try.expr;
        (void)expr;
    ...
    return __ret573; }
        ...
        uint64_t base = _m503.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m503.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m503.data.Arrow.nameLen;
        (void)nameLen;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    ...
    return __ret575; }
        ...
        Array_Param params = _m503.data.Closure.params;
        (void)params;
        long long hasRet = _m503.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m503.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m503.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m503.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m503.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m503.data.Closure.body;
        (void)body;
    { TypeInfo __ret576 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), closureFnTypeRef_c_Comp_params_AParam_retTy_U64(&((*c)), Array_Param_share(params), retTy));
    Expr_release(e);
    return __ret576; }
    }
    else if (_m503.tag == 18) {
        uint64_t operand = _m503.data.Move.operand;
        (void)operand;
        long long isBorrow = _m503.data.Move.isBorrow;
        (void)isBorrow;
    ...
    return __ret577; }
        ...
        uint64_t operand = _m503.data.Await.operand;
        (void)operand;
...
int64_t opEq(void) {
    { int64_t __ret583 = kindCode_k_Kind((Kind){.tag = 42});
    return __ret583; }
}
int64_t opNe(void) {
    { int64_t __ret584 = kindCode_k_Kind((Kind){.tag = 43});
    return __ret584; }
}
int64_t opLt(void) {
    { int64_t __ret585 = kindCode_k_Kind((Kind){.tag = 44});
    return __ret585; }
}
int64_t opLe(void) {
    { int64_t __ret586 = kindCode_k_Kind((Kind){.tag = 45});
    return __ret586; }
}
int64_t opGt(void) {
    { int64_t __ret587 = kindCode_k_Kind((Kind){.tag = 46});
    return __ret587; }
}
int64_t opGe(void) {
    { int64_t __ret588 = kindCode_k_Kind((Kind){.tag = 47});
    return __ret588; }
}
int64_t opAdd(void) {
    { int64_t __ret589 = kindCode_k_Kind((Kind){.tag = 48});
    return __ret589; }
}
int64_t opSub(void) {
    { int64_t __ret590 = kindCode_k_Kind((Kind){.tag = 49});
    return __ret590; }
}
int64_t opMul(void) {
    { int64_t __ret591 = kindCode_k_Kind((Kind){.tag = 50});
    return __ret591; }
}
int64_t opDiv(void) {
    { int64_t __ret592 = kindCode_k_Kind((Kind){.tag = 51});
    return __ret592; }
}
int64_t opRem(void) {
    { int64_t __ret593 = kindCode_k_Kind((Kind){.tag = 52});
    return __ret593; }
}
int64_t opAnd(void) {
    { int64_t __ret594 = kindCode_k_Kind((Kind){.tag = 53});
    return __ret594; }
}
int64_t opOr(void) {
    { int64_t __ret595 = kindCode_k_Kind((Kind){.tag = 54});
    return __ret595; }
}
int64_t opNot(void) {
    { int64_t __ret596 = kindCode_k_Kind((Kind){.tag = 55});
    return __ret596; }
}
int64_t opBitAnd(void) {
    { int64_t __ret597 = kindCode_k_Kind((Kind){.tag = 56});
    return __ret597; }
}
int64_t opBitOr(void) {
    { int64_t __ret598 = kindCode_k_Kind((Kind){.tag = 57});
    return __ret598; }
}
int64_t opBitXor(void) {
    { int64_t __ret599 = kindCode_k_Kind((Kind){.tag = 58});
    return __ret599; }
}
int64_t opShl(void) {
    { int64_t __ret600 = kindCode_k_Kind((Kind){.tag = 59});
    return __ret600; }
}
int64_t opShr(void) {
    { int64_t __ret601 = kindCode_k_Kind((Kind){.tag = 60});
    return __ret601; }
}
int64_t opBitNot(void) {
    { int64_t __ret602 = kindCode_k_Kind((Kind){.tag = 61});
    return __ret602; }
}
int64_t opAssign(void) {
    { int64_t __ret603 = kindCode_k_Kind((Kind){.tag = 41});
    return __ret603; }
}
int64_t opAddAssign(void) {
    { int64_t __ret604 = kindCode_k_Kind((Kind){.tag = 65});
    return __ret604; }
}
int64_t opSubAssign(void) {
    { int64_t __ret605 = kindCode_k_Kind((Kind){.tag = 66});
    return __ret605; }
}
int64_t opMulAssign(void) {
    { int64_t __ret606 = kindCode_k_Kind((Kind){.tag = 67});
    return __ret606; }
}
int64_t opDivAssign(void) {
    { int64_t __ret607 = kindCode_k_Kind((Kind){.tag = 68});
    return __ret607; }
}
int64_t opRemAssign(void) {
    { int64_t __ret608 = kindCode_k_Kind((Kind){.tag = 69});
    return __ret608; }
}
int64_t opBitAndAssign(void) {
    { int64_t __ret609 = kindCode_k_Kind((Kind){.tag = 70});
    return __ret609; }
}
int64_t opBitOrAssign(void) {
    { int64_t __ret610 = kindCode_k_Kind((Kind){.tag = 71});
    return __ret610; }
}
int64_t opBitXorAssign(void) {
    { int64_t __ret611 = kindCode_k_Kind((Kind){.tag = 72});
    return __ret611; }
}
int64_t opShlAssign(void) {
    { int64_t __ret612 = kindCode_k_Kind((Kind){.tag = 73});
    return __ret612; }
}
int64_t opShrAssign(void) {
    { int64_t __ret613 = kindCode_k_Kind((Kind){.tag = 74});
    return __ret613; }
}
int64_t opCoalesce(void) {
    { int64_t __ret614 = kindCode_k_Kind((Kind){.tag = 77});
    return __ret614; }
}
PlewString binOpStr_op_I64(int64_t op) {
    if (op == opAdd()) {
...
long long isCheckedArith_op_I64(int64_t op) {
    ...
    { long long __ret641 = 0;
    return __ret641; }
}
int64_t compoundCheckedBin_op_I64(int64_t op) {
    if (op == opAddAssign()) {
    { int64_t __ret642 = opAdd();
    return __ret642; }
    }
    if (op == opSubAssign()) {
    { int64_t __ret643 = opSub();
    return __ret643; }
    }
    if (op == opMulAssign()) {
    { int64_t __ret644 = opMul();
    return __ret644; }
    }
    { int64_t __ret645 = 0;
    return __ret645; }
...
PlewString overflowBuiltin_op_I64(int64_t op) {
    if (op == opAdd()) {
    { PlewString __ret646 = (PlewString){"__builtin_add_overflow", 22};
    return __ret646; }
    }
    if (op == opSub()) {
    { PlewString __ret647 = (PlewString){"__builtin_sub_overflow", 22};
    return __ret647; }
    }
    { PlewString __ret648 = (PlewString){"__builtin_mul_overflow", 22};
    return __ret648; }
}
TypeInfo arithIntType_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
    ...
    { TypeInfo __ret650 = rt;
    return __ret650; }
    }
    }
    { TypeInfo __ret651 = scalarInfo();
    return __ret651; }
}
void genCheckedArith_c_Comp_op_I64_lhs_U64_rhs_U64_tyStart_U64_tyLen_U64(Comp* c, int64_t op, uint64_t lhs, uint64_t rhs, uint64_t tyStart, uint64_t tyLen) {
...
PlewString intMinMacro_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I8", 2})) {
    { PlewString __ret652 = (PlewString){"INT8_MIN", 8};
    return __ret652; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I16", 3})) {
    { PlewString __ret653 = (PlewString){"INT16_MIN", 9};
    return __ret653; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), start, len, (PlewString){"I32", 3})) {
    { PlewString __ret654 = (PlewString){"INT32_MIN", 9};
    return __ret654; }
    }
    { PlewString __ret655 = (PlewString){"INT64_MIN", 9};
    return __ret655; }
}
void genCheckedNeg_c_Comp_operand_U64_tyStart_U64_tyLen_U64(Comp* c, uint64_t operand, uint64_t tyStart, uint64_t tyLen) {
    plew_write((PlewString){"({ ", 3});
...
PlewString assignOpStr_op_I64(int64_t op) {
    if (op == opAssign()) {
    { PlewString __ret656 = (PlewString){" = ", 3};
    return __ret656; }
    }
    if (op == opAddAssign()) {
...
PlewString compoundDivFn_op_I64(int64_t op) {
    if (op == opDivAssign()) {
    { PlewString __ret670 = (PlewString){"plew_div(", 9};
    return __ret670; }
    }
    if (op == opRemAssign()) {
    { PlewString __ret671 = (PlewString){"plew_mod(", 9};
    return __ret671; }
    }
    { PlewString __ret672 = (PlewString){"", 0};
    return __ret672; }
}
PlewString assignToBinStr_op_I64(int64_t op) {
    if (op == opAddAssign()) {
...
ConstInt notConst(void) {
    { ConstInt __ret683 = (ConstInt){.isConst = 0, .neg = 0, .value = 0};
    return __ret683; }
}
ConstInt mkConst_neg_Bool_mag_U64(long long neg, uint64_t mag) {
    if (mag == 0) {
    { ConstInt __ret684 = (ConstInt){.isConst = 1, .neg = 0, .value = 0};
    return __ret684; }
    }
    { ConstInt __ret685 = (ConstInt){.isConst = 1, .neg = neg, .value = mag};
    return __ret685; }
}
ConstInt addConst_na_Bool_a_U64_nb_Bool_b_U64(long long na, uint64_t a, long long nb, uint64_t b) {
    if (na == nb) {
    if (a > ({ uint64_t __ov; if (__builtin_sub_overflow((9223372036854775807), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })) {
    { ConstInt __ret686 = notConst();
    return __ret686; }
    }
    { ConstInt __ret687 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_add_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret687; }
    }
    if (a >= b) {
    { ConstInt __ret688 = mkConst_neg_Bool_mag_U64(na, ({ uint64_t __ov; if (__builtin_sub_overflow((a), (b), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret688; }
    }
    { ConstInt __ret689 = mkConst_neg_Bool_mag_U64(nb, ({ uint64_t __ov; if (__builtin_sub_overflow((b), (a), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    return __ret689; }
}
ConstInt foldConst_c_Comp_id_U64(Comp* c, uint64_t id) {
    Expr e = Expr_share(Array_Expr_get((*c).exprs, (long long)(id)));
    ...
    if (_m690.tag == 0) {
        ...
        (void)value;
        long long isBool = _m690.data.Int.isBool;
        (void)isBool;
    if (isBool) {
    ...
    { ConstInt __ret693 = (ConstInt){.isConst = 1, .neg = 0, .value = value};
    Expr_release(e);
    return __ret693; }
    }
    else if (_m690.tag == 2) {
    ...
    if (o.isConst) {
    { ConstInt __ret694 = mkConst_neg_Bool_mag_U64(!(o.neg), o.value);
    Expr_release(e);
    return __ret694; }
    }
    }
    ...
    if (op == opMul()) {
    if (a.value == 0) {
    { ConstInt __ret698 = mkConst_neg_Bool_mag_U64(0, 0);
    Expr_release(e);
    return __ret698; }
    }
    ...
    { ConstInt __ret700 = mkConst_neg_Bool_mag_U64((a.neg != b.neg), ({ uint64_t __ov; if (__builtin_mul_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }));
    Expr_release(e);
    return __ret700; }
    }
    }
...
long long tiIsInt_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    if (ti.kind == 0) {
    if (ti.nameLen != 0) {
    { long long __ret703 = isIntType_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret703; }
    }
    }
...
void checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(Comp* c, uint64_t id, uint64_t eKind, uint64_t eBits, long long eSgn) {
    ...
    checkLitLeaf_c_Comp_value_U64_neg_Bool_offset_U64_isBool_Bool_tyStart_U64_tyLen_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), value, 0, offset, isBool, tyStart, tyLen, eKind, eBits, eSgn);
        ...
        int64_t op = _m705.data.Unary.op;
        (void)op;
        uint64_t operand = _m705.data.Unary.operand;
        (void)operand;
    if (op == opSub()) {
    ...
    checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(&((*c)), lhs, rhs);
        ...
        uint64_t nameStart = _m705.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m705.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m705.data.Call.args;
        (void)args;
    checkCallArgs_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, Array_Arg_share(args));
    }
    else if (_m705.tag == 10) {
        uint64_t recv = _m705.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m705.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m705.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m705.data.Method.args;
        (void)args;
    checkMethodArgs_c_Comp_recv_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recv, nameStart, nameLen, Array_Arg_share(args));
    }
    else if (_m705.tag == 11) {
        uint64_t operand = _m705.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m705.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m705.data.Cast.tyLen;
        (void)tyLen;
    Expr oe = Expr_share(Array_Expr_get((*c).exprs, (long long)(operand)));
    {
    Expr _m707 = oe;
    ...
    Expr_release(oe);
        ...
        uint64_t base = _m705.data.Field.base;
        (void)base;
        uint64_t nameStart = _m705.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m705.data.Field.nameLen;
        (void)nameLen;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    }
    else if (_m705.tag == 9) {
        uint64_t base = _m705.data.Index.base;
        (void)base;
        uint64_t index = _m705.data.Index.index;
        (void)index;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), index, 1, 64, 0);
    }
    else if (_m705.tag == 6) {
        uint64_t typeStart = _m705.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m705.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m705.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m705.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m705.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m705.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m705.data.Make.fields;
        (void)fields;
    checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(&((*c)), typeStart, typeLen, variantStart, variantLen, isEnum, ty, Array_MakeField_share(fields));
        ...
        Array_U64 elems = _m705.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    ...
    else if (_m705.tag == 12) {
        uint64_t scrut = _m705.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m705.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m705.tag == 14) {
        uint64_t opt = _m705.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m705.data.Coalesce.deflt;
        (void)deflt;
    ...
    else if (_m705.tag == 15) {
        uint64_t expr = _m705.data.Try.expr;
        (void)expr;
...
IntTy exprIntTy_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { IntTy __ret708 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen)};
    return __ret708; }
    }
    Expr e = Expr_share(Array_Expr_get((*c).exprs, (long long)(id)));
    {
    ...
    { IntTy __ret710 = (IntTy){.known = 1, .bits = 64, .sgn = 1};
    Expr_release(e);
    return __ret710; }
    }
    }
    ...
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { IntTy __ret711 = (IntTy){.known = 1, .bits = 64, .sgn = 0};
    Expr_release(e);
    return __ret711; }
    }
    }
    ...
    { IntTy __ret712 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)};
    Expr_release(e);
    return __ret712; }
    }
    }
    ...
    { IntTy __ret713 = (IntTy){.known = 0, .bits = 0, .sgn = 0};
    Expr_release(e);
    return __ret713; }
    Expr_release(e);
}
...
TypeInfo makeFieldType_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret719 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), fd.tyStart, fd.tyLen, fd.tyIsArray);
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
    EnumDef_release(en);
    ...
    { TypeInfo __ret720 = scalarInfo();
    return __ret720; }
    }
    { TypeInfo __ret721 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), typeStart, typeLen, fieldStart, fieldLen);
    return __ret721; }
}
void checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t ty, Array_MakeField fields) {
    uint64_t i = 0;
...
Bind assocBindingSpan_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen) {
    ...
    { Bind __ret726 = (Bind){.nameStart = ab.tyStart, .nameLen = ab.tyLen, .fieldStart = ab.tyStart, .fieldLen = ab.tyLen};
    return __ret726; }
    }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    { Bind __ret727 = (Bind){.nameStart = nameStart, .nameLen = nameLen, .fieldStart = nameStart, .fieldLen = nameLen};
    return __ret727; }
}
long long paramSelectorEqSubst_c_Comp_w_AParam_r_AParam_recvStart_U64_recvLen_U64(Comp* c, Array_Param w, Array_Param r, uint64_t recvStart, uint64_t recvLen) {
...
long long builtinEqOrd_c_Comp_typeStart_U64_typeLen_U64_traitStart_U64_traitLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t traitStart, uint64_t traitLen) {
    ...
    { long long __ret738 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), typeStart, typeLen, (PlewString){"String", 6});
    return __ret738; }
    }
...
void checkBoundsExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m753 = Array_Expr_get((*c).exprs, (long long)(exprId));
    if (_m753.tag == 2) {
        int64_t op = _m753.data.Unary.op;
        (void)op;
        uint64_t operand = _m753.data.Unary.operand;
        (void)operand;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m753.tag == 3) {
        int64_t op = _m753.data.Binary.op;
        (void)op;
        uint64_t lhs = _m753.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m753.data.Binary.rhs;
        (void)rhs;
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), lhs)), (PlewString){"comparison on a type parameter needs an Eq/Ord bound (add `where T: Eq` / `: Ord`)", 82});
        ...
        uint64_t nameStart = _m753.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m753.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m753.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).count)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t recv = _m753.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m753.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m753.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m753.data.Method.args;
        (void)args;
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), nameStart), (PlewString){"method not provided by the bounds of this type parameter (add a `where T: Trait` that declares it)", 98});
        ...
        uint64_t base = _m753.data.Field.base;
        (void)base;
        uint64_t nameStart = _m753.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m753.data.Field.nameLen;
        (void)nameLen;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        Array_U64 elems = _m753.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).count)) {
    ...
    else if (_m753.tag == 14) {
        uint64_t opt = _m753.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m753.data.Coalesce.deflt;
        (void)deflt;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), opt);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m753.tag == 15) {
        uint64_t expr = _m753.data.Try.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m753.tag == 16) {
        uint64_t base = _m753.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m753.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m753.data.Arrow.nameLen;
        (void)nameLen;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m753.tag == 13) {
        uint64_t cond = _m753.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m753.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m753.data.IfExpr.elseBlk;
        (void)elseBlk;
    ...
    else if (_m753.tag == 12) {
        uint64_t scrut = _m753.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m753.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m753.tag == 18) {
        uint64_t operand = _m753.data.Move.operand;
        (void)operand;
        long long isBorrow = _m753.data.Move.isBorrow;
        (void)isBorrow;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void checkBoundsStmt_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m754 = Array_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m754.tag == 0) {
        long long mutable = _m754.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m754.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m754.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m754.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m754.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m754.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m754.data.Let.ty;
        (void)ty;
        uint64_t init = _m754.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m754.data.Assign.op;
        (void)op;
        uint64_t target = _m754.data.Assign.target;
        (void)target;
        uint64_t value = _m754.data.Assign.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), target);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m754.tag == 2) {
        uint64_t expr = _m754.data.ExprStmt.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m754.tag == 3) {
        uint64_t value = _m754.data.Return.value;
        (void)value;
        long long hasValue = _m754.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m754.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m754.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m754.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m754.data.If.hasElse;
        (void)hasElse;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m754.data.While.cond;
        (void)cond;
        uint64_t body = _m754.data.While.body;
        (void)body;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m754.tag == 6) {
        uint64_t varStart = _m754.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m754.data.For.varLen;
        (void)varLen;
        long long isRange = _m754.data.For.isRange;
        (void)isRange;
        long long inclusive = _m754.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m754.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m754.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m754.data.For.body;
        (void)body;
        long long isStruct = _m754.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m754.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m754.data.For.patLen;
        (void)patLen;
        Array_Bind binds = _m754.data.For.binds;
        (void)binds;
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m754.data.Match.scrut;
        (void)scrut;
        Array_MatchArm arms = _m754.data.Match.arms;
        (void)arms;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).count)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m754.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m754.data.Panic.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m754.tag == 9) {
        uint64_t value = _m754.data.Give.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
...
void checkUseVisibility_c_Comp(Comp* c) {
    ...
    {
    Expr _m764 = Array_Expr_get((*c).exprs, (long long)(i));
    if (_m764.tag == 4) {
        uint64_t nameStart = _m764.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m764.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m764.data.Call.args;
        (void)args;
    uint64_t fi = findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, Array_Arg_share(args));
    if (fi < (long long)(((*c).funcs).count)) {
...
long long argIsElementTyped_c_Comp_mf_Func_i_U64(Comp* c, Func mf, uint64_t i) {
    ...
    { long long __ret768 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), p.tyStart, p.tyLen, Array_Bind_get(mf.typeParams, (long long)(0)).nameStart, Array_Bind_get(mf.typeParams, (long long)(0)).nameLen);
    return __ret768; }
}
long long makeProvides_c_Comp_fields_AMakeField_nameStart_U64_nameLen_U64(Comp* c, Array_MakeField fields, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
...
void genExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m771 = e;
    if (_m771.tag == 0) {
        uint64_t value = _m771.data.Int.value;
        (void)value;
    ...
    else if (_m771.tag == 18) {
        uint64_t operand = _m771.data.Move.operand;
        (void)operand;
        long long isBorrow = _m771.data.Move.isBorrow;
        (void)isBorrow;
    if (isBorrow) {
    genExpr_c_Comp_id_U64(&((*c)), operand);
    }
    ...
    {
    Expr _m772 = Array_Expr_get((*c).exprs, (long long)(operand));
    if (_m772.tag == 1) {
    ...
    markMovedExpr_c_Comp_exprId_U64(&((*c)), operand);
        ...
        int64_t op = _m771.data.Unary.op;
        (void)op;
        uint64_t operand = _m771.data.Unary.operand;
        (void)operand;
    ...
    plew_write((PlewString){")", 1});
        ...
        int64_t op = _m771.data.Binary.op;
        (void)op;
        uint64_t lhs = _m771.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m771.data.Binary.rhs;
        (void)rhs;
    ...
    plew_write((PlewString){")", 1});
        ...
        uint64_t nameStart = _m771.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m771.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m771.data.Call.args;
        (void)args;
    ...
    plew_write((PlewString){")", 1});
        ...
        (void)nameLen;
    {
    Expr _m773 = Array_Expr_get((*c).exprs, (long long)(base));
    if (_m773.tag == 1) {
        uint64_t bs = _m773.data.Ident.start;
        (void)bs;
        uint64_t bl = _m773.data.Ident.len;
        (void)bl;
    ...
    writeSpan_c_Comp_start_U64_len_U64(&((*c)), nameStart, nameLen);
        ...
        uint64_t start = _m771.data.Str.start;
        (void)start;
        uint64_t len = _m771.data.Str.len;
        (void)len;
    ...
    else if (_m771.tag == 16) {
        uint64_t base = _m771.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m771.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m771.data.Arrow.nameLen;
        (void)nameLen;
    plew_write((PlewString){"(", 1});
    genExpr_c_Comp_id_U64(&((*c)), base);
    plew_write((PlewString){")->", 3});
    ...
    else if (_m771.tag == 17) {
        Array_Param params = _m771.data.Closure.params;
        (void)params;
    ...
    else if (_m771.tag == 10) {
        uint64_t recv = _m771.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m771.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m771.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m771.data.Method.args;
        (void)args;
    Bind arn = assocRecvName_c_Comp_recv_U64(&((*c)), recv);
    if (arn.nameLen != 0) {
    uint64_t afi = findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), arn.nameStart, arn.nameLen, nameStart, nameLen, Array_Arg_share(args));
    ...
    if (_m774.tag == 9) {
        uint64_t abase = _m774.data.Index.base;
        (void)abase;
        uint64_t aidx = _m774.data.Index.index;
        (void)aidx;
    ...
    Func_release(mf);
        ...
        Array_U64 elems = _m771.data.Array.elems;
        (void)elems;
    plew_write((PlewString){"0", 1});
    }
    else if (_m771.tag == 11) {
        uint64_t operand = _m771.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m771.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m771.data.Cast.tyLen;
        (void)tyLen;
    ...
    Expr _m776 = opE;
    if (_m776.tag == 0) {
        uint64_t value = _m776.data.Int.value;
        (void)value;
        uint64_t offset = _m776.data.Int.offset;
        (void)offset;
    ...
    plew_write((PlewString){"))", 2});
        ...
        uint64_t typeStart = _m771.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m771.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m771.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m771.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m771.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m771.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m771.data.Make.fields;
        (void)fields;
    if (isRefInst_c_Comp_ref_U64(&((*c)), ty)) {
    TypeRef rt = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ty)));
    uint64_t t2 = (*c).tmp;
    ...
    else if (_m771.tag == 12) {
        uint64_t scrut = _m771.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m771.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).count) > 0) {
    ...
    else if (_m771.tag == 13) {
        uint64_t cond = _m771.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m771.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m771.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
    ...
    else if (_m771.tag == 14) {
        uint64_t opt = _m771.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m771.data.Coalesce.deflt;
        (void)deflt;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    else if (_m771.tag == 15) {
        uint64_t expr = _m771.data.Try.expr;
        (void)expr;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    else if (_m771.tag == 19) {
        uint64_t operand = _m771.data.Await.operand;
        (void)operand;
...
long long isPlaceExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m777 = Array_Expr_get((*c).exprs, (long long)(id));
    if (_m777.tag == 1) {
...
void genArrayLiteral_c_Comp_exprId_U64_elemStart_U64_elemLen_U64(Comp* c, uint64_t exprId, uint64_t elemStart, uint64_t elemLen) {
    ...
    Expr _m782 = e;
    if (_m782.tag == 8) {
        Array_U64 elems = _m782.data.Array.elems;
        (void)elems;
...
long long isEnumEq_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    TypeInfo lt = exprType_c_Comp_id_U64(&((*c)), lhs);
    if (lt.kind == 2) {
    { long long __ret791 = isEnumName_c_Comp_start_U64_len_U64(&((*c)), lt.nameStart, lt.nameLen);
    return __ret791; }
    }
...
void emitEnumOperand_c_Comp_id_U64_enStart_U64_enLen_U64(Comp* c, uint64_t id, uint64_t enStart, uint64_t enLen) {
    ...
    Expr _m799 = e;
    if (_m799.tag == 6) {
        uint64_t typeStart = _m799.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m799.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m799.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m799.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m799.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m799.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m799.data.Make.fields;
        (void)fields;
    if (isEnum) {
...
uint64_t findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(Comp* c, uint64_t typeStart, uint64_t typeLen, PlewString name) {
    ...
    { uint64_t __ret801 = (long long)(((*c).funcs).count);
    return __ret801; }
}
uint64_t orderingVariantIndex_c_Comp_name_String(Comp* c, PlewString name) {
    uint64_t ei = 0;
...
long long hasCompareWitness_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    { long long __ret806 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"compare", 7}) < (long long)(((*c).funcs).count));
    return __ret806; }
    }
    }
    }
...
long long eqWitnessReady_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret808 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), ti.nameStart, ti.nameLen, (PlewString){"eq", 2}) < (long long)(((*c).funcs).count));
    return __ret808; }
    }
...
void genCond_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m810 = e;
    if (_m810.tag == 3) {
        int64_t op = _m810.data.Binary.op;
        (void)op;
        uint64_t lhs = _m810.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m810.data.Binary.rhs;
        (void)rhs;
    if (isStringEq_c_Comp_op_I64_lhs_U64(&((*c)), op, lhs)) {
    genExpr_c_Comp_id_U64(&((*c)), id);
    }
...
long long tryArrayElemFieldAssign_c_Comp_op_I64_target_U64_value_U64(Comp* c, int64_t op, uint64_t target, uint64_t value) {
    ...
    Expr _m811 = te;
    if (_m811.tag == 5) {
        uint64_t base = _m811.data.Field.base;
        (void)base;
        uint64_t nameStart = _m811.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m811.data.Field.nameLen;
        (void)nameLen;
    Expr be = Expr_share(Array_Expr_get((*c).exprs, (long long)(base)));
    {
    Expr _m812 = be;
    if (_m812.tag == 9) {
        uint64_t abase = _m812.data.Index.base;
        (void)abase;
        uint64_t index = _m812.data.Index.index;
        (void)index;
...
TypeInfo forBindFieldType_c_Comp_et_TypeInfo_bd_Bind(Comp* c, TypeInfo et, Bind bd) {
    if (isGenericInst_c_Comp_ref_U64(&((*c)), et.ref)) {
    { TypeInfo __ret818 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), et.ref, bd.fieldStart, bd.fieldLen);
    return __ret818; }
    }
    { TypeInfo __ret819 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), et.nameStart, et.nameLen, bd.fieldStart, bd.fieldLen);
    return __ret819; }
}
void addForStructBinds_c_Comp_et_TypeInfo_binds_ABind(Comp* c, TypeInfo et, Array_Bind binds) {
    uint64_t bi = 0;
...
void genStmt_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Stmt _m820 = s;
    if (_m820.tag == 0) {
        long long mutable = _m820.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m820.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m820.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m820.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m820.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m820.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m820.data.Let.ty;
        (void)ty;
        uint64_t init = _m820.data.Let.init;
        (void)init;
    ...
    addLocalCn_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool_cnum_U64(&((*c)), nameStart, nameLen, effStart, effLen, effArr, effTy, 0, mutable, 1, cnum);
        ...
        int64_t op = _m820.data.Assign.op;
        (void)op;
        uint64_t target = _m820.data.Assign.target;
        (void)target;
        uint64_t value = _m820.data.Assign.value;
        (void)value;
    ...
    Expr _m821 = te;
    if (_m821.tag == 9) {
        uint64_t base = _m821.data.Index.base;
        (void)base;
    ...
    {
    Expr _m822 = Array_Expr_get((*c).exprs, (long long)(target));
    if (_m822.tag == 5) {
        uint64_t base = _m822.data.Field.base;
        (void)base;
        uint64_t nameStart = _m822.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m822.data.Field.nameLen;
        (void)nameLen;
    ...
    Expr_release(te);
        ...
        uint64_t expr = _m820.data.ExprStmt.expr;
        (void)expr;
    if ((*c).curAsync) {
    {
    Expr _m823 = Array_Expr_get((*c).exprs, (long long)(expr));
    if (_m823.tag == 19) {
        uint64_t operand = _m823.data.Await.operand;
        (void)operand;
    ...
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t value = _m820.data.Return.value;
        (void)value;
        long long hasValue = _m820.data.Return.hasValue;
        (void)hasValue;
    if ((*c).curAsync) {
    ...
    {
    Expr _m824 = Array_Expr_get((*c).exprs, (long long)(value));
    if (_m824.tag == 1) {
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), value)), (PlewString){"returning a field of a unique value is a partial move (not yet supported)", 73});
        ...
        uint64_t base = _m824.data.Index.base;
        (void)base;
        uint64_t index = _m824.data.Index.index;
        (void)index;
    ...
    plew_write((PlewString){"; }\n", 4});
        ...
        uint64_t cond = _m820.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m820.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m820.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m820.data.If.hasElse;
        (void)hasElse;
    ...
    (*c).curBranchBase = savedBB;
        ...
        uint64_t cond = _m820.data.While.cond;
        (void)cond;
        uint64_t body = _m820.data.While.body;
        (void)body;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), cond, 0, 0, 0);
    ...
    plew_write((PlewString){"    }\n", 6});
        ...
        uint64_t varStart = _m820.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m820.data.For.varLen;
        (void)varLen;
        long long isRange = _m820.data.For.isRange;
        (void)isRange;
        long long inclusive = _m820.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m820.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m820.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m820.data.For.body;
        (void)body;
        long long isStruct = _m820.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m820.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m820.data.For.patLen;
        (void)patLen;
        Array_Bind binds = _m820.data.For.binds;
        (void)binds;
    if (isRange) {
    ...
    scopeExit_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t msg = _m820.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m820.data.Panic.offset;
        (void)offset;
    ...
    plew_write((PlewString){");\n", 3});
        ...
        uint64_t value = _m820.data.Give.value;
        (void)value;
...
long long nameIsMain_c_Comp_f_Func(Comp* c, Func f) {
    ...
    { long long __ret826 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), f.nameStart, f.nameLen, (PlewString){"main", 4});
    return __ret826; }
}
long long isTraitName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
...
long long methodRecvIsTrait_c_Comp_f_Func(Comp* c, Func f) {
    if (f.hasRecv) {
    { long long __ret829 = isTraitName_c_Comp_start_U64_len_U64(&((*c)), f.recvStart, f.recvLen);
    return __ret829; }
    }
...
Array_Bind providedCopyTypeParams_c_Comp_recvStart_U64_recvLen_U64_ownParams_ABind(Comp* c, uint64_t recvStart, uint64_t recvLen, Array_Bind ownParams) {
    ...
    { Array_Bind __ret833 = Array_Bind_share(out);
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret835 = (long long)(((*c).structs).count);
    return __ret835; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
long long typeInfoNeedsCopy_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret843 = monoEnumNeedsCopy_c_Comp_instRef_U64(&((*c)), ti.ref);
    return __ret843; }
    }
    { long long __ret844 = monoStructNeedsCopy_c_Comp_instRef_U64(&((*c)), ti.ref);
    return __ret844; }
    }
    }
    ...
    { long long __ret846 = enumNeedsCopy_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret846; }
    }
...
long long typeInfoNeedsRelease_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ti.ref)) {
    if (isGenericEnumInst_c_Comp_ref_U64(&((*c)), ti.ref)) {
    { long long __ret849 = monoEnumNeedsRelease_c_Comp_instRef_U64(&((*c)), ti.ref);
    return __ret849; }
    }
    ...
    { long long __ret852 = enumNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret852; }
    }
...
long long fieldNeedsCopy_c_Comp_f_FieldDef(Comp* c, FieldDef f) {
    ...
    { long long __ret857 = monoEnumNeedsCopy_c_Comp_instRef_U64(&((*c)), f.ty);
    return __ret857; }
    }
    { long long __ret858 = monoStructNeedsCopy_c_Comp_instRef_U64(&((*c)), f.ty);
    return __ret858; }
    }
    }
    ...
    { long long __ret860 = enumNeedsCopy_c_Comp_start_U64_len_U64(&((*c)), f.tyStart, f.tyLen);
    return __ret860; }
}
long long fieldNeedsRelease_c_Comp_f_FieldDef(Comp* c, FieldDef f) {
    if (fieldIsBoxed_c_Comp_f_FieldDef(&((*c)), f)) {
    ...
    if (isGenericInst_c_Comp_ref_U64(&((*c)), f.ty)) {
    if (isGenericEnumInst_c_Comp_ref_U64(&((*c)), f.ty)) {
    { long long __ret864 = monoEnumNeedsRelease_c_Comp_instRef_U64(&((*c)), f.ty);
    return __ret864; }
    }
    ...
    { long long __ret868 = enumNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), f.tyStart, f.tyLen);
    return __ret868; }
}
long long enumNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
...
long long pointeeNeedsRelease_c_Comp_f_FieldDef(Comp* c, FieldDef f) {
    ...
    if (isGenericInst_c_Comp_ref_U64(&((*c)), f.ty)) {
    if (isGenericEnumInst_c_Comp_ref_U64(&((*c)), f.ty)) {
    { long long __ret878 = monoEnumNeedsRelease_c_Comp_instRef_U64(&((*c)), f.ty);
    return __ret878; }
    }
    ...
    { long long __ret881 = enumNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), f.tyStart, f.tyLen);
    return __ret881; }
}
void emitBoxedFieldRetain_c_Comp_f_FieldDef_isEnum_Bool_vStart_U64_vLen_U64(Comp* c, FieldDef f, long long isEnum, uint64_t vStart, uint64_t vLen) {
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m894 = Array_Expr_get((*c).exprs, (long long)(id));
    if (_m894.tag == 17) {
        Array_Param params = _m894.data.Closure.params;
        (void)params;
        long long hasRet = _m894.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m894.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m894.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m894.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m894.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m894.data.Closure.body;
        (void)body;
    if (hasRet) {
    (*c).curRetVoid = 0;
...
void collectFnThunks_c_Comp(Comp* c) {
    ...
    while (i < (long long)(((*c).exprs).count)) {
    {
    Expr _m895 = Array_Expr_get((*c).exprs, (long long)(i));
    if (_m895.tag == 1) {
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret907 = (long long)(((*c).structs).count);
    return __ret907; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret909 = (long long)(((*c).enums).count);
    return __ret909; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret914 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).count));
    TypeRef_release(t);
    return __ret914; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret916 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret916; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret919 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret919; }
    TypeRef_release(t);
}
long long isRawBufInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret922 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"RawBuffer", 9});
    TypeRef_release(t);
    return __ret922; }
    TypeRef_release(t);
}
long long isPromiseInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret924 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Promise", 7});
    TypeRef_release(t);
    return __ret924; }
    TypeRef_release(t);
}
long long isIndirectContainer_c_Comp_nStart_U64_nLen_U64(Comp* c, uint64_t nStart, uint64_t nLen) {
    ...
    { long long __ret928 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), nStart, nLen, (PlewString){"WeakRef", 7});
    return __ret928; }
}
long long isTransparentContainer_c_Comp_nStart_U64_nLen_U64(Comp* c, uint64_t nStart, uint64_t nLen) {
    ...
    { long long __ret930 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), nStart, nLen, (PlewString){"Result", 6});
    return __ret930; }
}
uint64_t concreteEnumIndex_c_Comp_nStart_U64_nLen_U64(Comp* c, uint64_t nStart, uint64_t nLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret932 = (long long)(((*c).enums).count);
    return __ret932; }
}
long long containsU64_xs_AU64_v_U64(Array_U64 xs, uint64_t v) {
    uint64_t i = 0;
...
long long typeRefReachesOwner_c_Comp_ref_U64_tStart_U64_tLen_U64_visited_AU64(Comp* c, uint64_t ref, uint64_t tStart, uint64_t tLen, Array_U64* visited) {
    ...
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret949 = nameReachesOwner_c_Comp_nStart_U64_nLen_U64_args_AU64_tStart_U64_tLen_U64_visited_AU64(&((*c)), t.nameStart, t.nameLen, Array_U64_share(t.args), tStart, tLen, &((*visited)));
    TypeRef_release(t);
    return __ret949; }
    TypeRef_release(t);
}
long long fieldReachesOwner_c_Comp_f_FieldDef_tStart_U64_tLen_U64_visited_AU64(Comp* c, FieldDef f, uint64_t tStart, uint64_t tLen, Array_U64* visited) {
    ...
    if (f.ty != 0) {
    { long long __ret951 = typeRefReachesOwner_c_Comp_ref_U64_tStart_U64_tLen_U64_visited_AU64(&((*c)), f.ty, tStart, tLen, &((*visited)));
    return __ret951; }
    }
    Array_U64 noArgs = Array_U64_new();
    { long long __ret952 = nameReachesOwner_c_Comp_nStart_U64_nLen_U64_args_AU64_tStart_U64_tLen_U64_visited_AU64(&((*c)), f.tyStart, f.tyLen, Array_U64_share(noArgs), tStart, tLen, &((*visited)));
    Array_U64_release(noArgs);
    return __ret952; }
    Array_U64_release(noArgs);
}
long long fieldIsBoxed_c_Comp_f_FieldDef(Comp* c, FieldDef f) {
    { long long __ret953 = containsU64_xs_AU64_v_U64(Array_U64_share((*c).boxedFields), f.nameStart);
    return __ret953; }
}
FieldDef noField(void) {
    { FieldDef __ret954 = (FieldDef){.nameStart = 0, .nameLen = 0, .tyStart = 0, .tyLen = 0, .tyIsArray = 0, .ty = 0, .isMut = 0, .hasDefault = 0, .defaultVal = 0, .vis = 0};
    return __ret954; }
}
FieldDef findFieldDef_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    if (isEnum) {
    ...
    { FieldDef __ret956 = Array_FieldDef_get(fs, (long long)(fj));
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
    return __ret956; }
    ...
    { FieldDef __ret959 = Array_FieldDef_get(fs, (long long)(fi));
    Array_FieldDef_release(fs);
    return __ret959; }
    }
    fi = ({ uint64_t __ov; if (__builtin_add_overflow((fi), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret963 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).count));
    TypeRef_release(t);
    return __ret963; }
    TypeRef_release(t);
}
...
Bind appendMangleSpan_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    uint64_t n = (long long)(((*c).bytes).count);
    { Bind __ret969 = (Bind){.nameStart = start, .nameLen = ({ uint64_t __ov; if (__builtin_sub_overflow((n), (start), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; }), .fieldStart = ref, .fieldLen = 0};
    return __ret969; }
}
long long sameMangle_c_Comp_refA_U64_refB_U64(Comp* c, uint64_t refA, uint64_t refB) {
...
long long isCompoundType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret977 = ((long long)((Array_TypeRef_get((*c).types, (long long)(r)).args).count) > 0);
    return __ret977; }
}
void emitConcreteCType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    uint64_t r = resolveTy_c_Comp_tyRef_U64(&((*c)), ref);
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    { uint64_t __ret979 = (*c).curSelfRef;
    TypeRef_release(t);
    return __ret979; }
    }
    }
    ...
    { uint64_t __ret980 = (*c).curItemRef;
    TypeRef_release(t);
    return __ret980; }
    }
    }
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret981 = Array_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret981; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
uint64_t groundTypeRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    if (ref >= (long long)(((*c).types).count)) {
    { uint64_t __ret994 = ref;
    return __ret994; }
    }
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).count) == 0) {
    { uint64_t __ret995 = resolveTy_c_Comp_tyRef_U64(&((*c)), ref);
    TypeRef_release(t);
    return __ret995; }
    }
    ...
    { uint64_t __ret996 = idx;
    Array_U64_release(newArgs);
    TypeRef_release(t);
    return __ret996; }
    }
    { uint64_t __ret997 = ref;
    Array_U64_release(newArgs);
    TypeRef_release(t);
    return __ret997; }
    Array_U64_release(newArgs);
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m1005 = Array_Stmt_get((*c).stmts, (long long)(sti));
    if (_m1005.tag == 0) {
        uint64_t ty = _m1005.data.Let.ty;
        (void)ty;
    ...
    {
    Expr _m1006 = Array_Expr_get((*c).exprs, (long long)(xi));
    if (_m1006.tag == 11) {
        uint64_t operand = _m1006.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m1006.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m1006.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m1006.data.Cast.ty;
        (void)ty;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else if (_m1006.tag == 6) {
        uint64_t typeStart = _m1006.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m1006.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m1006.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m1006.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m1006.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m1006.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m1006.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    TypeRef t = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).count) == 0) {
    { TypeInfo __ret1007 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret1007; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), t.nameStart, t.nameLen, (PlewString){"Array", 5})) {
    TypeRef el = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(Array_U64_get(t.args, (long long)(0)))));
    { TypeInfo __ret1008 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret1008; }
    TypeRef_release(el);
    }
    { TypeInfo __ret1009 = (TypeInfo){.kind = 2, .nameStart = t.nameStart, .nameLen = t.nameLen, .ref = ref};
    TypeRef_release(t);
    return __ret1009; }
    TypeRef_release(t);
}
TypeInfo iterableItemInfo_c_Comp_et_TypeInfo(Comp* c, TypeInfo et) {
    ...
    TypeRef ot = TypeRef_share(Array_TypeRef_get((*c).types, (long long)(optRef)));
    if ((long long)((ot.args).count) > 0) {
    { TypeInfo __ret1011 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(ot.args, (long long)(0)));
    TypeRef_release(ot);
    Func_release(nmf);
    Array_Arg_release(noArgs);
    return __ret1011; }
...
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, Array_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret1013 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret1013; }
    }
    ...
    { TypeInfo __ret1014 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret1014; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret1016 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
    ...
    { TypeInfo __ret1017 = (TypeInfo){.kind = 3, .nameStart = mn.nameStart, .nameLen = mn.nameLen, .ref = 0};
    TypeRef_release(elr);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    StructDef_release(s);
    ...
    { TypeInfo __ret1018 = (TypeInfo){.kind = 3, .nameStart = at.nameStart, .nameLen = at.nameLen, .ref = 0};
    TypeRef_release(at);
    TypeRef_release(elr);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    ...
    { TypeInfo __ret1019 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    Array_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret1022 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), Array_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    Array_FieldDef_release(fs);
    Variant_release(v);
    Array_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret1028 = ((long long)((f.typeParams).count) == (long long)((inst.args).count));
    TypeRef_release(inst);
    return __ret1028; }
    TypeRef_release(inst);
}
...
uint64_t arrayInstRef_c_Comp_ae_Bind(Comp* c, Bind ae) {
    ...
    { uint64_t __ret1029 = (long long)(((*c).types).count);
    return __ret1029; }
    }
...
long long providedRetReachable_c_Comp_mf_Func_recvInstRef_U64(Comp* c, Func mf, uint64_t recvInstRef) {
    ...
    (*c).curTypeParams = Array_Bind_share(savedP);
    (*c).curTypeArgs = Array_U64_share(savedA);
    { long long __ret1035 = isRegisteredGenInst_c_Comp_ref_U64(&((*c)), gret);
    Array_U64_release(savedA);
    Array_Bind_release(savedP);
    return __ret1035; }
    Array_U64_release(savedA);
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret1038 = ((long long)((f.typeParams).count) > 0);
    Func_release(f);
    return __ret1038; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    Array_U64 noArgs = Array_U64_new();
    { uint64_t __ret1040 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = Array_U64_share(noArgs)});
    Array_U64_release(noArgs);
    return __ret1040; }
    Array_U64_release(noArgs);
}
...
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret1051 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret1051; }
}
uint64_t argArrayElemRef_c_Comp_argExpr_U64(Comp* c, uint64_t argExpr) {
    {
    Expr _m1052 = Array_Expr_get((*c).exprs, (long long)(argExpr));
    if (_m1052.tag == 1) {
        uint64_t start = _m1052.data.Ident.start;
        (void)start;
        uint64_t len = _m1052.data.Ident.len;
        (void)len;
    uint64_t li = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
    if (li < (long long)(((*c).locals).count)) {
    ...
    { uint64_t __ret1053 = Array_U64_get(lt.args, (long long)(0));
    TypeRef_release(lt);
    return __ret1053; }
    }
    }
...
Array_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, Array_Arg args) {
    ...
    { Array_U64 __ret1055 = Array_U64_share(out);
...
uint64_t recvParamCount_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    if (gsi < (long long)(((*c).structs).count)) {
    { uint64_t __ret1062 = (long long)((Array_StructDef_get((*c).structs, (long long)(gsi)).typeParams).count);
    return __ret1062; }
    }
    uint64_t gei = genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), nameStart, nameLen);
    if (gei < (long long)(((*c).enums).count)) {
    { uint64_t __ret1063 = (long long)((Array_EnumDef_get((*c).enums, (long long)(gei)).typeParams).count);
    return __ret1063; }
    }
    { uint64_t __ret1064 = 0;
    return __ret1064; }
}
void writeMethodInstSuffixFrom_c_Comp_typeArgs_AU64_startIdx_U64(Comp* c, Array_U64 typeArgs, uint64_t startIdx) {
    uint64_t i = startIdx;
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m1073 = Array_Expr_get((*c).exprs, (long long)(exprId));
    if (_m1073.tag == 1) {
        uint64_t start = _m1073.data.Ident.start;
        (void)start;
        uint64_t len = _m1073.data.Ident.len;
        (void)len;
    if ((*c).curInClosure) {
    uint64_t li = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
    ...
    else if (_m1073.tag == 17) {
        Array_Param params = _m1073.data.Closure.params;
        (void)params;
        long long hasRet = _m1073.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m1073.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m1073.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m1073.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m1073.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m1073.data.Closure.body;
        (void)body;
    if ((*c).curInClosure) {
    ...
    (*c).curCaptureMark = savedMark;
        ...
        int64_t op = _m1073.data.Unary.op;
        (void)op;
        uint64_t operand = _m1073.data.Unary.operand;
        (void)operand;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m1073.tag == 3) {
        int64_t op = _m1073.data.Binary.op;
        (void)op;
        uint64_t lhs = _m1073.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m1073.data.Binary.rhs;
        (void)rhs;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), lhs);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
    }
    else if (_m1073.tag == 4) {
        uint64_t nameStart = _m1073.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1073.data.Call.nameLen;
        (void)nameLen;
        Array_Arg args = _m1073.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).count)) {
    ...
    registerCallInst_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, Array_Arg_share(args));
        ...
        uint64_t recv = _m1073.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m1073.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1073.data.Method.nameLen;
        (void)nameLen;
        Array_Arg args = _m1073.data.Method.args;
        (void)args;
    ...
    scanType_c_Comp_ref_U64(&((*c)), mrt.ref);
        ...
        uint64_t base = _m1073.data.Field.base;
        (void)base;
        uint64_t nameStart = _m1073.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1073.data.Field.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m1073.tag == 9) {
        uint64_t base = _m1073.data.Index.base;
        (void)base;
        uint64_t index = _m1073.data.Index.index;
        (void)index;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), index);
    }
    else if (_m1073.tag == 6) {
        uint64_t typeStart = _m1073.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m1073.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m1073.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m1073.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m1073.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m1073.data.Make.ty;
        (void)ty;
        Array_MakeField fields = _m1073.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).count)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        Array_U64 elems = _m1073.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).count)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t operand = _m1073.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m1073.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m1073.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m1073.data.Cast.ty;
        (void)ty;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m1073.tag == 14) {
        uint64_t opt = _m1073.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m1073.data.Coalesce.deflt;
        (void)deflt;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), opt);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m1073.tag == 15) {
        uint64_t expr = _m1073.data.Try.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m1073.tag == 16) {
        uint64_t base = _m1073.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m1073.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1073.data.Arrow.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m1073.tag == 13) {
        uint64_t cond = _m1073.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m1073.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m1073.data.IfExpr.elseBlk;
        (void)elseBlk;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
    }
    else if (_m1073.tag == 12) {
        uint64_t scrut = _m1073.data.MatchExpr.scrut;
        (void)scrut;
        Array_MatchArm arms = _m1073.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m1073.tag == 18) {
        uint64_t operand = _m1073.data.Move.operand;
        (void)operand;
        long long isBorrow = _m1073.data.Move.isBorrow;
        (void)isBorrow;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m1074 = Array_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m1074.tag == 0) {
        long long mutable = _m1074.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m1074.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1074.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m1074.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m1074.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m1074.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m1074.data.Let.ty;
        (void)ty;
        uint64_t init = _m1074.data.Let.init;
        (void)init;
    ...
    else if (_m1074.tag == 1) {
        int64_t op = _m1074.data.Assign.op;
        (void)op;
        uint64_t target = _m1074.data.Assign.target;
        (void)target;
        uint64_t value = _m1074.data.Assign.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), target);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m1074.tag == 2) {
        uint64_t expr = _m1074.data.ExprStmt.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m1074.tag == 3) {
        uint64_t value = _m1074.data.Return.value;
        (void)value;
        long long hasValue = _m1074.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m1074.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m1074.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m1074.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m1074.data.If.hasElse;
        (void)hasElse;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m1074.data.While.cond;
        (void)cond;
        uint64_t body = _m1074.data.While.body;
        (void)body;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m1074.tag == 6) {
        uint64_t varStart = _m1074.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m1074.data.For.varLen;
        (void)varLen;
        long long isRange = _m1074.data.For.isRange;
        (void)isRange;
        long long inclusive = _m1074.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m1074.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m1074.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m1074.data.For.body;
        (void)body;
        long long isStruct = _m1074.data.For.isStruct;
        (void)isStruct;
        uint64_t patStart = _m1074.data.For.patStart;
        (void)patStart;
        uint64_t patLen = _m1074.data.For.patLen;
        (void)patLen;
        Array_Bind binds = _m1074.data.For.binds;
        (void)binds;
    uint64_t forMark = scopeMark_c_Comp(&((*c)));
    ...
    else if (_m1074.tag == 7) {
        uint64_t scrut = _m1074.data.Match.scrut;
        (void)scrut;
        Array_MatchArm arms = _m1074.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).count)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m1074.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m1074.data.Panic.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m1074.tag == 9) {
        uint64_t value = _m1074.data.Give.value;
        (void)value;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
    }
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret1097 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String(Array_U8_share((*c).bytes), elemStart, elemLen, (PlewString){"U8", 2});
    return __ret1097; }
}
long long elemIsRef_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    ...
    { long long __ret1099 = isRefInst_c_Comp_ref_U64(&((*c)), er);
    return __ret1099; }
}
long long skipArrayElem_c_Comp_ae_Bind(Comp* c, Bind ae) {
...
void rejectAsyncUnsupported_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    else if (_m1105.tag == 1) {
    }
    else if (_m1105.tag == 2) {
    }
    else if (_m1105.tag == 3) {
    }
    else if (_m1105.tag == 10) {
    }
    else if (_m1105.tag == 11) {
    }
    else if (_m1105.tag == 8) {
    }
...
void collectAsyncFields_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    if (_m1106.tag == 0) {
        long long mutable = _m1106.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m1106.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m1106.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m1106.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m1106.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m1106.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m1106.data.Let.ty;
        (void)ty;
        uint64_t init = _m1106.data.Let.init;
        (void)init;
    ...
    collectAsyncFields_c_Comp_blockId_U64(&((*c)), body);
        ...
        uint64_t scrut = _m1106.data.Match.scrut;
        (void)scrut;
...
uint64_t nextAsyncVar_c_Comp(Comp* c) {
    ...
    { uint64_t __ret1107 = (*c).asyncVarSeq;
    return __ret1107; }
}
void genAsyncLet_c_Comp_nameStart_U64_nameLen_U64_effStart_U64_effLen_U64_effArr_Bool_effTy_U64_init_U64_mutable_Bool(Comp* c, uint64_t nameStart, uint64_t nameLen, uint64_t effStart, uint64_t effLen, long long effArr, uint64_t effTy, uint64_t init, long long mutable) {
    uint64_t cnum = nextAsyncVar_c_Comp(&((*c)));
    {
    Expr _m1108 = Array_Expr_get((*c).exprs, (long long)(init));
    if (_m1108.tag == 19) {
...
void genAsyncReturn_c_Comp_value_U64_hasValue_Bool(Comp* c, uint64_t value, long long hasValue) {
    if (hasValue) {
    {
    Expr _m1109 = Array_Expr_get((*c).exprs, (long long)(value));
    if (_m1109.tag == 19) {
...
uint64_t countAsyncAwaits_c_Comp_blockId_U64(Comp* c, uint64_t blockId) {
    ...
    else if (_m1110.tag == 3) {
        uint64_t value = _m1110.data.Return.value;
        (void)value;
        long long hasValue = _m1110.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    ...
    else if (_m1110.tag == 2) {
        uint64_t expr = _m1110.data.ExprStmt.expr;
        (void)expr;
...
long long exprIsAwait_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m1112 = Array_Expr_get((*c).exprs, (long long)(id));
    if (_m1112.tag == 19) {
    { long long __ret1113 = 1;
    return __ret1113; }
    }
    else {
    { long long __ret1114 = 0;
    return __ret1114; }
    }
    }
}
...
Array_Bind collectParts_rootBytes_AU8_toks_ATok(Array_U8 rootBytes, Array_Tok toks) {
    ...
    long long starts = 0;
    {
    Kind _m1121 = first.kind;
    if (_m1121.tag == 40) {
    starts = 1;
    }
    else if (_m1121.tag == 51) {
    starts = 1;
    }
    else {
    ...
    { Array_Bind __ret1122 = Array_Bind_share(parts);
...
Array_U8 findSrcRoot_entry_AU8(Array_U8 entry) {
    ...
    { Array_U8 __ret1134 = Array_U8_share(sr);
    Array_U8_release(sx);
    Array_U8_release(sr);
    Array_U8_release(mn);
    ...
    { Array_U8 __ret1135 = Array_U8_share(empty);
...
long long String_isEmpty(PlewString self) {
    { long long __ret1138 = ((long long)((({ PlewString __s = self; Array_U8 __b; __b.data = (unsigned char*)plew_rawbuf_alloc(sizeof(unsigned char), __s.len); for (long long __i = 0; __i < __s.len; __i++) __b.data[__i] = (unsigned char)__s.data[__i]; __b.count = __s.len; __b; })).count) == 0);
    return __ret1138; }
}
unsigned char digitByteI_d_I64(int64_t d) {
    if (d == 0) {
    { unsigned char __ret1139 = 48;
    return __ret1139; }
    }
    if (d == 1) {
    { unsigned char __ret1140 = 49;
    return __ret1140; }
    }
    if (d == 2) {
    { unsigned char __ret1141 = 50;
    return __ret1141; }
    }
    if (d == 3) {
    { unsigned char __ret1142 = 51;
    return __ret1142; }
    }
    if (d == 4) {
    { unsigned char __ret1143 = 52;
    return __ret1143; }
    }
    if (d == 5) {
    { unsigned char __ret1144 = 53;
    return __ret1144; }
    }
    if (d == 6) {
    { unsigned char __ret1145 = 54;
    return __ret1145; }
    }
    if (d == 7) {
    { unsigned char __ret1146 = 55;
    return __ret1146; }
    }
    if (d == 8) {
    { unsigned char __ret1147 = 56;
    return __ret1147; }
    }
    { unsigned char __ret1148 = 57;
    return __ret1148; }
}
unsigned char digitByteU_d_U64(uint64_t d) {
    if (d == 0) {
...
PlewString Bool_format_format_String(long long self, PlewString format) {
    if (self) {
    { PlewString __ret1167 = (PlewString){"1", 1};
    return __ret1167; }
    }
    else {
    { PlewString __ret1168 = (PlewString){"0", 1};
    return __ret1168; }
    }
}
void Array_U8_append_value_T(Array_U8* self, unsigned char value) {
...
unsigned char Array_U8_get_i_U64(Array_U8 self, uint64_t i) {
    { unsigned char __ret1169 = Array_U8_get((self), (long long)(i));
    return __ret1169; }
}
void Array_U8_set_i_U64_value_T(Array_U8* self, uint64_t i, unsigned char value) {
...
Bind Array_Bind_get_i_U64(Array_Bind self, uint64_t i) {
    { Bind __ret1170 = Array_Bind_get((self), (long long)(i));
    return __ret1170; }
}
void Array_Bind_set_i_U64_value_T(Array_Bind* self, uint64_t i, Bind value) {
...
Tok Array_Tok_get_i_U64(Array_Tok self, uint64_t i) {
    { Tok __ret1171 = Array_Tok_get((self), (long long)(i));
    return __ret1171; }
}
void Array_Tok_set_i_U64_value_T(Array_Tok* self, uint64_t i, Tok value) {
...
uint64_t Array_U64_get_i_U64(Array_U64 self, uint64_t i) {
    { uint64_t __ret1172 = Array_U64_get((self), (long long)(i));
    return __ret1172; }
}
void Array_U64_set_i_U64_value_T(Array_U64* self, uint64_t i, uint64_t value) {
...
Arg Array_Arg_get_i_U64(Array_Arg self, uint64_t i) {
    { Arg __ret1173 = Array_Arg_get((self), (long long)(i));
    return __ret1173; }
}
void Array_Arg_set_i_U64_value_T(Array_Arg* self, uint64_t i, Arg value) {
...
MakeField Array_MakeField_get_i_U64(Array_MakeField self, uint64_t i) {
    { MakeField __ret1174 = Array_MakeField_get((self), (long long)(i));
    return __ret1174; }
}
void Array_MakeField_set_i_U64_value_T(Array_MakeField* self, uint64_t i, MakeField value) {
...
MatchArm Array_MatchArm_get_i_U64(Array_MatchArm self, uint64_t i) {
    { MatchArm __ret1175 = Array_MatchArm_get((self), (long long)(i));
    return __ret1175; }
}
void Array_MatchArm_set_i_U64_value_T(Array_MatchArm* self, uint64_t i, MatchArm value) {
...
Param Array_Param_get_i_U64(Array_Param self, uint64_t i) {
    { Param __ret1176 = Array_Param_get((self), (long long)(i));
    return __ret1176; }
}
void Array_Param_set_i_U64_value_T(Array_Param* self, uint64_t i, Param value) {
...
FieldDef Array_FieldDef_get_i_U64(Array_FieldDef self, uint64_t i) {
    { FieldDef __ret1177 = Array_FieldDef_get((self), (long long)(i));
    return __ret1177; }
}
void Array_FieldDef_set_i_U64_value_T(Array_FieldDef* self, uint64_t i, FieldDef value) {
...
Func Array_Func_get_i_U64(Array_Func self, uint64_t i) {
    { Func __ret1178 = Array_Func_get((self), (long long)(i));
    return __ret1178; }
}
void Array_Func_set_i_U64_value_T(Array_Func* self, uint64_t i, Func value) {
...
Variant Array_Variant_get_i_U64(Array_Variant self, uint64_t i) {
    { Variant __ret1179 = Array_Variant_get((self), (long long)(i));
    return __ret1179; }
}
void Array_Variant_set_i_U64_value_T(Array_Variant* self, uint64_t i, Variant value) {
...
Expr Array_Expr_get_i_U64(Array_Expr self, uint64_t i) {
    { Expr __ret1180 = Array_Expr_get((self), (long long)(i));
    return __ret1180; }
}
void Array_Expr_set_i_U64_value_T(Array_Expr* self, uint64_t i, Expr value) {
...
Stmt Array_Stmt_get_i_U64(Array_Stmt self, uint64_t i) {
    { Stmt __ret1181 = Array_Stmt_get((self), (long long)(i));
    return __ret1181; }
}
void Array_Stmt_set_i_U64_value_T(Array_Stmt* self, uint64_t i, Stmt value) {
...
Block Array_Block_get_i_U64(Array_Block self, uint64_t i) {
    { Block __ret1182 = Array_Block_get((self), (long long)(i));
    return __ret1182; }
}
void Array_Block_set_i_U64_value_T(Array_Block* self, uint64_t i, Block value) {
...
StructDef Array_StructDef_get_i_U64(Array_StructDef self, uint64_t i) {
    { StructDef __ret1183 = Array_StructDef_get((self), (long long)(i));
    return __ret1183; }
}
void Array_StructDef_set_i_U64_value_T(Array_StructDef* self, uint64_t i, StructDef value) {
...
EnumDef Array_EnumDef_get_i_U64(Array_EnumDef self, uint64_t i) {
    { EnumDef __ret1184 = Array_EnumDef_get((self), (long long)(i));
    return __ret1184; }
}
void Array_EnumDef_set_i_U64_value_T(Array_EnumDef* self, uint64_t i, EnumDef value) {
...
TraitDef Array_TraitDef_get_i_U64(Array_TraitDef self, uint64_t i) {
    { TraitDef __ret1185 = Array_TraitDef_get((self), (long long)(i));
    return __ret1185; }
}
void Array_TraitDef_set_i_U64_value_T(Array_TraitDef* self, uint64_t i, TraitDef value) {
...
Conform Array_Conform_get_i_U64(Array_Conform self, uint64_t i) {
    { Conform __ret1186 = Array_Conform_get((self), (long long)(i));
    return __ret1186; }
}
void Array_Conform_set_i_U64_value_T(Array_Conform* self, uint64_t i, Conform value) {
...
MethodAlias Array_MethodAlias_get_i_U64(Array_MethodAlias self, uint64_t i) {
    { MethodAlias __ret1187 = Array_MethodAlias_get((self), (long long)(i));
    return __ret1187; }
}
void Array_MethodAlias_set_i_U64_value_T(Array_MethodAlias* self, uint64_t i, MethodAlias value) {
...
DeriveReq Array_DeriveReq_get_i_U64(Array_DeriveReq self, uint64_t i) {
    { DeriveReq __ret1188 = Array_DeriveReq_get((self), (long long)(i));
    return __ret1188; }
}
void Array_DeriveReq_set_i_U64_value_T(Array_DeriveReq* self, uint64_t i, DeriveReq value) {
...
FuncBound Array_FuncBound_get_i_U64(Array_FuncBound self, uint64_t i) {
    { FuncBound __ret1189 = Array_FuncBound_get((self), (long long)(i));
    return __ret1189; }
}
void Array_FuncBound_set_i_U64_value_T(Array_FuncBound* self, uint64_t i, FuncBound value) {
...
TypeRef Array_TypeRef_get_i_U64(Array_TypeRef self, uint64_t i) {
    { TypeRef __ret1190 = Array_TypeRef_get((self), (long long)(i));
    return __ret1190; }
}
void Array_TypeRef_set_i_U64_value_T(Array_TypeRef* self, uint64_t i, TypeRef value) {
...
FnInst Array_FnInst_get_i_U64(Array_FnInst self, uint64_t i) {
    { FnInst __ret1191 = Array_FnInst_get((self), (long long)(i));
    return __ret1191; }
}
void Array_FnInst_set_i_U64_value_T(Array_FnInst* self, uint64_t i, FnInst value) {
...
CaptureEntry Array_CaptureEntry_get_i_U64(Array_CaptureEntry self, uint64_t i) {
    { CaptureEntry __ret1192 = Array_CaptureEntry_get((self), (long long)(i));
    return __ret1192; }
}
void Array_CaptureEntry_set_i_U64_value_T(Array_CaptureEntry* self, uint64_t i, CaptureEntry value) {
...
Local Array_Local_get_i_U64(Array_Local self, uint64_t i) {
    { Local __ret1193 = Array_Local_get((self), (long long)(i));
    return __ret1193; }
}
void Array_Local_set_i_U64_value_T(Array_Local* self, uint64_t i, Local value) {
...
AssocBinding Array_AssocBinding_get_i_U64(Array_AssocBinding self, uint64_t i) {
    { AssocBinding __ret1194 = Array_AssocBinding_get((self), (long long)(i));
    return __ret1194; }
}
void Array_AssocBinding_set_i_U64_value_T(Array_AssocBinding* self, uint64_t i, AssocBinding value) {
...
PatInfo Array_PatInfo_get_i_U64(Array_PatInfo self, uint64_t i) {
    { PatInfo __ret1195 = Array_PatInfo_get((self), (long long)(i));
    return __ret1195; }
}
void Array_PatInfo_set_i_U64_value_T(Array_PatInfo* self, uint64_t i, PatInfo value) {
