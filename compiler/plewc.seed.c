...
Bind internBytes_c_Comp_s_String(Comp* c, PlewString s) {
    ...
    { Bind __ret255 = (Bind){.nameStart = start, .nameLen = (long long)((sb).len), .fieldStart = start, .fieldLen = (long long)((sb).len)};
    PlewArray_U8_release(sb);
    return __ret255; }
    PlewArray_U8_release(sb);
}
...
unsigned char digitByte_d_U64(uint64_t d) {
    if (d == 0) {
    { unsigned char __ret257 = 48;
    return __ret257; }
    }
    if (d == 1) {
    { unsigned char __ret258 = 49;
    return __ret258; }
    }
    if (d == 2) {
    { unsigned char __ret259 = 50;
    return __ret259; }
    }
    if (d == 3) {
    { unsigned char __ret260 = 51;
    return __ret260; }
    }
    if (d == 4) {
    { unsigned char __ret261 = 52;
    return __ret261; }
    }
    if (d == 5) {
    { unsigned char __ret262 = 53;
    return __ret262; }
    }
    if (d == 6) {
    { unsigned char __ret263 = 54;
    return __ret263; }
    }
    if (d == 7) {
    { unsigned char __ret264 = 55;
    return __ret264; }
    }
    if (d == 8) {
    { unsigned char __ret265 = 56;
    return __ret265; }
    }
    { unsigned char __ret266 = 57;
    return __ret266; }
}
void appendU64Digits_c_Comp_n_U64(Comp* c, uint64_t n) {
    if (n >= 10) {
...
Bind internName_c_Comp_prefix_U8_n_U64(Comp* c, unsigned char prefix, uint64_t n) {
    ...
    { Bind __ret267 = (Bind){.nameStart = start, .nameLen = len, .fieldStart = start, .fieldLen = len};
    return __ret267; }
}
uint64_t enumIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
    ...
    { uint64_t __ret269 = (long long)(((*c).enums).len);
    return __ret269; }
}
uint64_t synthBool_c_Comp_v_I64(Comp* c, int64_t v) {
    { uint64_t __ret270 = Comp_pushExpr_e_Expr(&((*c)), (Expr){.tag = 0, .data.Int = {.value = v, .offset = 0, .isBool = 1, .tyStart = 0, .tyLen = 0}});
    return __ret270; }
}
void synthEnumEq_c_Comp_d_DeriveReq_eqN_Bind_lhsN_Bind_rhsN_Bind_boolN_Bind_eqTrait_Bind(Comp* c, DeriveReq d, Bind eqN, Bind lhsN, Bind rhsN, Bind boolN, Bind eqTrait) {
...
uint64_t synthOrdering_c_Comp_ordN_Bind_variantN_Bind(Comp* c, Bind ordN, Bind variantN) {
    ...
    { uint64_t __ret271 = Comp_pushExpr_e_Expr(&((*c)), (Expr){.tag = 6, .data.Make = {.typeStart = ordN.nameStart, .typeLen = ordN.nameLen, .variantStart = variantN.nameStart, .variantLen = variantN.nameLen, .isEnum = 1, .ty = 0, .fields = PlewArray_MakeField_share(noFields)}});
...
PlewString digitStr_d_I64(int64_t d) {
    if (d == 0) {
    { PlewString __ret278 = (PlewString){"0", 1};
    return __ret278; }
    }
    if (d == 1) {
    { PlewString __ret279 = (PlewString){"1", 1};
    return __ret279; }
    }
    if (d == 2) {
    { PlewString __ret280 = (PlewString){"2", 1};
    return __ret280; }
    }
    if (d == 3) {
    { PlewString __ret281 = (PlewString){"3", 1};
    return __ret281; }
    }
    if (d == 4) {
    { PlewString __ret282 = (PlewString){"4", 1};
    return __ret282; }
    }
    if (d == 5) {
    { PlewString __ret283 = (PlewString){"5", 1};
    return __ret283; }
    }
    if (d == 6) {
    { PlewString __ret284 = (PlewString){"6", 1};
    return __ret284; }
    }
    if (d == 7) {
    { PlewString __ret285 = (PlewString){"7", 1};
    return __ret285; }
    }
    if (d == 8) {
    { PlewString __ret286 = (PlewString){"8", 1};
    return __ret286; }
    }
    { PlewString __ret287 = (PlewString){"9", 1};
    return __ret287; }
}
void writeInt_n_I64(int64_t n) {
    if (n < 0) {
...
uint64_t intBits_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"I16", 3})) {
    { uint64_t __ret319 = 16;
    return __ret319; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"U16", 3})) {
    { uint64_t __ret320 = 16;
    return __ret320; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"I32", 3})) {
    { uint64_t __ret321 = 32;
    return __ret321; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"U32", 3})) {
    { uint64_t __ret322 = 32;
    return __ret322; }
    }
    { uint64_t __ret323 = 64;
    return __ret323; }
}
long long intSigned_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    { long long __ret324 = (PlewArray_U8_get((*c).bytes, (long long)(start)) == 73);
    return __ret324; }
}
long long losslessInt_c_Comp_srcStart_U64_srcLen_U64_dstStart_U64_dstLen_U64(Comp* c, uint64_t srcStart, uint64_t srcLen, uint64_t dstStart, uint64_t dstLen) {
    ...
    if (sSigned) {
    if (dSigned) {
    { long long __ret325 = (dBits >= sBits);
    return __ret325; }
    }
    ...
    if (dSigned) {
    { long long __ret327 = (dBits > sBits);
    return __ret327; }
    }
...
long long litFitsType_c_Comp_value_I64_dstStart_U64_dstLen_U64(Comp* c, int64_t value, uint64_t dstStart, uint64_t dstLen) {
    ...
    { long long __ret329 = litFitsBits_value_I64_bits_U64_sgn_Bool(value, bits, sgn);
    return __ret329; }
}
long long litFitsBits_value_I64_bits_U64_sgn_Bool(int64_t value, uint64_t bits, long long sgn) {
    if (sgn) {
...
uint64_t exprOffset_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m352 = e;
    if (_m352.tag == 0) {
        uint64_t offset = _m352.data.Int.offset;
        (void)offset;
    { uint64_t __ret353 = offset;
    return __ret353; }
    }
    else if (_m352.tag == 1) {
        uint64_t start = _m352.data.Ident.start;
        (void)start;
        uint64_t len = _m352.data.Ident.len;
        (void)len;
    { uint64_t __ret354 = start;
    return __ret354; }
    }
    else if (_m352.tag == 7) {
        uint64_t start = _m352.data.Str.start;
        (void)start;
        uint64_t len = _m352.data.Str.len;
        (void)len;
    { uint64_t __ret355 = start;
    return __ret355; }
    }
    else if (_m352.tag == 4) {
        uint64_t nameStart = _m352.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m352.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m352.data.Call.args;
        (void)args;
    { uint64_t __ret356 = nameStart;
    return __ret356; }
    }
    else if (_m352.tag == 10) {
        uint64_t recv = _m352.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m352.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m352.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m352.data.Method.args;
        (void)args;
    { uint64_t __ret357 = nameStart;
    return __ret357; }
    }
    else if (_m352.tag == 5) {
        uint64_t base = _m352.data.Field.base;
        (void)base;
        uint64_t nameStart = _m352.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m352.data.Field.nameLen;
        (void)nameLen;
    { uint64_t __ret358 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret358; }
    }
    else if (_m352.tag == 9) {
        uint64_t base = _m352.data.Index.base;
        (void)base;
        uint64_t index = _m352.data.Index.index;
        (void)index;
    { uint64_t __ret359 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret359; }
    }
    else if (_m352.tag == 3) {
        int64_t op = _m352.data.Binary.op;
        (void)op;
        uint64_t lhs = _m352.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m352.data.Binary.rhs;
        (void)rhs;
    { uint64_t __ret360 = exprOffset_c_Comp_id_U64(&((*c)), lhs);
    return __ret360; }
    }
    else if (_m352.tag == 2) {
        int64_t op = _m352.data.Unary.op;
        (void)op;
        uint64_t operand = _m352.data.Unary.operand;
        (void)operand;
    { uint64_t __ret361 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret361; }
    }
    else if (_m352.tag == 11) {
        uint64_t operand = _m352.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m352.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m352.data.Cast.tyLen;
        (void)tyLen;
    { uint64_t __ret362 = exprOffset_c_Comp_id_U64(&((*c)), operand);
    return __ret362; }
    }
    else if (_m352.tag == 6) {
        uint64_t typeStart = _m352.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m352.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m352.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m352.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m352.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m352.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m352.data.Make.fields;
        (void)fields;
    { uint64_t __ret363 = typeStart;
    return __ret363; }
    }
    else if (_m352.tag == 12) {
        uint64_t scrut = _m352.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m352.data.MatchExpr.arms;
        (void)arms;
    { uint64_t __ret364 = exprOffset_c_Comp_id_U64(&((*c)), scrut);
    return __ret364; }
    }
    else if (_m352.tag == 13) {
        uint64_t cond = _m352.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m352.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m352.data.IfExpr.elseBlk;
        (void)elseBlk;
    { uint64_t __ret365 = exprOffset_c_Comp_id_U64(&((*c)), cond);
    return __ret365; }
    }
    else if (_m352.tag == 14) {
        uint64_t opt = _m352.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m352.data.Coalesce.deflt;
        (void)deflt;
    { uint64_t __ret366 = exprOffset_c_Comp_id_U64(&((*c)), opt);
    return __ret366; }
    }
    else if (_m352.tag == 15) {
        uint64_t expr = _m352.data.Try.expr;
        (void)expr;
    { uint64_t __ret367 = exprOffset_c_Comp_id_U64(&((*c)), expr);
    return __ret367; }
    }
    else if (_m352.tag == 16) {
        uint64_t base = _m352.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m352.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m352.data.Arrow.nameLen;
        (void)nameLen;
    { uint64_t __ret368 = exprOffset_c_Comp_id_U64(&((*c)), base);
    return __ret368; }
    }
    else if (_m352.tag == 17) {
        PlewArray_Param params = _m352.data.Closure.params;
        (void)params;
        long long hasRet = _m352.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m352.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m352.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m352.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m352.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m352.data.Closure.body;
        (void)body;
    { uint64_t __ret369 = retStart;
    return __ret369; }
    }
    else {
    { uint64_t __ret370 = 0;
...
uint64_t findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret371 = typeMatch;
    return __ret371; }
    }
    { uint64_t __ret372 = firstLabel;
    return __ret372; }
}
uint64_t firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret374 = (long long)(((*c).funcs).len);
    return __ret374; }
}
long long funcNameExists_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    { long long __ret375 = (firstFuncByName_c_Comp_nameStart_U64_nameLen_U64(&((*c)), nameStart, nameLen) != (long long)(((*c).funcs).len));
    return __ret375; }
}
uint64_t findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
    ...
    if (typeMatch != (long long)(((*c).funcs).len)) {
    { uint64_t __ret376 = typeMatch;
    return __ret376; }
    }
    if (firstLabel != (long long)(((*c).funcs).len)) {
    { uint64_t __ret377 = firstLabel;
    return __ret377; }
    }
    uint64_t ai = 0;
    ...
    { uint64_t __ret378 = findMethod_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recvStart, recvLen, al.realStart, al.realLen, args);
    return __ret378; }
    }
    }
    ai = ({ uint64_t __ov; if (__builtin_add_overflow((ai), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    { uint64_t __ret379 = (long long)(((*c).funcs).len);
    return __ret379; }
}
uint64_t findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t recvStart, uint64_t recvLen, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    uint64_t firstLabel = (long long)(((*c).funcs).len);
...
long long isTypeName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret384 = (genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), start, len) < (long long)(((*c).structs).len));
    return __ret384; }
}
Bind assocRecvName_c_Comp_recv_U64(Comp* c, uint64_t recv) {
    {
    Expr _m385 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m385.tag == 1) {
    ...
    { Bind __ret386 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret386; }
    }
    if (localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len) < (long long)(((*c).locals).len)) {
    { Bind __ret387 = (Bind){.nameStart = 0, .nameLen = 0, .fieldStart = 0, .fieldLen = 0};
    return __ret387; }
    }
    if (isTypeName_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { Bind __ret388 = (Bind){.nameStart = start, .nameLen = len, .fieldStart = start, .fieldLen = len};
    return __ret388; }
    }
...
long long argMatchesParam_c_Comp_argExpr_U64_p_Param(Comp* c, uint64_t argExpr, Param p) {
    ...
    if (p.tyIsArray) {
    if (ti.kind == 3) {
    { long long __ret397 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret397; }
    }
    ...
    if (ti.kind == 1) {
    { long long __ret399 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, p.tyStart, p.tyLen, (PlewString){"String", 6});
    return __ret399; }
    }
    if (ti.kind == 2) {
    ...
    if (ti.nameLen != 0) {
    { long long __ret401 = spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ti.nameStart, ti.nameLen, p.tyStart, p.tyLen);
    return __ret401; }
    }
    { long long __ret402 = isIntType_c_Comp_start_U64_len_U64(&((*c)), p.tyStart, p.tyLen);
    return __ret402; }
}
long long paramsTypesMatch_c_Comp_params_AParam_args_AArg(Comp* c, PlewArray_Param params, PlewArray_Arg args) {
    uint64_t i = 0;
...
long long callLabelsOk_c_Comp_nameStart_U64_nameLen_U64_args_AArg(Comp* c, uint64_t nameStart, uint64_t nameLen, PlewArray_Arg args) {
    ...
    { long long __ret405 = (findFunc_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, args) != (long long)(((*c).funcs).len));
    return __ret405; }
    }
...
TypeInfo scalarInfo(void) {
    { TypeInfo __ret417 = (TypeInfo){.kind = 0, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret417; }
}
TypeInfo typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(Comp* c, uint64_t start, uint64_t len, long long isArray) {
    if (isArray) {
    { TypeInfo __ret418 = (TypeInfo){.kind = 3, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret418; }
    }
    if (len == 0) {
    { TypeInfo __ret419 = scalarInfo();
    return __ret419; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"String", 6})) {
    { TypeInfo __ret420 = (TypeInfo){.kind = 1, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret420; }
    }
    if (isPrimType_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { TypeInfo __ret421 = (TypeInfo){.kind = 0, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret421; }
    }
    { TypeInfo __ret422 = (TypeInfo){.kind = 2, .nameStart = start, .nameLen = len, .ref = 0};
    return __ret422; }
}
void addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(Comp* c, uint64_t nameStart, uint64_t nameLen, uint64_t tyStart, uint64_t tyLen, long long isArray, uint64_t ty, long long isInout, long long isMut, long long owned) {
...
uint64_t scopeMark_c_Comp(Comp* c) {
    { uint64_t __ret423 = (long long)(((*c).locals).len);
    return __ret423; }
}
void emitScopeDrops_c_Comp_mark_U64_exclIdx_U64(Comp* c, uint64_t mark, uint64_t exclIdx) {
...
long long structLocalReleasable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret428 = structNeedsRelease_c_Comp_start_U64_len_U64(&((*c)), start, len);
    return __ret428; }
}
void popLocals_c_Comp_mark_U64(Comp* c, uint64_t mark) {
...
long long localIsMutable_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { long long __ret429 = (*c).curSelfInout;
    return __ret429; }
    }
    uint64_t i = (long long)(((*c).locals).len);
    while (i > 0) {
...
long long isSelfRef_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if ((*c).curHasRecv) {
    { long long __ret433 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"self", 4});
    return __ret433; }
    }
...
long long isInoutLocal_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    { long long __ret435 = (*c).curSelfInout;
    return __ret435; }
    }
    uint64_t i = (long long)(((*c).locals).len);
    while (i > 0) {
...
long long typeIsUnique_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { long long __ret439 = PlewArray_StructDef_get((*c).structs, (long long)(si)).isUnique;
    return __ret439; }
}
uint64_t localIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = (long long)(((*c).locals).len);
...
void markMovedExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m444 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m444.tag == 1) {
...
TypeInfo fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t structStart, uint64_t structLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret445 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.tyStart, f.tyLen, f.tyIsArray);
...
TypeInfo exprType_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { TypeInfo __ret461 = (TypeInfo){.kind = 2, .nameStart = rt.nameStart, .nameLen = rt.nameLen, .ref = (*c).curRecvInstRef};
    TypeRef_release(rt);
    return __ret461; }
    TypeRef_release(rt);
    }
    { TypeInfo __ret462 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), (*c).curRecvStart, (*c).curRecvLen, 0);
    return __ret462; }
    }
    uint64_t i = (long long)(((*c).locals).len);
    while (i > 0) {
    ...
    { TypeInfo __ret463 = (TypeInfo){.kind = 2, .nameStart = lt.nameStart, .nameLen = lt.nameLen, .ref = lo.ty};
    TypeRef_release(lt);
    return __ret463; }
    TypeRef_release(lt);
    }
    ...
    { TypeInfo __ret464 = (TypeInfo){.kind = 2, .nameStart = lt2.nameStart, .nameLen = lt2.nameLen, .ref = lo.ty};
    TypeRef_release(lt2);
    return __ret464; }
    TypeRef_release(lt2);
    }
    ...
    { TypeInfo __ret465 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get((*c).curTypeArgs, (long long)(k)));
    return __ret465; }
    }
    k = ({ uint64_t __ov; if (__builtin_add_overflow((k), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    }
    }
    { TypeInfo __ret466 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), lo.tyStart, lo.tyLen, lo.isArray);
    return __ret466; }
    }
    }
    { TypeInfo __ret467 = scalarInfo();
    return __ret467; }
    }
    else if (_m457.tag == 2) {
        ...
        (void)operand;
    if (op == 57) {
    { TypeInfo __ret468 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret468; }
    }
    if (op == 79) {
    { TypeInfo __ret469 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret469; }
    }
    ...
    if (op >= 56) {
    if (op <= 60) {
    { TypeInfo __ret471 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret471; }
    }
    }
    if (op >= 74) {
    if (op <= 78) {
    { TypeInfo __ret472 = exprType_c_Comp_id_U64(&((*c)), lhs);
    return __ret472; }
    }
    }
    ...
    return __ret473; }
        ...
        (void)nameLen;
        PlewArray_Arg args = _m457.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"readStdin", 9})) {
    { TypeInfo __ret474 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret474; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"readFile", 8})) {
    ...
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"readFileBytes", 13})) {
    { TypeInfo __ret476 = (TypeInfo){.kind = 1, .nameStart = 0, .nameLen = 0, .ref = 0};
    return __ret476; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"argAt", 5})) {
    ...
    { TypeInfo __ret478 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inferred, (long long)(k)));
    ...
    { TypeInfo __ret479 = (TypeInfo){.kind = 2, .nameStart = rtr.nameStart, .nameLen = rtr.nameLen, .ref = f.retTy};
    TypeRef_release(rtr);
    Func_release(f);
    return __ret479; }
    TypeRef_release(rtr);
    }
    { TypeInfo __ret480 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), f.retStart, f.retLen, f.retIsArray);
    Func_release(f);
    return __ret480; }
    }
    ...
    { TypeInfo __ret483 = genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.ref, nameStart, nameLen);
    return __ret483; }
    }
    if (bt.kind == 2) {
    { TypeInfo __ret484 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), bt.nameStart, bt.nameLen, nameStart, nameLen);
    return __ret484; }
    }
    ...
    return __ret485; }
        ...
        (void)ty;
        PlewArray_MakeField fields = _m457.data.Make.fields;
        (void)fields;
    if (isGenericInst_c_Comp_ref_U64(&((*c)), ty)) {
    { TypeInfo __ret486 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = ty};
    return __ret486; }
    }
    { TypeInfo __ret487 = (TypeInfo){.kind = 2, .nameStart = typeStart, .nameLen = typeLen, .ref = 0};
    return __ret487; }
    }
    else if (_m457.tag == 8) {
        PlewArray_U64 elems = _m457.data.Array.elems;
        (void)elems;
    ...
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { TypeInfo __ret489 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), bt.nameStart, bt.nameLen, 0);
    return __ret489; }
    }
    ...
    return __ret490; }
        ...
        (void)nameLen;
        PlewArray_Arg args = _m457.data.Method.args;
        (void)args;
    ...
    if (af.hasRet) {
    { TypeInfo __ret492 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), af.retStart, af.retLen, af.retIsArray);
    Func_release(af);
    return __ret492; }
    }
    ...
    if (mf.hasRet) {
    { TypeInfo __ret495 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), mf.retStart, mf.retLen, mf.retIsArray);
    Func_release(mf);
    return __ret495; }
    }
    ...
    return __ret498; }
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m457.data.MatchExpr.arms;
        (void)arms;
    if ((long long)((arms).len) > 0) {
    { TypeInfo __ret499 = exprType_c_Comp_id_U64(&((*c)), PlewArray_MatchArm_get(arms, (long long)(0)).body);
    return __ret499; }
    }
    ...
    { TypeInfo __ret501 = exprType_c_Comp_id_U64(&((*c)), g);
    return __ret501; }
    }
    ...
    return __ret502; }
        ...
        (void)deflt;
    { TypeInfo __ret503 = exprType_c_Comp_id_U64(&((*c)), deflt);
    return __ret503; }
    }
    ...
    { TypeInfo __ret504 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(0)));
    ...
    if (pt.kind == 2) {
    { TypeInfo __ret506 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), pt.nameStart, pt.nameLen, nameStart, nameLen);
    TypeRef_release(inst);
    return __ret506; }
    }
    TypeRef_release(inst);
    ...
    return __ret507; }
        ...
        PlewArray_Param params = _m457.data.Closure.params;
        (void)params;
    ...
    return __ret508; }
        ...
        (void)isBorrow;
    { TypeInfo __ret509 = exprType_c_Comp_id_U64(&((*c)), operand);
    return __ret509; }
    }
...
uint64_t blockGiveExpr_c_Comp_blkId_U64(Comp* c, uint64_t blkId) {
    ...
    Stmt _m511 = s;
    if (_m511.tag == 10) {
        uint64_t value = _m511.data.Give.value;
        (void)value;
    found = value;
    }
    else {
...
PlewString binOpStr_op_I64(int64_t op) {
    ...
    if (op == 58) {
    { PlewString __ret515 = (PlewString){" * ", 3};
    return __ret515; }
    }
    if (op == 59) {
    { PlewString __ret516 = (PlewString){" / ", 3};
    return __ret516; }
    }
    if (op == 60) {
    { PlewString __ret517 = (PlewString){" % ", 3};
    return __ret517; }
    }
    if (op == 50) {
    { PlewString __ret518 = (PlewString){" == ", 4};
    return __ret518; }
    }
    if (op == 51) {
    { PlewString __ret519 = (PlewString){" != ", 4};
    return __ret519; }
    }
    if (op == 52) {
    ...
    if (op == 53) {
    { PlewString __ret521 = (PlewString){" <= ", 4};
    return __ret521; }
    }
    if (op == 54) {
    ...
    if (op == 62) {
    { PlewString __ret525 = (PlewString){" || ", 4};
    return __ret525; }
    }
    if (op == 74) {
...
PlewString unaryOpStr_op_I64(int64_t op) {
    if (op == 57) {
    { PlewString __ret532 = (PlewString){"-", 1};
    return __ret532; }
    }
    if (op == 79) {
    { PlewString __ret533 = (PlewString){"~", 1};
    return __ret533; }
    }
    { PlewString __ret534 = (PlewString){"!", 1};
    return __ret534; }
}
int64_t strDecodedLen_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    int64_t n = 0;
...
PlewString overflowBuiltin_op_I64(int64_t op) {
    if (op == 56) {
    { PlewString __ret544 = (PlewString){"__builtin_add_overflow", 22};
    return __ret544; }
    }
    if (op == 57) {
    { PlewString __ret545 = (PlewString){"__builtin_sub_overflow", 22};
    return __ret545; }
    }
    { PlewString __ret546 = (PlewString){"__builtin_mul_overflow", 22};
    return __ret546; }
}
TypeInfo arithIntType_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
PlewString intMinMacro_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"I8", 2})) {
    { PlewString __ret550 = (PlewString){"INT8_MIN", 8};
    return __ret550; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"I16", 3})) {
    { PlewString __ret551 = (PlewString){"INT16_MIN", 9};
    return __ret551; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, start, len, (PlewString){"I32", 3})) {
    { PlewString __ret552 = (PlewString){"INT32_MIN", 9};
    return __ret552; }
    }
    { PlewString __ret553 = (PlewString){"INT64_MIN", 9};
    return __ret553; }
}
void genCheckedNeg_c_Comp_operand_U64_tyStart_U64_tyLen_U64(Comp* c, uint64_t operand, uint64_t tyStart, uint64_t tyLen) {
    plew_write((PlewString){"({ ", 3});
...
PlewString assignOpStr_op_I64(int64_t op) {
    ...
    if (op == 83) {
    { PlewString __ret563 = (PlewString){" <<= ", 5};
    return __ret563; }
    }
    { PlewString __ret564 = (PlewString){" >>= ", 5};
    return __ret564; }
}
long long isCompoundDiv_op_I64(int64_t op) {
    if (op == 70) {
    { long long __ret565 = 1;
    return __ret565; }
    }
    if (op == 71) {
...
PlewString compoundDivFn_op_I64(int64_t op) {
    if (op == 70) {
    { PlewString __ret568 = (PlewString){"plew_div(", 9};
    return __ret568; }
    }
    if (op == 71) {
    { PlewString __ret569 = (PlewString){"plew_mod(", 9};
    return __ret569; }
    }
    { PlewString __ret570 = (PlewString){"", 0};
    return __ret570; }
}
PlewString assignToBinStr_op_I64(int64_t op) {
    if (op == 67) {
...
ConstInt notConst(void) {
    { ConstInt __ret581 = (ConstInt){.isConst = 0, .value = 0};
    return __ret581; }
}
ConstInt foldConst_c_Comp_id_U64(Comp* c, uint64_t id) {
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    ...
    Expr _m582 = e;
    if (_m582.tag == 0) {
        int64_t value = _m582.data.Int.value;
        (void)value;
        long long isBool = _m582.data.Int.isBool;
        (void)isBool;
    if (isBool) {
    { ConstInt __ret583 = notConst();
    return __ret583; }
    }
    { ConstInt __ret584 = (ConstInt){.isConst = 1, .value = value};
    return __ret584; }
    }
    else if (_m582.tag == 2) {
        int64_t op = _m582.data.Unary.op;
        (void)op;
        uint64_t operand = _m582.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ConstInt o = foldConst_c_Comp_id_U64(&((*c)), operand);
    if (o.isConst) {
    { ConstInt __ret585 = (ConstInt){.isConst = 1, .value = ({ int64_t __ov; if (__builtin_sub_overflow((0), (o.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })};
    return __ret585; }
    }
    }
    { ConstInt __ret586 = notConst();
    return __ret586; }
    }
    else if (_m582.tag == 3) {
        int64_t op = _m582.data.Binary.op;
        (void)op;
        uint64_t lhs = _m582.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m582.data.Binary.rhs;
        (void)rhs;
    ...
    if (b.isConst) {
    if (op == 56) {
    { ConstInt __ret587 = (ConstInt){.isConst = 1, .value = ({ int64_t __ov; if (__builtin_add_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })};
    return __ret587; }
    }
    if (op == 57) {
    { ConstInt __ret588 = (ConstInt){.isConst = 1, .value = ({ int64_t __ov; if (__builtin_sub_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })};
    return __ret588; }
    }
    if (op == 58) {
    { ConstInt __ret589 = (ConstInt){.isConst = 1, .value = ({ int64_t __ov; if (__builtin_mul_overflow((a.value), (b.value), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; })};
    return __ret589; }
    }
    }
    }
    { ConstInt __ret590 = notConst();
    return __ret590; }
    }
    else {
...
long long tiIsInt_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    if (ti.kind == 0) {
    if (ti.nameLen != 0) {
    { long long __ret592 = isIntType_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret592; }
    }
    }
...
void checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(Comp* c, uint64_t id, uint64_t eKind, uint64_t eBits, long long eSgn) {
    ...
    Expr _m594 = e;
    if (_m594.tag == 0) {
        int64_t value = _m594.data.Int.value;
        (void)value;
        uint64_t offset = _m594.data.Int.offset;
        (void)offset;
        long long isBool = _m594.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m594.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m594.data.Int.tyLen;
        (void)tyLen;
    checkLitLeaf_c_Comp_value_I64_offset_U64_isBool_Bool_tyStart_U64_tyLen_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), value, offset, isBool, tyStart, tyLen, eKind, eBits, eSgn);
        ...
        int64_t op = _m594.data.Unary.op;
        (void)op;
        uint64_t operand = _m594.data.Unary.operand;
        (void)operand;
    if (op == 57) {
    ...
    if (_m595.tag == 0) {
        ...
        (void)value;
        uint64_t offset = _m595.data.Int.offset;
        (void)offset;
        long long isBool = _m595.data.Int.isBool;
        (void)isBool;
        uint64_t tyStart = _m595.data.Int.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m595.data.Int.tyLen;
        (void)tyLen;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, eKind, eBits, eSgn);
        ...
        int64_t op = _m594.data.Binary.op;
        (void)op;
        uint64_t lhs = _m594.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m594.data.Binary.rhs;
        (void)rhs;
    long long isArith = 0;
    if (op >= 56) {
    if (op <= 60) {
    ...
    checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(&((*c)), lhs, rhs);
        ...
        uint64_t nameStart = _m594.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m594.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m594.data.Call.args;
        (void)args;
    checkCallArgs_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, args);
    }
    else if (_m594.tag == 10) {
        uint64_t recv = _m594.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m594.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m594.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m594.data.Method.args;
        (void)args;
    checkMethodArgs_c_Comp_recv_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), recv, nameStart, nameLen, args);
    }
    else if (_m594.tag == 11) {
        uint64_t operand = _m594.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m594.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m594.data.Cast.tyLen;
        (void)tyLen;
    Expr oe = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    {
    Expr _m596 = oe;
    ...
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), operand, 0, 0, 0);
        ...
        uint64_t base = _m594.data.Field.base;
        (void)base;
        uint64_t nameStart = _m594.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m594.data.Field.nameLen;
        (void)nameLen;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    }
    else if (_m594.tag == 9) {
        uint64_t base = _m594.data.Index.base;
        (void)base;
        uint64_t index = _m594.data.Index.index;
        (void)index;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), base, 0, 0, 0);
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), index, 1, 64, 0);
    }
    else if (_m594.tag == 6) {
        uint64_t typeStart = _m594.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m594.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m594.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m594.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m594.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m594.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m594.data.Make.fields;
        (void)fields;
    checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(&((*c)), typeStart, typeLen, variantStart, variantLen, isEnum, ty, fields);
        ...
        PlewArray_U64 elems = _m594.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    ...
    else if (_m594.tag == 12) {
        uint64_t scrut = _m594.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m594.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m594.tag == 14) {
        uint64_t opt = _m594.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m594.data.Coalesce.deflt;
        (void)deflt;
    ...
    else if (_m594.tag == 15) {
        uint64_t expr = _m594.data.Try.expr;
        (void)expr;
...
IntTy exprIntTy_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    { IntTy __ret597 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), ti.nameStart, ti.nameLen)};
    return __ret597; }
    }
    Expr e = PlewArray_Expr_get((*c).exprs, (long long)(id));
    {
    Expr _m598 = e;
    if (_m598.tag == 4) {
        uint64_t nameStart = _m598.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m598.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m598.data.Call.args;
        (void)args;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"argCount", 8})) {
    { IntTy __ret599 = (IntTy){.known = 1, .bits = 64, .sgn = 1};
    return __ret599; }
    }
    }
    else if (_m598.tag == 5) {
        uint64_t base = _m598.data.Field.base;
        (void)base;
        uint64_t nameStart = _m598.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m598.data.Field.nameLen;
        (void)nameLen;
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, nameStart, nameLen, (PlewString){"count", 5})) {
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    { IntTy __ret600 = (IntTy){.known = 1, .bits = 64, .sgn = 0};
    return __ret600; }
    }
    }
    }
    else if (_m598.tag == 9) {
        uint64_t base = _m598.data.Index.base;
        (void)base;
        uint64_t index = _m598.data.Index.index;
        (void)index;
    TypeInfo bt = exprType_c_Comp_id_U64(&((*c)), base);
    if (bt.kind == 3) {
    if (isIntType_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)) {
    { IntTy __ret601 = (IntTy){.known = 1, .bits = intBits_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen), .sgn = intSigned_c_Comp_start_U64_len_U64(&((*c)), bt.nameStart, bt.nameLen)};
    return __ret601; }
    }
    }
    }
    ...
    { IntTy __ret602 = (IntTy){.known = 0, .bits = 0, .sgn = 0};
    return __ret602; }
}
void checkArithNoCtx_c_Comp_lhs_U64_rhs_U64(Comp* c, uint64_t lhs, uint64_t rhs) {
...
void checkLitArray_c_Comp_id_U64_elemStart_U64_elemLen_U64(Comp* c, uint64_t id, uint64_t elemStart, uint64_t elemLen) {
    ...
    Expr _m603 = e;
    if (_m603.tag == 8) {
        PlewArray_U64 elems = _m603.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
...
TypeInfo makeFieldType_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret608 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), fd.tyStart, fd.tyLen, fd.tyIsArray);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    EnumDef_release(en);
    ...
    { TypeInfo __ret610 = fieldType_c_Comp_structStart_U64_structLen_U64_fieldStart_U64_fieldLen_U64(&((*c)), typeStart, typeLen, fieldStart, fieldLen);
    return __ret610; }
}
void checkMakeFields_c_Comp_typeStart_U64_typeLen_U64_variantStart_U64_variantLen_U64_isEnum_Bool_ty_U64_fields_AMakeField(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t variantStart, uint64_t variantLen, long long isEnum, uint64_t ty, PlewArray_MakeField fields) {
    uint64_t i = 0;
...
long long builtinEqOrd_c_Comp_typeStart_U64_typeLen_U64_traitStart_U64_traitLen_U64(Comp* c, uint64_t typeStart, uint64_t typeLen, uint64_t traitStart, uint64_t traitLen) {
    ...
    { long long __ret621 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, typeStart, typeLen, (PlewString){"String", 6});
    return __ret621; }
    }
...
void checkBoundsExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m636 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m636.tag == 2) {
        int64_t op = _m636.data.Unary.op;
        (void)op;
        uint64_t operand = _m636.data.Unary.operand;
        (void)operand;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m636.tag == 3) {
        int64_t op = _m636.data.Binary.op;
        (void)op;
        uint64_t lhs = _m636.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m636.data.Binary.rhs;
        (void)rhs;
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), lhs)), (PlewString){"comparison on a type parameter needs an Eq/Ord bound (add `where T: Eq` / `: Ord`)", 82});
        ...
        uint64_t nameStart = _m636.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m636.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m636.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    else if (_m636.tag == 10) {
        uint64_t recv = _m636.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m636.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m636.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m636.data.Method.args;
        (void)args;
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), nameStart), (PlewString){"method not provided by the bounds of this type parameter (add a `where T: Trait` that declares it)", 98});
        ...
        uint64_t base = _m636.data.Field.base;
        (void)base;
        uint64_t nameStart = _m636.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m636.data.Field.nameLen;
        (void)nameLen;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m636.tag == 9) {
        uint64_t base = _m636.data.Index.base;
        (void)base;
        uint64_t index = _m636.data.Index.index;
        (void)index;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), base);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), index);
    }
    else if (_m636.tag == 6) {
        uint64_t typeStart = _m636.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m636.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m636.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m636.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m636.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m636.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m636.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m636.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    else if (_m636.tag == 11) {
        uint64_t operand = _m636.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m636.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m636.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m636.data.Cast.ty;
        (void)ty;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m636.tag == 14) {
        uint64_t opt = _m636.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m636.data.Coalesce.deflt;
        (void)deflt;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), opt);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m636.tag == 15) {
        uint64_t expr = _m636.data.Try.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m636.tag == 16) {
        uint64_t base = _m636.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m636.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m636.data.Arrow.nameLen;
        (void)nameLen;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m636.tag == 13) {
        uint64_t cond = _m636.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m636.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m636.data.IfExpr.elseBlk;
        (void)elseBlk;
    ...
    else if (_m636.tag == 12) {
        uint64_t scrut = _m636.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m636.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m636.tag == 18) {
        uint64_t operand = _m636.data.Move.operand;
        (void)operand;
        long long isBorrow = _m636.data.Move.isBorrow;
        (void)isBorrow;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void checkBoundsStmt_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m637 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m637.tag == 0) {
        long long mutable = _m637.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m637.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m637.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m637.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m637.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m637.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m637.data.Let.ty;
        (void)ty;
        uint64_t init = _m637.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m637.data.Assign.op;
        (void)op;
        uint64_t target = _m637.data.Assign.target;
        (void)target;
        uint64_t value = _m637.data.Assign.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), target);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m637.tag == 2) {
        uint64_t expr = _m637.data.Print.expr;
        (void)expr;
        uint64_t offset = _m637.data.Print.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m637.tag == 3) {
        uint64_t expr = _m637.data.ExprStmt.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m637.tag == 4) {
        uint64_t value = _m637.data.Return.value;
        (void)value;
        long long hasValue = _m637.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m637.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m637.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m637.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m637.data.If.hasElse;
        (void)hasElse;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m637.data.While.cond;
        (void)cond;
        uint64_t body = _m637.data.While.body;
        (void)body;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m637.tag == 7) {
        uint64_t varStart = _m637.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m637.data.For.varLen;
        (void)varLen;
        long long isRange = _m637.data.For.isRange;
        (void)isRange;
        long long inclusive = _m637.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m637.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m637.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m637.data.For.body;
        (void)body;
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m637.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m637.data.Match.arms;
        (void)arms;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m637.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m637.data.Panic.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m637.tag == 10) {
        uint64_t value = _m637.data.Give.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
...
void genExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m638 = e;
    if (_m638.tag == 0) {
        int64_t value = _m638.data.Int.value;
        (void)value;
    writeInt_n_I64(value);
    }
    else if (_m638.tag == 1) {
        uint64_t start = _m638.data.Ident.start;
        (void)start;
        uint64_t len = _m638.data.Ident.len;
        (void)len;
    ...
    else if (_m638.tag == 18) {
        uint64_t operand = _m638.data.Move.operand;
        (void)operand;
        long long isBorrow = _m638.data.Move.isBorrow;
        (void)isBorrow;
    if (isBorrow) {
    genExpr_c_Comp_id_U64(&((*c)), operand);
    }
    ...
    {
    Expr _m639 = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    if (_m639.tag == 1) {
        uint64_t start = _m639.data.Ident.start;
        (void)start;
        uint64_t len = _m639.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    writeSpan_c_Comp_start_U64_len_U64(&((*c)), nameStart, nameLen);
        ...
        uint64_t start = _m638.data.Str.start;
        (void)start;
        uint64_t len = _m638.data.Str.len;
        (void)len;
    ...
    else if (_m638.tag == 16) {
        uint64_t base = _m638.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m638.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m638.data.Arrow.nameLen;
        (void)nameLen;
    plew_write((PlewString){"(", 1});
    genExpr_c_Comp_id_U64(&((*c)), base);
    plew_write((PlewString){")->", 3});
    ...
    else if (_m638.tag == 17) {
        PlewArray_Param params = _m638.data.Closure.params;
        (void)params;
        long long hasRet = _m638.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m638.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m638.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m638.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m638.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m638.data.Closure.body;
        (void)body;
    plew_write((PlewString){"__closure", 9});
    writeU64_n_U64(id);
    }
    else if (_m638.tag == 10) {
        uint64_t recv = _m638.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m638.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m638.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m638.data.Method.args;
        (void)args;
    Bind arn = assocRecvName_c_Comp_recv_U64(&((*c)), recv);
    if (arn.nameLen != 0) {
    uint64_t afi = findAssoc_c_Comp_recvStart_U64_recvLen_U64_nameStart_U64_nameLen_U64_args_AArg(&((*c)), arn.nameStart, arn.nameLen, nameStart, nameLen, args);
    ...
    if (mf.selfMove) {
    {
    Expr _m640 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m640.tag == 1) {
        uint64_t start = _m640.data.Ident.start;
        (void)start;
        uint64_t len = _m640.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), recv)), (PlewString){"cannot call a `move fn` on a variable declared outside the enclosing conditional/loop (the consume would be conditional)", 120});
        ...
        uint64_t base = _m640.data.Field.base;
        (void)base;
        uint64_t nameStart = _m640.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m640.data.Field.nameLen;
        (void)nameLen;
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), recv)), (PlewString){"cannot call a `move fn` on a field (partial move, not yet supported)", 68});
        ...
        uint64_t base = _m640.data.Index.base;
        (void)base;
        uint64_t index = _m640.data.Index.index;
        (void)index;
    ...
    Func_release(mf);
        ...
        PlewArray_U64 elems = _m638.data.Array.elems;
        (void)elems;
    plew_write((PlewString){"0", 1});
    }
    else if (_m638.tag == 11) {
        uint64_t operand = _m638.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m638.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m638.data.Cast.tyLen;
        (void)tyLen;
    ...
    Expr _m641 = opE;
    if (_m641.tag == 0) {
        int64_t value = _m641.data.Int.value;
        (void)value;
        uint64_t offset = _m641.data.Int.offset;
        (void)offset;
    if (litFitsType_c_Comp_value_I64_dstStart_U64_dstLen_U64(&((*c)), value, tyStart, tyLen)) {
    }
    else {
    ...
    plew_write((PlewString){"))", 2});
        ...
        uint64_t typeStart = _m638.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m638.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m638.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m638.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m638.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m638.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m638.data.Make.fields;
        (void)fields;
    ...
    else if (_m638.tag == 12) {
        uint64_t scrut = _m638.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m638.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m638.tag == 13) {
        uint64_t cond = _m638.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m638.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m638.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
    ...
    else if (_m638.tag == 14) {
        uint64_t opt = _m638.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m638.data.Coalesce.deflt;
        (void)deflt;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    ...
    else if (_m638.tag == 15) {
        uint64_t expr = _m638.data.Try.expr;
        (void)expr;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
long long isPlaceExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m642 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m642.tag == 1) {
        uint64_t start = _m642.data.Ident.start;
        (void)start;
        uint64_t len = _m642.data.Ident.len;
        (void)len;
    { long long __ret643 = 1;
    return __ret643; }
    }
    else if (_m642.tag == 5) {
        uint64_t base = _m642.data.Field.base;
        (void)base;
        uint64_t nameStart = _m642.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m642.data.Field.nameLen;
        (void)nameLen;
    { long long __ret644 = 1;
    return __ret644; }
    }
    else if (_m642.tag == 9) {
        uint64_t base = _m642.data.Index.base;
        (void)base;
        uint64_t index = _m642.data.Index.index;
        (void)index;
...
long long isEnumEq_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    TypeInfo lt = exprType_c_Comp_id_U64(&((*c)), lhs);
    if (lt.kind == 2) {
    { long long __ret656 = isEnumName_c_Comp_start_U64_len_U64(&((*c)), lt.nameStart, lt.nameLen);
    return __ret656; }
    }
...
uint64_t findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(Comp* c, uint64_t typeStart, uint64_t typeLen, PlewString name) {
    ...
    { uint64_t __ret666 = (long long)(((*c).funcs).len);
    return __ret666; }
}
uint64_t orderingVariantIndex_c_Comp_name_String(Comp* c, PlewString name) {
    uint64_t ei = 0;
...
long long hasCompareWitness_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    if (lt.kind == 2) {
    if (op == 50) {
    { long long __ret669 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret669; }
    }
    if (op == 51) {
    { long long __ret670 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret670; }
    }
    if (op >= 52) {
    if (op <= 55) {
    if (typeConformsToName_c_Comp_typeStart_U64_typeLen_U64_traitName_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"Ord", 3})) {
    { long long __ret671 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"compare", 7}) < (long long)(((*c).funcs).len));
    return __ret671; }
    }
    }
    }
...
long long eqWitnessReady_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret673 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), ti.nameStart, ti.nameLen, (PlewString){"eq", 2}) < (long long)(((*c).funcs).len));
    return __ret673; }
    }
...
void genStmt_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    {
    Expr _m678 = PlewArray_Expr_get((*c).exprs, (long long)(value));
    if (_m678.tag == 1) {
        uint64_t start = _m678.data.Ident.start;
        (void)start;
        uint64_t len = _m678.data.Ident.len;
        (void)len;
    if ((*c).curSelfMove) {
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    retExcl = localIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
        ...
        uint64_t base = _m678.data.Field.base;
        (void)base;
        uint64_t nameStart = _m678.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m678.data.Field.nameLen;
        (void)nameLen;
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), exprOffset_c_Comp_id_U64(&((*c)), value)), (PlewString){"returning a field of a unique value is a partial move (not yet supported)", 73});
        ...
        uint64_t base = _m678.data.Index.base;
        (void)base;
        uint64_t index = _m678.data.Index.index;
        (void)index;
...
long long nameIsMain_c_Comp_f_Func(Comp* c, Func f) {
    ...
    { long long __ret680 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, f.nameStart, f.nameLen, (PlewString){"main", 4});
    return __ret680; }
}
long long isTraitName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
...
long long methodRecvIsTrait_c_Comp_f_Func(Comp* c, Func f) {
    if (f.hasRecv) {
    { long long __ret683 = isTraitName_c_Comp_start_U64_len_U64(&((*c)), f.recvStart, f.recvLen);
    return __ret683; }
    }
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret688 = (long long)(((*c).structs).len);
    return __ret688; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m704 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m704.tag == 17) {
        PlewArray_Param params = _m704.data.Closure.params;
        (void)params;
        long long hasRet = _m704.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m704.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m704.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m704.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m704.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m704.data.Closure.body;
        (void)body;
    if (hasRet) {
    (*c).curRetVoid = 0;
...
void emitClosures_c_Comp_proto_Bool(Comp* c, long long proto) {
    ...
    {
    Expr _m705 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m705.tag == 17) {
        PlewArray_Param params = _m705.data.Closure.params;
        (void)params;
        long long hasRet = _m705.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m705.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m705.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m705.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m705.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m705.data.Closure.body;
        (void)body;
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret707 = (long long)(((*c).structs).len);
    return __ret707; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret709 = (long long)(((*c).enums).len);
    return __ret709; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret713 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret713; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret715 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret715; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret718 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret718; }
    TypeRef_release(t);
}
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret721 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret721; }
    TypeRef_release(t);
}
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret728 = PlewArray_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret728; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m738 = PlewArray_Stmt_get((*c).stmts, (long long)(sti));
    if (_m738.tag == 0) {
        uint64_t ty = _m738.data.Let.ty;
        (void)ty;
    ...
    {
    Expr _m739 = PlewArray_Expr_get((*c).exprs, (long long)(xi));
    if (_m739.tag == 11) {
        ...
        (void)tyLen;
        uint64_t ty = _m739.data.Cast.ty;
        (void)ty;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else if (_m739.tag == 6) {
        ...
        (void)ty;
        PlewArray_MakeField fields = _m739.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    if ((long long)((t.args).len) == 0) {
    { TypeInfo __ret740 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret740; }
    }
    if (rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, t.nameStart, t.nameLen, (PlewString){"Array", 5})) {
    TypeRef el = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(PlewArray_U64_get(t.args, (long long)(0)))));
    { TypeInfo __ret741 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret741; }
    TypeRef_release(el);
    }
    { TypeInfo __ret742 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret742; }
    TypeRef_release(t);
}
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, PlewArray_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret743 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret743; }
    }
    ...
    { TypeInfo __ret744 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret744; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret746 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
    ...
    { TypeInfo __ret747 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret750 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    ...
    { TypeInfo __ret751 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret756 = ((long long)((f.typeParams).len) == (long long)((inst.args).len));
    TypeRef_release(inst);
    return __ret756; }
    TypeRef_release(inst);
}
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret759 = ((long long)((f.typeParams).len) > 0);
    Func_release(f);
    return __ret759; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    PlewArray_U64 noArgs = PlewArray_U64_new();
    { uint64_t __ret761 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = PlewArray_U64_share(noArgs)});
    PlewArray_U64_release(noArgs);
    return __ret761; }
    PlewArray_U64_release(noArgs);
}
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret765 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret765; }
}
PlewArray_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, PlewArray_Arg args) {
    ...
    { PlewArray_U64 __ret766 = PlewArray_U64_share(out);
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m773 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m773.tag == 2) {
    ...
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
        ...
        (void)nameLen;
        PlewArray_Arg args = _m773.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    registerCallInst_c_Comp_nameStart_U64_nameLen_U64_args_AArg(&((*c)), nameStart, nameLen, args);
        ...
        (void)nameLen;
        PlewArray_Arg args = _m773.data.Method.args;
        (void)args;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m773.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m773.data.MatchExpr.arms;
        (void)arms;
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m774 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m774.tag == 0) {
    ...
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
        ...
        uint64_t expr = _m774.data.Print.expr;
        (void)expr;
        uint64_t offset = _m774.data.Print.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m774.tag == 3) {
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m774.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret775 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, elemStart, elemLen, (PlewString){"U8", 2});
    return __ret775; }
}
void genU8ArrayTypedef(void) {
...
PlewArray_Bind collectParts_rootBytes_AU8_toks_ATok(PlewArray_U8 rootBytes, PlewArray_Tok toks) {
    ...
    long long starts = 0;
    {
    Kind _m782 = first.kind;
    if (_m782.tag == 37) {
    starts = 1;
    }
    else if (_m782.tag == 48) {
    starts = 1;
    }
    else {
    ...
    { PlewArray_Bind __ret783 = PlewArray_Bind_share(parts);
...
uint64_t stripParents_path_AU8_baseLen_U64_n_U64(PlewArray_U8 path, uint64_t baseLen, uint64_t n) {
    ...
    { uint64_t __ret784 = end;
    return __ret784; }
}
PlewArray_U8 resolveImport_src_AU8_pStart_U64_pLen_U64_importer_AU8_baseLen_U64_srcRoot_AU8_srcRootLen_U64_stdRoot_AU8_stdRootLen_U64(PlewArray_U8 src, uint64_t pStart, uint64_t pLen, PlewArray_U8 importer, uint64_t baseLen, PlewArray_U8 srcRoot, uint64_t srcRootLen, PlewArray_U8 stdRoot, uint64_t stdRootLen) {
    PlewArray_U8 out = PlewArray_U8_new();
    if (pLen == 0) {
    { PlewArray_U8 __ret785 = PlewArray_U8_share(out);
    ...
    if (stdRootLen == 0) {
    { PlewArray_U8 __ret786 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret786; }
    }
    uint64_t si = 0;
    ...
    { PlewArray_U8 __ret787 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret787; }
    }
    }
    ...
    { PlewArray_U8 __ret788 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret788; }
    }
    if (b0 == 47) {
    if (srcRootLen == 0) {
    { PlewArray_U8 __ret789 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret789; }
    }
    uint64_t i = 0;
    ...
    PlewArray_U8_push(&(out), 112);
    PlewArray_U8_push(&(out), 119);
    { PlewArray_U8 __ret790 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret790; }
    }
    ...
    PlewArray_U8_push(&(out), 112);
    PlewArray_U8_push(&(out), 119);
    { PlewArray_U8 __ret791 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret791; }
    PlewArray_U8_release(out);
}
...
PlewArray_U8 extractSpan_buf_AU8_start_U64_len_U64(PlewArray_U8 buf, uint64_t start, uint64_t len) {
    ...
    { PlewArray_U8 __ret792 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret792; }
    PlewArray_U8_release(out);
}
...
PlewArray_U8 computeStdRoot_arg0_AU8(PlewArray_U8 arg0) {
    ...
    { PlewArray_U8 __ret794 = PlewArray_U8_share(out);
    PlewArray_U8_release(out);
    return __ret794; }
    PlewArray_U8_release(out);
}
PlewArray_U8 findSrcRoot_entry_AU8(PlewArray_U8 entry) {
    ...
    { PlewArray_U8 __ret795 = PlewArray_U8_share(sr);
    ...
    { PlewArray_U8 __ret796 = PlewArray_U8_share(empty);
