...
void checkBoundsExpr_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m632 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m632.tag == 2) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        (void)tyLen;
        uint64_t ty = _m632.data.Cast.ty;
        (void)ty;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), operand);
    }
...
void checkBoundsStmt_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m633 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m633.tag == 0) {
        long long mutable = _m633.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m633.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m633.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m633.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m633.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m633.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m633.data.Let.ty;
        (void)ty;
        uint64_t init = _m633.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m633.data.Assign.op;
        (void)op;
        uint64_t target = _m633.data.Assign.target;
        (void)target;
        uint64_t value = _m633.data.Assign.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), target);
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
    else if (_m633.tag == 2) {
        uint64_t expr = _m633.data.Print.expr;
        (void)expr;
        uint64_t offset = _m633.data.Print.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m633.tag == 3) {
        uint64_t expr = _m633.data.ExprStmt.expr;
        (void)expr;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m633.tag == 4) {
        uint64_t value = _m633.data.Return.value;
        (void)value;
        long long hasValue = _m633.data.Return.hasValue;
        (void)hasValue;
    if (hasValue) {
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
        ...
        uint64_t cond = _m633.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m633.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m633.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m633.data.If.hasElse;
        (void)hasElse;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), thenBlk);
    if (hasElse) {
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), elseBlk);
        ...
        uint64_t cond = _m633.data.While.cond;
        (void)cond;
        uint64_t body = _m633.data.While.body;
        (void)body;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), cond);
    checkBoundsBlock_c_Comp_blkId_U64(&((*c)), body);
    }
    else if (_m633.tag == 7) {
        uint64_t varStart = _m633.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m633.data.For.varLen;
        (void)varLen;
        long long isRange = _m633.data.For.isRange;
        (void)isRange;
        long long inclusive = _m633.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m633.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m633.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m633.data.For.body;
        (void)body;
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t scrut = _m633.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m633.data.Match.arms;
        (void)arms;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
    ...
    MatchArm_release(a);
        ...
        uint64_t msg = _m633.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m633.data.Panic.offset;
        (void)offset;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), msg);
    }
    else if (_m633.tag == 10) {
        uint64_t value = _m633.data.Give.value;
        (void)value;
    checkBoundsExpr_c_Comp_exprId_U64(&((*c)), value);
    }
...
void genExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Expr _m634 = e;
    if (_m634.tag == 0) {
        int64_t value = _m634.data.Int.value;
        (void)value;
    ...
    else if (_m634.tag == 18) {
        uint64_t operand = _m634.data.Move.operand;
        (void)operand;
        long long isBorrow = _m634.data.Move.isBorrow;
        (void)isBorrow;
    if (isBorrow) {
    genExpr_c_Comp_id_U64(&((*c)), operand);
    }
    ...
    {
    Expr _m635 = PlewArray_Expr_get((*c).exprs, (long long)(operand));
    if (_m635.tag == 1) {
        uint64_t start = _m635.data.Ident.start;
        (void)start;
        uint64_t len = _m635.data.Ident.len;
        (void)len;
    if (isSelfRef_c_Comp_start_U64_len_U64(&((*c)), start, len)) {
    ...
    writeSpan_c_Comp_start_U64_len_U64(&((*c)), nameStart, nameLen);
        ...
        uint64_t start = _m634.data.Str.start;
        (void)start;
        uint64_t len = _m634.data.Str.len;
        (void)len;
    ...
    else if (_m634.tag == 16) {
        uint64_t base = _m634.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m634.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m634.data.Arrow.nameLen;
        (void)nameLen;
    plew_write((PlewString){"(", 1});
    genExpr_c_Comp_id_U64(&((*c)), base);
    plew_write((PlewString){")->", 3});
    ...
    else if (_m634.tag == 17) {
        PlewArray_Param params = _m634.data.Closure.params;
        (void)params;
        long long hasRet = _m634.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m634.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m634.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m634.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m634.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m634.data.Closure.body;
        (void)body;
    ...
    if (mf.selfMove) {
    {
    Expr _m636 = PlewArray_Expr_get((*c).exprs, (long long)(recv));
    if (_m636.tag == 1) {
    ...
    Expr _m637 = opE;
    if (_m637.tag == 0) {
        int64_t value = _m637.data.Int.value;
        (void)value;
    ...
    else if (_m634.tag == 13) {
        uint64_t cond = _m634.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m634.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m634.data.IfExpr.elseBlk;
        (void)elseBlk;
    uint64_t t = (*c).tmp;
    (*c).tmp = ({ uint64_t __ov; if (__builtin_add_overflow(((*c).tmp), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
    uint64_t g = blockGiveExpr_c_Comp_blkId_U64(&((*c)), thenBlk);
...
long long isPlaceExpr_c_Comp_id_U64(Comp* c, uint64_t id) {
    {
    Expr _m638 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m638.tag == 1) {
...
long long isEnumEq_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    TypeInfo lt = exprType_c_Comp_id_U64(&((*c)), lhs);
    if (lt.kind == 2) {
    { long long __ret652 = isEnumName_c_Comp_start_U64_len_U64(&((*c)), lt.nameStart, lt.nameLen);
    return __ret652; }
    }
...
void emitEnumOperand_c_Comp_id_U64_enStart_U64_enLen_U64(Comp* c, uint64_t id, uint64_t enStart, uint64_t enLen) {
    ...
    Expr _m660 = e;
    if (_m660.tag == 6) {
        uint64_t typeStart = _m660.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m660.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m660.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m660.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m660.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m660.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m660.data.Make.fields;
        (void)fields;
    if (isEnum) {
...
uint64_t findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(Comp* c, uint64_t typeStart, uint64_t typeLen, PlewString name) {
    ...
    { uint64_t __ret662 = (long long)(((*c).funcs).len);
    return __ret662; }
}
uint64_t orderingVariantIndex_c_Comp_name_String(Comp* c, PlewString name) {
    uint64_t ei = 0;
...
long long hasCompareWitness_c_Comp_op_I64_lhs_U64(Comp* c, int64_t op, uint64_t lhs) {
    ...
    if (lt.kind == 2) {
    if (op == 50) {
    { long long __ret665 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret665; }
    }
    if (op == 51) {
    { long long __ret666 = eqWitnessReady_c_Comp_ti_TypeInfo(&((*c)), lt);
    return __ret666; }
    }
    if (op >= 52) {
    if (op <= 55) {
    if (typeConformsToName_c_Comp_typeStart_U64_typeLen_U64_traitName_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"Ord", 3})) {
    { long long __ret667 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), lt.nameStart, lt.nameLen, (PlewString){"compare", 7}) < (long long)(((*c).funcs).len));
    return __ret667; }
    }
    }
    }
...
long long eqWitnessReady_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { long long __ret669 = (findAssocByName_c_Comp_typeStart_U64_typeLen_U64_name_String(&((*c)), ti.nameStart, ti.nameLen, (PlewString){"eq", 2}) < (long long)(((*c).funcs).len));
    return __ret669; }
    }
...
void genStmt_c_Comp_id_U64(Comp* c, uint64_t id) {
    ...
    Stmt _m672 = s;
    if (_m672.tag == 0) {
        long long mutable = _m672.data.Let.mutable;
        (void)mutable;
        uint64_t nameStart = _m672.data.Let.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m672.data.Let.nameLen;
        (void)nameLen;
        uint64_t tyStart = _m672.data.Let.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m672.data.Let.tyLen;
        (void)tyLen;
        long long tyIsArray = _m672.data.Let.tyIsArray;
        (void)tyIsArray;
        uint64_t ty = _m672.data.Let.ty;
        (void)ty;
        uint64_t init = _m672.data.Let.init;
        (void)init;
    ...
    addLocal_c_Comp_nameStart_U64_nameLen_U64_tyStart_U64_tyLen_U64_isArray_Bool_ty_U64_isInout_Bool_isMut_Bool_owned_Bool(&((*c)), nameStart, nameLen, tyStart, tyLen, tyIsArray, ty, 0, mutable, 1);
        ...
        int64_t op = _m672.data.Assign.op;
        (void)op;
        uint64_t target = _m672.data.Assign.target;
        (void)target;
        uint64_t value = _m672.data.Assign.value;
        (void)value;
    ...
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t expr = _m672.data.Print.expr;
        (void)expr;
        uint64_t offset = _m672.data.Print.offset;
        (void)offset;
    if ((*c).impPrint) {
    ...
    compileErrorAt_line_I64_msg_String(lineOf_c_Comp_offset_U64(&((*c)), offset), (PlewString){"print is not ambient; import it from @Std/Io", 44});
        ...
        uint64_t expr = _m672.data.ExprStmt.expr;
        (void)expr;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), expr, 0, 0, 0);
    plew_write((PlewString){"    ", 4});
    genExpr_c_Comp_id_U64(&((*c)), expr);
    plew_write((PlewString){";\n", 2});
        ...
        uint64_t value = _m672.data.Return.value;
        (void)value;
        long long hasValue = _m672.data.Return.hasValue;
        (void)hasValue;
    if ((*c).curIsMain) {
    ...
    {
    Expr _m674 = PlewArray_Expr_get((*c).exprs, (long long)(value));
    if (_m674.tag == 1) {
    ...
    plew_write((PlewString){"; }\n", 4});
        ...
        uint64_t cond = _m672.data.If.cond;
        (void)cond;
        uint64_t thenBlk = _m672.data.If.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m672.data.If.elseBlk;
        (void)elseBlk;
        long long hasElse = _m672.data.If.hasElse;
        (void)hasElse;
    ...
    (*c).curBranchBase = savedBB;
        ...
        uint64_t cond = _m672.data.While.cond;
        (void)cond;
        uint64_t body = _m672.data.While.body;
        (void)body;
    checkLitCtx_c_Comp_id_U64_eKind_U64_eBits_U64_eSgn_Bool(&((*c)), cond, 0, 0, 0);
    ...
    plew_write((PlewString){"    }\n", 6});
        ...
        uint64_t varStart = _m672.data.For.varStart;
        (void)varStart;
        uint64_t varLen = _m672.data.For.varLen;
        (void)varLen;
        long long isRange = _m672.data.For.isRange;
        (void)isRange;
        long long inclusive = _m672.data.For.inclusive;
        (void)inclusive;
        uint64_t iter = _m672.data.For.iter;
        (void)iter;
        uint64_t rangeHi = _m672.data.For.rangeHi;
        (void)rangeHi;
        uint64_t body = _m672.data.For.body;
        (void)body;
    if (isRange) {
    ...
    scopeExit_c_Comp_mark_U64(&((*c)), forMark);
        ...
        uint64_t msg = _m672.data.Panic.msg;
        (void)msg;
        uint64_t offset = _m672.data.Panic.offset;
        (void)offset;
    ...
    plew_write((PlewString){");\n", 3});
        ...
        uint64_t value = _m672.data.Give.value;
        (void)value;
    ...
    plew_write((PlewString){"    continue;\n", 14});
        ...
        uint64_t scrut = _m672.data.Match.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m672.data.Match.arms;
        (void)arms;
    if (matchExhaustive_c_Comp_arms_AMatchArm(&((*c)), arms)) {
    }
    else {
...
long long nameIsMain_c_Comp_f_Func(Comp* c, Func f) {
    ...
    { long long __ret676 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, f.nameStart, f.nameLen, (PlewString){"main", 4});
    return __ret676; }
}
long long isTraitName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t i = 0;
...
long long methodRecvIsTrait_c_Comp_f_Func(Comp* c, Func f) {
    if (f.hasRecv) {
    { long long __ret679 = isTraitName_c_Comp_start_U64_len_U64(&((*c)), f.recvStart, f.recvLen);
    return __ret679; }
    }
...
uint64_t structIndexByName_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    ...
    { uint64_t __ret682 = (long long)(((*c).structs).len);
    return __ret682; }
}
long long structNeedsCopy_c_Comp_start_U64_len_U64(Comp* c, uint64_t start, uint64_t len) {
    uint64_t si = structIndexByName_c_Comp_start_U64_len_U64(&((*c)), start, len);
...
void genClosure_c_Comp_id_U64_proto_Bool(Comp* c, uint64_t id, long long proto) {
    {
    Expr _m698 = PlewArray_Expr_get((*c).exprs, (long long)(id));
    if (_m698.tag == 17) {
        PlewArray_Param params = _m698.data.Closure.params;
        (void)params;
        long long hasRet = _m698.data.Closure.hasRet;
        (void)hasRet;
        uint64_t retStart = _m698.data.Closure.retStart;
        (void)retStart;
        uint64_t retLen = _m698.data.Closure.retLen;
        (void)retLen;
        long long retIsArray = _m698.data.Closure.retIsArray;
        (void)retIsArray;
        uint64_t retTy = _m698.data.Closure.retTy;
        (void)retTy;
        uint64_t body = _m698.data.Closure.body;
        (void)body;
    if (hasRet) {
    (*c).curRetVoid = 0;
...
void emitClosures_c_Comp_proto_Bool(Comp* c, long long proto) {
    ...
    {
    Expr _m699 = PlewArray_Expr_get((*c).exprs, (long long)(i));
    if (_m699.tag == 17) {
...
uint64_t genericStructIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    { uint64_t __ret701 = (long long)(((*c).structs).len);
    return __ret701; }
}
uint64_t genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    uint64_t i = 0;
    ...
    { uint64_t __ret703 = (long long)(((*c).enums).len);
    return __ret703; }
}
long long isGenericInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret707 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret707; }
    TypeRef_release(t);
}
long long isFnType_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    TypeRef t = TypeRef_share(PlewArray_TypeRef_get((*c).types, (long long)(ref)));
    { long long __ret709 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, t.nameStart, t.nameLen, (PlewString){"fn", 2});
    TypeRef_release(t);
    return __ret709; }
    TypeRef_release(t);
}
long long isRefInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret712 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, t.nameStart, t.nameLen, (PlewString){"Ref", 3});
    TypeRef_release(t);
    return __ret712; }
    TypeRef_release(t);
}
long long isGenericEnumInst_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { long long __ret715 = (genericEnumIndex_c_Comp_nameStart_U64_nameLen_U64(&((*c)), t.nameStart, t.nameLen) < (long long)(((*c).enums).len));
    TypeRef_release(t);
    return __ret715; }
    TypeRef_release(t);
}
...
uint64_t resolveTy_c_Comp_tyRef_U64(Comp* c, uint64_t tyRef) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), t.nameStart, t.nameLen, p.nameStart, p.nameLen)) {
    { uint64_t __ret722 = PlewArray_U64_get((*c).curTypeArgs, (long long)(i));
    TypeRef_release(t);
    return __ret722; }
    }
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
...
void collectGenInsts_c_Comp(Comp* c) {
    ...
    {
    Stmt _m732 = PlewArray_Stmt_get((*c).stmts, (long long)(sti));
    if (_m732.tag == 0) {
        uint64_t ty = _m732.data.Let.ty;
        (void)ty;
    ...
    {
    Expr _m733 = PlewArray_Expr_get((*c).exprs, (long long)(xi));
    if (_m733.tag == 11) {
        uint64_t operand = _m733.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m733.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m733.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m733.data.Cast.ty;
        (void)ty;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else if (_m733.tag == 6) {
        uint64_t typeStart = _m733.data.Make.typeStart;
        (void)typeStart;
        uint64_t typeLen = _m733.data.Make.typeLen;
        (void)typeLen;
        uint64_t variantStart = _m733.data.Make.variantStart;
        (void)variantStart;
        uint64_t variantLen = _m733.data.Make.variantLen;
        (void)variantLen;
        long long isEnum = _m733.data.Make.isEnum;
        (void)isEnum;
        uint64_t ty = _m733.data.Make.ty;
        (void)ty;
        PlewArray_MakeField fields = _m733.data.Make.fields;
        (void)fields;
    scanType_c_Comp_ref_U64(&((*c)), ty);
    }
    else {
...
TypeInfo typeInfoOfRef_c_Comp_ref_U64(Comp* c, uint64_t ref) {
    ...
    { TypeInfo __ret735 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), el.nameStart, el.nameLen, 1);
    TypeRef_release(el);
    TypeRef_release(t);
    return __ret735; }
    TypeRef_release(el);
    }
    { TypeInfo __ret736 = typeInfoOfName_c_Comp_start_U64_len_U64_isArray_Bool(&((*c)), t.nameStart, t.nameLen, 0);
    TypeRef_release(t);
    return __ret736; }
    TypeRef_release(t);
}
TypeInfo substTypeInfo_c_Comp_instRef_U64_params_ABind_tyRef_U64(Comp* c, uint64_t instRef, PlewArray_Bind params, uint64_t tyRef) {
    ...
    { TypeInfo __ret737 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(inst.args, (long long)(i)));
    TypeRef_release(inst);
    TypeRef_release(t);
    return __ret737; }
    }
    ...
    { TypeInfo __ret738 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), tyRef);
    TypeRef_release(t);
    return __ret738; }
    TypeRef_release(t);
}
TypeInfo genericFieldTypeInfo_c_Comp_instRef_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    { TypeInfo __ret740 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
    ...
    { TypeInfo __ret741 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fields);
    StructDef_release(s);
    TypeRef_release(t);
...
TypeInfo genericEnumFieldTypeInfo_c_Comp_instRef_U64_variantStart_U64_variantLen_U64_fieldStart_U64_fieldLen_U64(Comp* c, uint64_t instRef, uint64_t variantStart, uint64_t variantLen, uint64_t fieldStart, uint64_t fieldLen) {
    ...
    if (spansEqual_c_Comp_aStart_U64_aLen_U64_bStart_U64_bLen_U64(&((*c)), ftr.nameStart, ftr.nameLen, p.nameStart, p.nameLen)) {
    { TypeInfo __ret744 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), PlewArray_U64_get(t.args, (long long)(pi)));
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
    ...
    { TypeInfo __ret745 = typeInfoOfRef_c_Comp_ref_U64(&((*c)), fd.ty);
    TypeRef_release(ftr);
    PlewArray_FieldDef_release(fs);
    Variant_release(v);
    PlewArray_Variant_release(vars);
...
long long methodMatchesInst_c_Comp_f_Func_instRef_U64(Comp* c, Func f, uint64_t instRef) {
    ...
    { long long __ret750 = ((long long)((f.typeParams).len) == (long long)((inst.args).len));
    TypeRef_release(inst);
    return __ret750; }
    TypeRef_release(inst);
}
...
long long isGenericFreeFn_c_Comp_fi_U64(Comp* c, uint64_t fi) {
    ...
    { long long __ret753 = ((long long)((f.typeParams).len) > 0);
    Func_release(f);
    return __ret753; }
    Func_release(f);
}
uint64_t findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(Comp* c, uint64_t nameStart, uint64_t nameLen) {
    ...
    PlewArray_U64 noArgs = PlewArray_U64_new();
    { uint64_t __ret755 = Comp_pushType_t_TypeRef(&((*c)), (TypeRef){.nameStart = nameStart, .nameLen = nameLen, .args = PlewArray_U64_share(noArgs)});
    PlewArray_U64_release(noArgs);
    return __ret755; }
    PlewArray_U64_release(noArgs);
}
uint64_t tyRefOfInfo_c_Comp_ti_TypeInfo(Comp* c, TypeInfo ti) {
    ...
    { uint64_t __ret759 = findOrAddTypeRef_c_Comp_nameStart_U64_nameLen_U64(&((*c)), ti.nameStart, ti.nameLen);
    return __ret759; }
}
PlewArray_U64 inferFnArgs_c_Comp_f_Func_args_AArg(Comp* c, Func f, PlewArray_Arg args) {
    ...
    { PlewArray_U64 __ret760 = PlewArray_U64_share(out);
...
void scanExprInsts_c_Comp_exprId_U64(Comp* c, uint64_t exprId) {
    {
    Expr _m767 = PlewArray_Expr_get((*c).exprs, (long long)(exprId));
    if (_m767.tag == 2) {
        int64_t op = _m767.data.Unary.op;
        (void)op;
        uint64_t operand = _m767.data.Unary.operand;
        (void)operand;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m767.tag == 3) {
        int64_t op = _m767.data.Binary.op;
        (void)op;
        uint64_t lhs = _m767.data.Binary.lhs;
        (void)lhs;
        uint64_t rhs = _m767.data.Binary.rhs;
        (void)rhs;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), lhs);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), rhs);
    }
    else if (_m767.tag == 4) {
        uint64_t nameStart = _m767.data.Call.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m767.data.Call.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m767.data.Call.args;
        (void)args;
    uint64_t i = 0;
    while (i < (long long)((args).len)) {
    ...
    else if (_m767.tag == 10) {
        uint64_t recv = _m767.data.Method.recv;
        (void)recv;
        uint64_t nameStart = _m767.data.Method.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m767.data.Method.nameLen;
        (void)nameLen;
        PlewArray_Arg args = _m767.data.Method.args;
        (void)args;
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        uint64_t base = _m767.data.Field.base;
        (void)base;
        uint64_t nameStart = _m767.data.Field.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m767.data.Field.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m767.tag == 9) {
        uint64_t base = _m767.data.Index.base;
        (void)base;
        uint64_t index = _m767.data.Index.index;
        (void)index;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), index);
        ...
        (void)ty;
        PlewArray_MakeField fields = _m767.data.Make.fields;
        (void)fields;
    uint64_t i = 0;
    while (i < (long long)((fields).len)) {
    ...
    i = ({ uint64_t __ov; if (__builtin_add_overflow((i), (1), &__ov)) plew_panic((PlewString){"integer overflow", 16}); __ov; });
        ...
        PlewArray_U64 elems = _m767.data.Array.elems;
        (void)elems;
    uint64_t i = 0;
    while (i < (long long)((elems).len)) {
    ...
    else if (_m767.tag == 11) {
        uint64_t operand = _m767.data.Cast.operand;
        (void)operand;
        uint64_t tyStart = _m767.data.Cast.tyStart;
        (void)tyStart;
        uint64_t tyLen = _m767.data.Cast.tyLen;
        (void)tyLen;
        uint64_t ty = _m767.data.Cast.ty;
        (void)ty;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else if (_m767.tag == 14) {
        uint64_t opt = _m767.data.Coalesce.opt;
        (void)opt;
        uint64_t deflt = _m767.data.Coalesce.deflt;
        (void)deflt;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), opt);
    scanExprInsts_c_Comp_exprId_U64(&((*c)), deflt);
    }
    else if (_m767.tag == 15) {
        uint64_t expr = _m767.data.Try.expr;
        (void)expr;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m767.tag == 16) {
        uint64_t base = _m767.data.Arrow.base;
        (void)base;
        uint64_t nameStart = _m767.data.Arrow.nameStart;
        (void)nameStart;
        uint64_t nameLen = _m767.data.Arrow.nameLen;
        (void)nameLen;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), base);
    }
    else if (_m767.tag == 13) {
        uint64_t cond = _m767.data.IfExpr.cond;
        (void)cond;
        uint64_t thenBlk = _m767.data.IfExpr.thenBlk;
        (void)thenBlk;
        uint64_t elseBlk = _m767.data.IfExpr.elseBlk;
        (void)elseBlk;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), cond);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), thenBlk);
    scanBlockInsts_c_Comp_blkId_U64(&((*c)), elseBlk);
    }
    else if (_m767.tag == 12) {
        uint64_t scrut = _m767.data.MatchExpr.scrut;
        (void)scrut;
        PlewArray_MatchArm arms = _m767.data.MatchExpr.arms;
        (void)arms;
    ...
    else if (_m767.tag == 18) {
        uint64_t operand = _m767.data.Move.operand;
        (void)operand;
        long long isBorrow = _m767.data.Move.isBorrow;
        (void)isBorrow;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), operand);
    }
    else {
...
void scanStmtInsts_c_Comp_stmtId_U64(Comp* c, uint64_t stmtId) {
    {
    Stmt _m768 = PlewArray_Stmt_get((*c).stmts, (long long)(stmtId));
    if (_m768.tag == 0) {
    ...
    scanExprInsts_c_Comp_exprId_U64(&((*c)), value);
        ...
        uint64_t expr = _m768.data.Print.expr;
        (void)expr;
        uint64_t offset = _m768.data.Print.offset;
        (void)offset;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), expr);
    }
    else if (_m768.tag == 3) {
    ...
    popLocals_c_Comp_mark_U64(&((*c)), forMark);
        ...
        (void)scrut;
        PlewArray_MatchArm arms = _m768.data.Match.arms;
        (void)arms;
    scanExprInsts_c_Comp_exprId_U64(&((*c)), scrut);
    uint64_t ai = 0;
    while (ai < (long long)((arms).len)) {
...
long long isU8Elem_c_Comp_elemStart_U64_elemLen_U64(Comp* c, uint64_t elemStart, uint64_t elemLen) {
    { long long __ret769 = rangeEquals_bytes_AU8_start_U64_len_U64_kw_String((*c).bytes, elemStart, elemLen, (PlewString){"U8", 2});
    return __ret769; }
}
void genU8ArrayTypedef(void) {
...
PlewArray_Bind collectParts_rootBytes_AU8_toks_ATok(PlewArray_U8 rootBytes, PlewArray_Tok toks) {
    ...
    { PlewArray_Bind __ret777 = PlewArray_Bind_share(parts);
...
PlewArray_U8 findSrcRoot_entry_AU8(PlewArray_U8 entry) {
    ...
    { PlewArray_U8 __ret789 = PlewArray_U8_share(sr);
    ...
    { PlewArray_U8 __ret790 = PlewArray_U8_share(empty);
