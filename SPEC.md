...
2. [型システム](spec/02-types.md) — プリミティブ型、文字列展開、複合型、構造体／列挙型／トレイト、フィールド統一原則、Optional／Result、インスタンス生成（JSX／factory）、newtype（名目型）、ジェネリクス、where 句
...
11. [トレイト](spec/11-traits.md) — トレイトの定義（要求・提供メソッド）、関連型、継承（supertrait）、準拠と via、標準トレイト（基本／変換／演算子）
